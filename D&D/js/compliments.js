...
let mid = [
    "a creative", "a gorgeous", "a beautiful", "an intelligent", "a friendly", "a kind", "an awesome", "an impressive", "a great", "an important", "an admirable", "a dependable", "a talented", "a hardworking", "an imaginative", "a generous", "an excellent", "an inspiring"
]
let finisher = [
    "person", "DM", "friend", "creator", "inspirer"
]
let template = [
