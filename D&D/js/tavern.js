...
let noun = [
[
"Guy", "Gal", "Abbot", "Refugee", "Acolyte", "Archmage", "Assassin", "Bandit", "Berserker", "Commoner", "Cultist", "Fanatic", "Gladiator", "Mage", "Preist", "Scout", 
"Spy", "Thug", "Veteran", "Dutchess", "Paladin", "Farmer", "Seaman", "Knight", "Scholar", "Seadog", "Jester", "Noble", "King", "Count", "Duke", "Emperor", "Thief", 
"Sailor", "Farmer", "Soldier", "Mercenary", "Priest", "Mage", "Scholar", "Beggar", "Bard", "Guard", "Drunk", "Wench", "Knight", "Merchant", "Smuggler", "Fool", "Druid", 
"Witch", "Traveler", "Fisherman", "Lady", "Harlot", "Bounty Hunter", "Gardener", "Gambler", "Prince", "Princess", "Brother", "Father", "Sister", "Mother", "Pirate", 
"Journeyman", "Chieftain", "Lord", "Miller", "Archer", "Crossbowman", "Lumberjack", "Miner", "Hunter", "Villager", "Settler", "Butcher", "Oracle", "Pilgrim", "Courier", 
"Hero", "Necromancer", "Sorcerer", "Wizard", "Barbarian", "Ranger", "Fighter", "Monk", "Warlock", "Summoner", "Arcanist", "Blood Hunter", "Cleric", "Rogue", "Artificer", 
"Outlander", "Exile"
],
[
"Swamp", "Mire", "End", "Bridge", "Gate", "Road", "Solace", "Haven", "Rest", "Paradise", "Fort", "House", "Home", "Venture", "Joint", "Hut", "Repose", "Keep", "Garden", 
"Room", "Sanctum", "Retreat", "Asylum", "Hideaway", "Refuge", "Shelter", "Haunt", "Shack", "Den", "Clearing", "Dungeon", "Castle", "Cottage", "Dungeon", "Field", "Camp", 
"Lean-To", "Mountain", "Cave", "Town", "City", "Lake", "Pond", "Lair", "Chamber", "Hovel", "Stall"
],
[
"Whistle", "Anchor", "Bench", "Bramble", "Nail", "Scale", "Bugle", "Keystone", "Blight", "Hook", "Tree", "Flower", "Drum", "Buckle", "Chair", "Table", "Spoon", 
"Fork", "Axe", "Sword", "Shield", "Armor", "Bag", "Door", "Stash", "Bed", "Bunk", "Bedroll", "Barrel", "Keg", "Crate", "Box", "Pot", "Vial", "Arrow", "Broom", 
"Shovel", "Pillow", "Hearth", "Candle", "Lantern", "Mug", "Cup", "Tankard", "Bottle", "Plate", "Plow", "Pot", "Pan", "Lamp", "Wagon", "Spoke", "Rug", "Hammer", 
"Anvil", "Forge", "Goblet", "Chest", "Wardrobe", "Cellar", "Beer", "Ale", "Mead", "Wine", "Vodka", "Feather", "Oar", "Brandy", "Cask", "Harp", "Lute", "Necklace", 
"Bracelet", "Comb", "Mantle", "Crown", "Ring", "Oil", "Potion", "Gem", "Scroll", "Wand", "Bead", "Horseshoe", "Pike", "Bow", "Slippers", "Trident", "Brooch", "Amulet", 
"Pipe", "Figurine", "Deck", "Circlet", "Fan", "Boots", "Quiver", "Helm", "Gloves", "Belt", "Cape", "Dagger", "Shackles", "Horn", "Staff", "Book", "Wings", "Bands", 
"Crystal Ball", "Carpet", "Cask", "Manual", "Tome", "Flask", "Treasure", "Map", "Artifact", "Trap", "Dart", "Javelin", "Spear", "Halberd", "Hoard", "Key", "Stone", 
"Talisman", "Scimitar", "Apparatus", "Bracers", "Bowl", "Chime", "Decanter", "Card", "Mail", "Elixer", "Boat", "Ship", "Hat", "Clothes", "Headband", "Haversack", 
"Mirror", "Mace", "Philter", "Periapt", "Robe", "Rope", "Saddle", "Glue", "Well", "Trinket", "Statue", "Hankercheif", "Locket", "Bone", "Skull", "Sickle"
],
[
"Aarakocra", "Aboleth", "Angel", "Animated Object", "Animated Weapon", "Ankheg", "Azer", "Banshee", "Basilisk", "Behir", "Beholder", "Blight", "Bugbear", 
"Bulette", "Bullywug", "Cambion", "Carrion Crawler", "Centaur", "Chimera", "Chuul", "Cloaker", "Cockatrice", "Couatl", "Crawling Claw", "Cyclops", "Darkmantle", 
"Death Knight", "Demilich", "Demon", "Devil", "Dinosaur", "Displacer Beast", "Doppleganger", "Dracolich", "Shadow Dragon", "Dragon", "Dragon Turtle", "Drider", 
"Dryad", "Duergar", "Elemental", "Empyrean", "Ettercap", "Ettin", "Faerie Dragon", "Flameskull", "Flumph", "Fomorian", "Fungi", "Galeb Duhr", "Gargoyle", 
"Genie", "Ghost", "Giant", "Gibbering Mouther", "Gith", "Gnoll", "Goblin", "Golem", "Gorgon", "Grell", "Grick", "Griffon", "Grimlock", "Hag", "Half Dragon", 
"Harpy", "Hell Hound", "Helmed Horror", "Hippogriph", "Hobgoblin", "Homunculus", "Hook Horror", "Hydra", "Intellect Devourer", "Invisible Stalker", "Jakalwere", 
"Kenku", "Kobold", "Kraken", "Kuo-Toa", "Lamia", "Lich", "Lizardfolk", "Lycanthrope", "Magmin", "Manticore", "Medusa", "Mephits", "Merfolk", "Merrow", "Mimic", 
"Mind Flayer", "Minotaur", "Modron", "Mummie", "Myconid", "Naga", "Nightmare", "Nothic", "Ogre", "Oni", "Ooze", "Orc", "Otyugh", "Owlbear", "Pegasus", "Peryton", 
"Piercer", "Pixie", "Psuedodragon", "Purple Worm", "Quaggoth", "Rakshasa", "Remorhazes", "Revenant", "Roc", "Roper", "Rust Monster", "Sahuagin", "Salamander", "Satyr", 
"Scarecrow", "Shadow", "Shambling Mound", "Shield Guardian", "Skeleton", "Slaadi", "Specter", "Sphinx", "Sprite", "Stirge", "Succubus", "Incubus", "Terrasque", 
"Thri-kreen", "Treant", "Troglodyte", "Troll", "Umber Hulk", "Unicorn", "Vampire", "Water Weird", "Wight', `Will-o'-Wisp`, 'Wraith", "Wyvern", "Xorn", "Yeti", "Yuan-ti", 
"Yugoloth", "Zombie", "Ape", "Awakened Tree", "Awakened Shrub", "Axe Beak", "Baboon", "Badger", "Bat", "Black Bear", "Blink Dog", "Blood Hawk", "Boar", "Brown Bear",
"Camel", "Cat", "Constrictor Snake", "Crab", "Crocodile", "Death Dog", "Deer", "Dire Wolf", "Draft Horse", "Eagle", "Elephant", "Elk", "Flying Snake", "Frog", 
"Giant Ape", "Giant Badger", "Giant Bat", "Giant Boar", "Giant Centipede", "Giant Constrictor Snake", "Giant Crab", "Giant Crocodile", "Giant Eagle", "Giant Elk", 
"Giant Fire Beetle", "Giant Frog", "Giant Goat", "Giant Hyena", "Giant Lizard", "Giant Octopus", "Giant Owl", "Giant Poisonous Snake", "Giant Rat", "Giant Scorpion", 
"Giant Sea Horse", "Giant Shark", "Giant Spider", "Giant Toad", "Giant Vulture", "Giant Wasp", "Giant Weasel", "Giant Wolf Spider", "Goat", "Hawk", "Hunter Shark", 
"Hyena", "Jackal", "Killer Whale", "Lion", "Lizard", "Mammoth", "Mastiff", "Mule", "Octopus", "Owl", "Panther", "Phase Spider", "Poisonous Snake", "Polar Bear", "Pony", 
"Quipper", "Rat", "Raven", "Reef Shark", "Rhinoceros", "Riding Horse", "Saber-Toothed Tiger", "Scorpion", "Sea Horse", "Spider", "Bat Swarm", "Insect Swarm", 
"Poisonous Snake Swarm", "Quipper Swarm", "Rat Swarm", "Raven Swarm", "Tiger", "Vulture", "Warhorse", "Weasel", "Winter Wolf", "Wolf", "Worg"
],
]
let template = [
...
`The ${toWords(rollDice(100))}${searchArray(noun[3])}s`,
