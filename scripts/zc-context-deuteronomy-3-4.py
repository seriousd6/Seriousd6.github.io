...
DEUT_CONTEXT = {
  ...
  "3": {
    "11": "<p>Og's iron bed (9×4 cubits, approximately 13×6 feet) is noted as preserved at Rabbah of the Ammonites (modern Amman, Jordan), functioning as a display piece or royal trophy in the period of Deuteronomy's composition. The object is variously identified as: (1) a royal basalt sarcophagus (basalt is abundant in Bashan and appears black like iron), (2) an actual iron-framed bed demonstrating royal status, or (3) a cultic object. 'Rephaim' in the Transjordanian texts denotes a pre-Israelite population associated with exceptional stature (Deut 2:11, 2:20; Gen 14:5; 15:20); in later Hebrew the word shifts to mean 'shades' — the dead in Sheol (Isa 14:9; Prov 9:18) — a fusion of giant-race and underworld-ancestor traditions. The defeat of Og as 'the last of the Rephaim' (3:11) is a deliberate literary closure: Israel's entry into the promised land eliminates the last survivors of the pre-Abrahamic peoples whose terror had paralyzed Israel at Kadesh (Num 13:33: 'we seemed to ourselves like grasshoppers').</p>",
    "26": "<p>Moses's exclusion from Canaan (3:23-27) is narrated as YHWH's refusal of his intercession: 'the LORD was angry with me on your account and would not listen to me.' The precise sin for which Moses is excluded is debated: Numbers 20:12 attributes it to his failure to 'believe in me' and 'uphold me as holy' at Meribah; Numbers 27:14 uses the same formula. In Deuteronomy the narrative reframes the exclusion through Moses's intercession and YHWH's flat refusal — 'Enough from you; do not speak to me of this matter again.' The Hebrew <em>rav-lach</em> (enough for you / it is too much for you) carries both sufficiency and rebuke. Moses is permitted to see the land from Pisgah but not enter — a distinction between visual possession and physical inheritance. The motif of the leader who brings his people to the threshold but cannot cross it anticipates the Mosaic typology in Heb 3:5-6: Moses is a servant in the house; Christ is the Son over the house, who leads his people all the way into the Sabbath-rest Moses could only glimpse.</p>"
  },
  "4": {
    "12": "<p>The Horeb prohibition of images is grounded in the nature of the Sinai theophany itself: 'you heard the sound of words but saw no form (<em>temunah</em>); there was only a voice' (4:12). Israel's aniconic tradition is historically distinctive — ancient Near Eastern religion was uniformly iconic: divine images (<em>ṣalmu</em> in Akkadian) were the physical locus of the deity's presence, 'activated' through mouth-washing and mouth-opening rituals. To worship without an image was anomalous. Greco-Roman observers noted it with derision: Tacitus writes that Jews 'acknowledge one God only ... of unbounded might, and eternal, neither admitting of any representative in human shape.' Deuteronomy grounds aniconism not merely in prohibition but in the nature of the Horeb revelation itself: YHWH is the God who speaks without being seen — the word, not the image, is the medium of divine self-communication. This tradition reaches its NT culmination in John's Logos theology: the Word that was with God and was God, heard but never seen (John 1:18: 'No one has ever seen God'), becomes flesh without becoming an idol (John 1:14).</p>",
    "35": "<p>'To you it was shown, that you might know that YHWH is God; there is no other besides him (<em>ein od milvado</em>)' (4:35). The formula <em>ein od</em> (there is no other) is the OT's sharpest expression of divine uniqueness. The question of whether Deuteronomy's monotheism is strict (ontological — other gods do not exist) or functional (monolatrous — other gods must not be worshipped by Israel) has been debated. The background of 4:19-20 (YHWH has assigned the heavenly bodies for the nations while taking Israel as his own portion) and the 'divine council' framework of Deut 32:8 LXX ('sons of God') suggest awareness of other divine beings alongside YHWH's incomparable supremacy. But the trajectory of <em>ein od</em> passages from Deuteronomy through Second Isaiah ('I am the LORD and there is no other', Isa 45:5-6; 45:18; 45:21-22; 46:9) moves toward ontological exclusive monotheism. Paul's Christological Shema in 1 Cor 8:6 ('for us there is one God ... and one Lord Jesus Christ') operates within this tradition of radical divine uniqueness while differentiating the single divine identity between Father and Son.</p>"
  },
  "18": {
