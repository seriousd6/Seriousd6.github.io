...
DEUT_ORIGINAL = {
  "26": {
    "5": "<p><strong>Arami oved avi vayered Mitzraymah vayagar sham bimtei me'at vayehi sham legoy gadol atzum varav</strong> (<em>ʾărammî ʾōbēd ʾābî wayyēred miṣrāymāh wayyāgār šām bimtê mĕʿāṭ wayyĕhî šām lĕgôy gādôl ʿāṣûm wārāb</em>): 'A wandering Aramean was my father, and he went down to Egypt and sojourned there, few in number, and there he became a nation, great, mighty, and populous.' This sentence — the opening of the first-fruits liturgical creed (vv. 5-10) — is Israel's compressed covenant history in confessional form. <em>Arami oved</em> (wandering/perishing Aramean): <em>oved</em> is the participle of <em>abad</em> (to perish, to be lost, to be destroyed), the same root as <em>eved</em> (servant/slave) — though different. The father is Jacob (whose mother was Aramean, and who lived among Arameans); he was one who was about to perish, a non-entity. From this near-extinction, the nation of Israel emerged — the covenant pivot from one man's destitution to a great nation. Paul's doctrine of election (<em>not many wise... not many powerful... God chose what is foolish</em>, 1 Cor 1:26-29) follows the same logic: the covenant community is defined by what it was before YHWH chose it, not by what it was in itself.</p>",
    "17": "<p><strong>et-YHWH he'emarta hayom lihyot lecha l'Elohim uve'lekhta bidrachav ve'lishmor chukkav umitzvotav umishpatav velishmo'a beqolo. ve'YHWH he'emircha hayom lihyot lo le'am segulah</strong> (<em>ʾet-Yhwh heʾĕmartā hayyôm lihyôt lĕkā lēʾlōhîm ûbĕleket bidĕrākāyw wĕlišmōr ḥuqqāyw ûmiṣwōtāyw ûmišpāṭāyw wĕlišmōaʿ bĕqōlô. wYhwh heʾĕmîrkā hayyôm lihyôt lô lĕʿam sĕgullāh</em>): 'You have caused YHWH to declare today that he will be your God... and YHWH has caused you to declare today that you will be his people of treasured possession.' The Hiphil form <em>heʾĕmartā</em> and <em>heʾĕmîrkā</em> are both causatives of <em>amar</em> (to say/declare) — literally, you have caused him to say, and he has caused you to say. This is covenant ratification language: the two parties publicly commit each other to their respective roles before witnesses. The mutual covenant-declaration structure (Israel declares YHWH as God; YHWH declares Israel as his treasured people) is the OT form of what Paul describes as adoption (Rom 8:15-16: the Spirit of adoption by whom we cry <em>Abba, Father</em> — the Spirit bearing witness with our spirit that we are children of God).</p>"
  },
  "27": {
    "5": "<p><strong>uvaneita sham mizbea'ch l'YHWH Eloheicha mizbea'ch avanim lo-tanif aleihem barzel</strong> (<em>ûb̠ānîtā šām mizbēaḥ laYhwh ʾĕlōhêkā mizbēaḥ ʾăbānîm lōʾ-tānîp̄ ʿălêhem barzel</em>): 'And you shall build there an altar to the LORD your God, an altar of stones. You shall not wield an iron tool on them.' The altar at Mt. Ebal (the curses-mountain) is to be built from uncut, undressed stones — natural stones untouched by iron tools. The same prohibition appears in Exod 20:25: to wield an iron tool on the stone would defile it (<em>wa-tachallelah</em>). The principle is that YHWH's altar must not be shaped by human craft — the natural roughness of the stone is the appropriate approach to a holy altar. The contrast with Solomon's temple (1 Kings 6:7: no hammer, chisel, or any iron tool was heard in the house) maintains the same principle: the place of divine encounter is not a human achievement but a divine provision. The roughness of Ebal's altar amid the covenant curses may foreshadow the cross — the rough wood of a tree, a place of curse (Deut 21:23), becoming the altar of the covenant.</p>",
    "26": "<p><strong>arur asher lo-yakim et-divrei hatorah hazot la'asot otam ve'amar kol-ha'am amen</strong> (<em>ʾārûr ʾăšer lōʾ-yāqîm ʾet-dibrê hattôrāh hazzōʾt laʿăśôt ʾôtām wĕʾāmar kol-hāʿām ʾāmēn</em>): 'Cursed be anyone who does not confirm the words of this law by doing them. And all the people shall say, Amen.' The climactic curse of the Deuteronomic ceremony. <em>Arur</em> (cursed) is a performative declaration: to speak <em>arur</em> over someone is to invoke covenant malediction, the opposite of <em>baruch</em> (blessed). <em>Yakim</em> (confirm, uphold, establish) from <em>qum</em> — to stand/rise; in the Hiphil: to cause to stand, to establish. The requirement is not merely to hear or to intend but to <em>do</em> (<em>la'asot</em>). Paul's citation of this verse in Galatians 3:10 is decisive: all who rely on works of the law are under a curse, for it is written, cursed is everyone who does not abide by all things written in the book of the law and do them. The Deuteronomic curse reveals the law's own logic: it requires total performance, which no one achieves, making it a curse-pronouncing instrument rather than a salvation vehicle. Christ redeems from this curse (Gal 3:13) by himself becoming the <em>arur</em> of Deut 21:23 — cursed is everyone who hangs on a tree.</p>"
  },
  "30": {
