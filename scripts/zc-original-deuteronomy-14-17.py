...
DEUT_ORIGINAL = {
  "14": {
    "2": "<p><strong>ki am qadosh atah l'YHWH Eloheicha uvcha bachar YHWH lihyot lo l'am segulah mikol ha'amim asher al-pnei ha'adamah</strong> (<em>kî ʿam qādôš ʾattāh laYhwh ʾĕlōhêkā ûbĕkā bāḥar Yhwh lihyôt lô lĕʿam sĕgullāh mikkōl hāʿammîm ʾăšer ʿal-pĕnê hāʾădāmāh</em>): 'For you are a people holy to the LORD your God, and the LORD has chosen you to be a people for his treasured possession, out of all the peoples who are on the face of the earth.' <em>Am qadosh</em> (holy people) and <em>am segulah</em> (treasured possession/people of special property) are Deuteronomy's twin covenant-identity terms. <em>Segulah</em> (also Exod 19:5; Deut 7:6; 26:18; Mal 3:17) derives from a root meaning private or personal property that one keeps close — it describes the intimate ownership-affection that distinguishes this people from all others. Peter applies both terms directly to the church (1 Pet 2:9-10): a holy nation, a people for YHWH's own possession. The dietary laws that follow in 14:3-21 are grounded in this identity: what Israel eats is shaped by who they are — a people set apart for YHWH.</p>",
    "21": "<p><strong>lo-tevashel gedi bachalev imo</strong> (<em>lōʾ tĕbaššēl gĕdî baḥălēb ʾimmô</em>): 'You shall not boil a young goat in its mother's milk.' This brief prohibition (repeated verbatim in Exod 23:19; 34:26) is the ancient scriptural basis for the rabbinic separation of meat and dairy foods (<em>basar bechalav</em>). Its precise rationale is debated: (1) a Canaanite fertility-ritual prohibition (though no such Ugaritic ritual is clearly attested); (2) a humanitarian principle against mixing life-food (milk) with death-food (meat) especially from the same animal; (3) a holiness-distinction principle consistent with Deuteronomy's separation-categories. The threefold repetition across Torah gives it canonical weight beyond its brevity. The NT never addresses it directly, but Paul's principle in 1 Cor 8-10 (idol food) applies similar logic: covenant identity shapes eating practices, and the offense to conscience may matter more than the intrinsic act.</p>"
  },
  "15": {
    "1": "<p><strong>mikets sheva-shanim ta'aseh shemitah</strong> (<em>miqqēṣ šebaʿ-šānîm taʿăśeh šĕmiṭṭāh</em>): 'At the end of every seven years you shall grant a release.' <em>Shemittah</em> from the root <em>šāmaṭ</em> (to let drop, to release, to let fall) — used elsewhere for letting a sword fall (2 Sam 6:6 variant) or releasing an animal. The sabbatical year (<em>shnat hashemittah</em>) is the seventh year in which debts between Israelites are released and the land is allowed to rest (Exod 23:10-11; Lev 25:1-7). The year of release images the Jubilee (Lev 25:10: <em>deror</em>, release/liberty) — which Jesus applies to his own ministry in Luke 4:18-19 (<em>shevat shevuyim deror</em>, proclaim liberty to captives). The whole sabbatical-Jubilee complex encodes the principle of periodic economic reset as a covenantal obligation.</p>",
    "11": "<p><strong>ki lo-yechdal evyon mikerev ha'aretz al-ken anochi metzavecha lemor pato'ach tiftach et-yadcha le'achicha la'aniyecha ule'evyonecha be'artzecha</strong> (<em>kî lōʾ-yeḥdal ʾebyôn miqqereb hāʾāreṣ ʿal-kēn ʾānōkî mĕṣawwĕkā lēmōr pātōaḥ tip̄taḥ ʾet-yādĕkā lĕʾāḥîkā lĕʿăniyyĕkā ûlĕʾebyônĕkā bĕʾarṣĕkā</em>): 'For there will never cease to be poor in the land. Therefore I command you, You shall open wide your hand to your brother, to the needy and to the poor, in your land.' Jesus cites this verse twice: Matt 26:11 and Mark 14:7 (<em>the poor you always have with you, but you will not always have me</em>) — not as a fatalistic dismissal of poverty but as a citation of Deut 15:11 to make a Christological point about the unique and irreplaceable moment of his physical presence. The double infinitive absolute <em>pātōaḥ tip̄taḥ</em> (open wide, you shall open) is intensifying idiom — categorical generosity, not selective charity.</p>"
  },
  "16": {
    "1": "<p><strong>shamor et-chodesh ha'aviv ve'asita Pesach l'YHWH Eloheicha ki be'chodesh ha'aviv hotziacha YHWH Eloheicha miMitzrayim laylah</strong> (<em>šāmôr ʾet-ḥōdeš hāʾābîb wĕʿāśîtā peseḥ laYhwh ʾĕlōhêkā kî bĕḥōdeš hāʾābîb hôṣîʾăkā Yhwh ʾĕlōhêkā mimmmiṣrayim lāylāh</em>): 'Observe the month of Abib and keep the Passover to the LORD your God, for in the month of Abib the LORD your God brought you out of Egypt by night.' <em>Chodesh ha'aviv</em> (month of the green ears/spring grain) — later called Nisan in the post-exilic calendar. <em>Pesach</em> (Passover) from <em>pasach</em> (to pass over, to skip; also possibly to protect or leap over). The Passover is the founding festival of Israel's identity as a redeemed people: the night of exodus (laylah) is the pivot of the nation's existence. Paul explicitly identifies Christ as the Passover lamb (1 Cor 5:7: <em>our Passover lamb, Christ, has been sacrificed</em>), and John times the crucifixion to coincide with the slaughter of the Passover lambs (John 19:14,31).</p>",
    "20": "<p><strong>tzedek tzedek tirdof lema'an tichyeh veyarashta et-ha'aretz asher YHWH Eloheicha noten lach</strong> (<em>ṣedeq ṣedeq tirdōp̄ lĕmaʿan tiḥyeh wĕyāraštā ʾet-hāʾāreṣ ʾăšer Yhwh ʾĕlōhêkā nōtēn lāk</em>): 'Justice, and only justice, you shall pursue, that you may live and inherit the land that the LORD your God is giving you.' <em>Tzedek tzedek tirdof</em> — the doubled noun is for emphasis (justice, justice!) rather than mere redundancy: the repetition insists on justice that is thoroughgoing, not merely formal. <em>Tirdof</em> (you shall pursue/chase) is hunting vocabulary — active, vigorous pursuit of justice as one pursues prey, not passive compliance when convenient. The connection between justice and land-possession (<em>lema'an tikhyeh ve-yarashta</em>) makes the covenant's social ethics directly tied to covenant standing in the land. Amos 5:24 and Micah 6:8 echo the same conviction that covenant fidelity is measured in justice done to the vulnerable.</p>"
  },
  "17": {
    "6": "<p><strong>al-pi shnayim edim o shloshah edim yumot hamet al-pi ed echad lo yumot</strong> (<em>ʿal-pî šĕnayim ʿēdîm ʾô šĕlōšāh ʿēdîm yûmat hammēt ʿal-pî ʿēd ʾeḥād lōʾ yûmat</em>): 'On the evidence of two witnesses or of three witnesses the one who is to die shall be put to death; a person shall not be put to death on the testimony of one witness.' The multiple-witness principle appears throughout Torah (Num 35:30; Deut 19:15) and is the evidentiary foundation of Israelite jurisprudence. Jesus applies it to church discipline (Matt 18:16: if he does not listen, take one or two others along, so that every charge may be established by the evidence of two or three witnesses). Paul cites the exact formula in 2 Cor 13:1 and 1 Tim 5:19, extending it to apostolic authority and elder accountability. John 8:17 has Jesus cite it to validate his own self-testimony: in your Law it is written that the testimony of two people is true; I am the one who bears witness about myself, and the Father bears witness about me — claiming divine corroboration that meets the Torah standard.</p>",
    "18": "<p><strong>vehayah be'shivto al-kise mamlakhto vekatav lo et-mishneh hatorah hazot al-sefer milifnei hakohanim halevi'im</strong> (<em>wĕhāyāh kĕšibtô ʿal kissēʾ mamlaktô wĕkātab lô ʾet-mišnēh hattôrāh hazzōʾt ʿal-sēp̄er miliprĕnê hakkōhănîm hallwîyîm</em>): 'And when he sits on the throne of his kingdom, he shall write for himself in a book a copy of this law, approved by the Levitical priests.' <em>Mishneh hatorah</em> (copy/repetition of this law) — this phrase is often thought to be the Hebrew original behind the Greek <em>deuteronomion</em>, giving the book its Greek name Deuteronomy. The king must personally copy the Torah (<em>katav lo</em>, write for himself) and read it all the days of his life (v. 19) so that his heart is not lifted up above his brothers. No hereditary autocracy; the king is bound by the same covenant-word as every Israelite. The ideal king is therefore not the triumphant warrior but the Torah-student who rules under the law. Psalm 119 may be read as the meditation of such a king; and the NT presents Jesus as the one who fulfills the law (Matt 5:17) from inside it.</p>"
  },
  "18": {
