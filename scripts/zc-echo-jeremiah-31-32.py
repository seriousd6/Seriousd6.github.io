...
JER_ECHO = {
  ...
  "31": {
    ...
    "33": [
      {"type": "fulfillment", "target": "2 Cor 3:3", "note": "I will put my law in their minds and write it on their hearts — Paul describes the Corinthian church as 'a letter from Christ, written not with ink but with the Spirit of the living God, not on tablets of stone but on tablets of human hearts' (2 Cor 3:3); the Spirit is the agent who performs the inner writing that Jer 31:33 promised; the law-on-heart covenant is the new covenant effected by the Spirit poured out through Christ."},
      {"type": "fulfillment", "target": "Heb 10:16", "note": "Hebrews quotes Jer 31:33 a second time (after the full citation in Heb 8:8-12) to apply the new covenant promise to Christ's once-for-all sacrifice: 'this is the covenant I will make with them after that time, says the Lord: I will put my laws in their hearts and write them on their minds'; the inner law is the fruit of the completed atonement, not merely a promise awaiting fulfillment."}
    ],
    "34": [
      {"type": "fulfillment", "target": "Heb 8:11-12", "note": "No longer will they teach their neighbor: Know the LORD, because they will all know me, from the least to the greatest; I will forgive their wickedness and remember their sins no more — Hebrews 8:11-12 quotes this as the climax of the new covenant: priestly mediation is obsolete because Christ's high-priestly sacrifice achieves the definitive atonement that makes sins not merely covered but forgotten; the universal direct knowledge of YHWH promised here is the fruit of Christ's finished work."},
      {"type": "allusion", "target": "John 6:45", "note": "They will all know me — Jesus cites the 'all taught by God' principle (Isa 54:13, parallel to Jer 31:34) to explain why those drawn by the Father come to him (John 6:45); the new covenant's direct-knowledge promise is arriving in Jesus; knowing God now means knowing the Son whom the Father has sent."}
    ]
  },
  "32": {
    "6": [
      {"type": "allusion", "target": "Matt 13:44", "note": "The field purchase during the siege as an enacted sign of hope — Jeremiah's word from YHWH to buy a field when Jerusalem is under siege and fields are worthless is a costly parable of faith in an impossible future; Jesus's parable of the man who sells everything to buy a field where treasure is hidden (Matt 13:44) resonates with the same pattern: a field is purchased at an unlikely moment because the one who sees its hidden value knows it is worth everything; both acts of purchase express faith against visible circumstances."}
    ],
    "9": [
      {"type": "allusion", "target": "Matt 27:9-10", "note": "Seventeen shekels of silver paid at Anathoth — Matthew's citation of a field-and-silver oracle (attributed to 'Jeremiah the prophet' in Matt 27:9-10, though quoting Zechariah) draws on the Jeremianic field-purchase tradition; both involve a field purchased for silver that becomes a prophetic sign; the Potter's Field bought with Judas's thirty pieces of betrayal-silver inverts Jeremiah's sign: Anathoth purchased in faith anticipates restoration-life, while Akeldama purchased in guilt becomes a field of death."},
      {"type": "allusion", "target": "Acts 1:18-19", "note": "The field bought at Anathoth as a sign that houses and fields will again be bought in the land (v15) is ironically echoed by Acts 1:18-19's Field of Blood (Akeldama), where Judas died; the contrast is instructive: Jeremiah's field-purchase is the sign of covenant hope enacted in judgment, while the blood-money field is the sign of betrayal; Christ's death absorbs both — the curse (Akeldama) to achieve the restoration that Anathoth signified."}
    ],
    "17": [
      {"type": "allusion", "target": "Luke 1:37", "note": "Ah, Lord GOD! You have made the heavens and the earth by your great power and outstretched arm. Nothing is too hard (Hebrew: pala', wondrous/impossible) for you — Gabriel echoes this confession to Mary: 'nothing will be impossible (Greek: adynateō) with God' (Luke 1:37); Jeremiah's prayer of faith under siege becomes the angel's reassurance that a virgin can bear the Son of God; the Creator who held nothing back in making the cosmos holds nothing back in the incarnation."},
      {"type": "allusion", "target": "Matt 19:26", "note": "Nothing is too hard for YHWH — Jesus echoes the same principle when his disciples despair at salvation's impossibility: 'with man this is impossible, but with God all things are possible' (Matt 19:26); the divine omnipotence Jeremiah confesses amid the siege is the same power by which Christ saves, raises the dead, and brings in the kingdom."}
    ],
    "27": [
      {"type": "allusion", "target": "Gen 18:14", "note": "I am the LORD, the God of all humanity. Is there anything too hard for me? — YHWH's challenge repeats the question first put to Abraham and Sarah: 'Is anything too hard for the LORD?' (Gen 18:14), when Isaac's birth seemed impossible; the pattern runs from Sarah's laughter → Jeremiah's faith under siege → Mary's yes to Gabriel; God consistently does what lies beyond all human capacity."},
      {"type": "allusion", "target": "Luke 1:37", "note": "Is anything too hard for me? — the divine self-declaration establishes the theological ground Gabriel cites directly; YHWH's omnipotence over ruined cities (Jer 32:27) and over human biology (Luke 1:37) are the same claim; the God who can restore a destroyed temple-city can bring his Son into the world through a virgin."}
    ],
    "38": [
      {"type": "fulfillment", "target": "Rev 21:3", "note": "They will be my people, and I will be their God — the covenant formula of Lev 26:12 renewed as a new covenant promise; Revelation 21:3 is its eschatological consummation: 'Look! God's dwelling place is now among the people, and he will dwell with them. They will be his people, and God himself will be with them and be their God'; the restored covenant of Jer 32:38 reaches its fullness in the new Jerusalem where no siege or exile is possible."},
      {"type": "allusion", "target": "2 Cor 6:16", "note": "I will be their God and they will be my people — Paul cites this formula in 2 Cor 6:16 to describe the church as the temple of the living God; the covenant community formed by the new covenant is the Spirit-indwelt body that embodies God's presence in the world between the advents; Jer 32:38's promise is already being fulfilled in the church."}
    ],
    "39": [
      {"type": "allusion", "target": "Acts 4:32", "note": "I will give them one heart and one way of life, that they may fear me always — the early church of Acts 4:32 is described as 'one in heart and mind (literally: one heart and one soul)'; this is the Spirit's firstfruits fulfillment of Jer 32:39's new covenant promise; the Pentecost community unified in devotion and sharing is the initial demonstration that YHWH's one-heart promise is being enacted in those who belong to Christ."},
      {"type": "allusion", "target": "Ezek 11:19", "note": "I will give them one heart — Ezekiel's parallel promise develops the same hope: 'I will give them one heart and put a new spirit within them; I will remove from them their heart of stone' (Ezek 11:19); both Jeremiah and Ezekiel point to the same inner transformation that the Spirit accomplishes in those united to Christ, replacing divided, hardened hearts with unified, responsive ones."}
    ],
    "40": [
      {"type": "fulfillment", "target": "Heb 13:20", "note": "I will make an everlasting covenant with them, and I will never stop doing good to them — Heb 13:20 is the only NT text that uses 'eternal covenant' explicitly: 'the God of peace who brought back from the dead our Lord Jesus, that great shepherd of the sheep, through the blood of the eternal covenant'; the verse directly connects Christ's resurrection to the fulfillment of YHWH's everlasting covenant promise; the blood that seals the eternal covenant is Christ's own."},
      {"type": "allusion", "target": "Luke 22:20", "note": "I will never turn away from doing good to them — the new covenant sealed in Jesus's blood at the Last Supper (Luke 22:20: 'this cup is the new covenant in my blood') is the enactment of YHWH's pledge of permanent faithfulness; the everlasting covenant that can never be broken is ratified by the blood of the mediator who cannot remain in death."}
    ],
    "41": [
      {"type": "allusion", "target": "Matt 22:37", "note": "I will rejoice in doing them good and will plant them firmly in this land, with all my heart and all my soul — YHWH pledges covenant faithfulness using the language of the Shema (Deut 6:5: love YHWH with all your heart and soul); the great commandment is here projected back onto God himself as YHWH's self-description; in Christ, God embodies this whole-heart, whole-soul love — the command reveals what God is before it demands what we must be."},
      {"type": "allusion", "target": "Zeph 3:17", "note": "YHWH will rejoice over you with gladness and exult over you with singing (Zeph 3:17) — both Zephaniah and Jeremiah depict YHWH acting in restoration with extravagant, whole-soul delight; the divine rejoicing finds its NT form in the parables of Luke 15, where the father runs toward the prodigal and throws his arms around him — God's whole-heart covenant love displayed in the reception of the returning son."}
    ]
  }
}
