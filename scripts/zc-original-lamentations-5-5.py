...
LAM_ORIGINAL = {
  ...
  "5": {
    "1": "<p><strong>zekor YHWH meh hayah lanu</strong>: 'Remember, O LORD, what has happened to us.' The chapter opens with an imperative petition: <em>zekor</em> (remember, take notice, act). Throughout the OT, divine 'remembering' is not merely cognitive recall but saving action — YHWH remembered Noah (Gen 8:1), remembered Hannah (1 Sam 1:19), remembered the covenant (Exod 2:24). The petition here is: 'Act now on what you know of our condition.' The matching counterpart comes at v20: 'Why have you forgotten us forever?' — the prayer is framed by the contrast between what memory-as-action should do and what YHWH's silence seems to demonstrate. <em>Habbita ure'eh et cherpateinu</em>: 'Look and see our disgrace [<em>cherpah</em>].' <em>Cherpah</em> is the term for public shame, the reproach that falls on those abandoned by God and defeated before enemies (cf. 2:15; Jer 20:8; Ps 22:6). Chapter 5 is not an acrostic (unlike chs. 1-4) — it has 22 verses matching the Hebrew alphabet but no alphabetic ordering. The formal structure collapses into raw petition; artistic discipline gives way to direct prayer.</p>",
    "2": "<p><strong>nachalateinu nehavekah lezarim batteinu lenokrim</strong>: 'Our inheritance has been given over to strangers, our houses to foreigners.' <em>Nachalah</em> (inheritance) is the covenantal term for Israel's portion of the land — the land YHWH gave to the fathers as a permanent possession (Deut 4:21; Josh 11:23). The transfer of <em>nachalah</em> to strangers is not merely an economic catastrophe; it is the dissolution of the covenant sign. Land tenure in Israel was theological: it confirmed YHWH's ongoing commitment to the Abrahamic promise. To lose the land to foreigners is to have the covenant promise publicly revoked. <em>Zarim</em> (strangers) and <em>nokrim</em> (foreigners) are both terms of alienness — those with no claim on Israel's covenant or territory.</p>",
    "3": "<p><strong>yetomim hayinu vein av imotenu kealmanot</strong>: 'We have become fatherless orphans; our mothers are as widows.' The social categories here — <em>yetomim</em> (orphans, fatherless) and <em>almanot</em> (widows) — were Israel's most vulnerable people, protected by covenant law (Deut 24:17-21; Isa 1:17). The community now inhabits the condition of those at the bottom of the covenant social order. 'Fatherless' (<em>yetomim</em>) is not only social; it is theological — YHWH is the 'Father of the fatherless' (Ps 68:5), so that Israel's experience of fatherlessness implicitly cries out to YHWH as the only one who can fill that role. The widow-and-orphan imagery recurs from 1:1 (Jerusalem is like a widow) — the city and its people share the same bereaved condition.</p>",
    "4": "<p><strong>meimeinu bekesef shatimu etzeinu bimhir yavou</strong>: 'We pay money for the water we drink; our wood must be bought at cost.' Water and wood — the most basic necessities of life in an agrarian society — are now commodities the community must purchase rather than draw freely from their own land and forests. In the covenant framework, the land's provision was a sign of YHWH's blessing; the Deuteronomic curse was removal of that provision (Deut 28:23-24: YHWH would make the sky bronze and the earth iron, withholding rain). The community pays strangers for what the land used to give freely, enacting the Deuteronomic curse in daily economic life. <em>Bekesef</em> (for silver/money) and <em>bimhir</em> (at cost/price) emphasize the transactional reversal: blessing used to be free gift; now it is a commodity bought from occupiers.</p>",
    "5": "<p><strong>al tzavarenu nirdafnu yaganu velo huna lanu</strong>: 'Our pursuers are at our necks; we are driven hard with no rest.' The image of oppressors at the <em>tzavar</em> (neck) is the posture of domination — a conqueror's foot or yoke on the neck of the conquered (cf. Josh 10:24; Isa 10:27). This 'yoke on the neck' language inverts the Exodus: YHWH broke Egypt's yoke from Israel's neck (Lev 26:13); now Israel bears a yoke again. <em>Lo huna lanu</em>: 'No rest is given to us' — <em>manoach</em> (rest) was the gift of the land (Deut 12:9-10; Josh 21:44). The restlessness of exile enacts the covenant curse: 'among these nations you will find no repose, and there shall be no resting place for the sole of your foot' (Deut 28:65).</p>",
    "6": "<p><strong>Mitzraim natanu yad Ashur liso'a lachem</strong>: 'We gave our hand to Egypt and to Assyria in order to get enough bread.' <em>Natan yad</em> (gave the hand) is an idiom for entering political submission or alliance — extending the hand in fealty (cf. 1 Chr 29:24; 2 Chr 30:8). The irony is devastating: Israel sought bread from Egypt and Assyria — the very powers YHWH had liberated them from or warned them against. The prophets repeatedly condemned such foreign alliances as covenant unfaithfulness (Isa 31:1: 'Woe to those who go down to Egypt for help'; Hos 7:11; Ezek 23). In seeking bread from these empires, Israel enacts the reversal of the Exodus and affirms what the exile demonstrated: they chose the bread of subjugation over the manna of covenant dependence.</p>",
    "7": "<p><strong>avoteinu chatu veinam anachnu avonoteyhem savulnu</strong>: 'Our fathers sinned and are gone; we carry the weight of their iniquities.' This verse engages the deepest problem of exile theodicy: transgenerational guilt. The community does not claim personal innocence but notes the bitterness of bearing the weight (<em>savulnu</em>, we have borne/carried) of what others originated. The tension with Ezekiel's contemporaneous teaching (Ezek 18:20: the soul who sins shall die; the son shall not suffer for the father's iniquity) is real and intentional — Ezekiel insists on individual accountability; Lamentations acknowledges the historical reality that communities bear accumulated consequences. <em>Avonoteyhem</em> (their iniquities) — the same word used in Isa 53:11, where the Servant 'bears' (<em>yisbol</em>) iniquities: a significant lexical echo that the NT reads as Christ bearing what was not his own.</p>",
    "8": "<p><strong>avadim mashlu vanu poreh ein miyyadam</strong>: 'Slaves rule over us; there is no one to rescue us from their power.' <em>Avadim</em> (slaves/servants) in positions of rule is a profound social inversion — Proverbs 30:22 lists a slave becoming king as one of four things that make the earth tremble. <em>Ein poreh</em>: 'no one delivers' — <em>paraq</em> means to snatch away, rescue violently (cf. Ps 136:24: YHWH 'snatched us from our foes'). The divine Rescuer who tore Israel from Egypt has not appeared; there is no deliverer from the Babylonian yoke. The absence of a human deliverer points to the need for one YHWH will provide — the <em>go'el</em> (kinsman-redeemer) theology that underpins the NT's presentation of Christ as the one who rescues where no human rescuer exists.</p>",
    "9": "<p><strong>benafsheinu navi lachmeinu mippene cherev hamidbar</strong>: 'We risk our lives to get our bread, because of the sword that threatens in the open country.' <em>Benafsheinu</em>: 'at the cost of our <em>nephesh</em>' — the <em>nephesh</em> (life-breath, animate self) is placed at risk in the simple act of gathering food. The open country (<em>hamidbar</em>, the wilderness/field) that should provide food now threatens death. The image echoes the wilderness wandering: in the desert YHWH provided manna so Israel did not have to risk its life for food; now in a second exile-wilderness, they risk everything for bread. The perversion of the basic provision-of-bread that YHWH designed reflects the total reversal of covenant blessing.</p>",
    "10": "<p><strong>oreinu ketannur nichtamu mippene zal'afot ra'av</strong>: 'Our skin burns hot as an oven because of the fever brought on by famine.' <em>Zal'afot</em> (fever, scorching wind, burning blast) is a rare term (cognate with <em>zal'afah</em> in Ps 11:6) suggesting the kind of burning heat associated with divine judgment as well as physical fever. Famine's physical effects — the skin darkening and tightening against the bones — are described in clinical detail throughout Lamentations (1:11; 2:11-12; 4:7-8). The <em>tannur</em> (oven/furnace) image connects to prophetic judgment language (Mal 4:1: the day is coming, burning like an oven) — here the community's physical suffering enacts in their bodies the judgment that fell on the city.</p>",
    "11": "<p><strong>nashim beTziyon innu betulot be'arei Yehudah</strong>: 'Women have been violated in Zion, young women in the towns of Judah.' <em>Innu</em> (they violated, they humiliated) is the verb for sexual violence — the same root used of Tamar's rape (2 Sam 13:12), the Levite's concubine (Judg 19:24), and Dinah (Gen 34:2). The violation of <em>betulot</em> (young women, virgins) in Zion — the holy city — is part of Lamentations' unflinching account of total defeat. The protection of women was one of the duties of men and community in the ancient world; the inability to protect signals total social collapse. The violation of Zion's women is also the defilement of the holy city itself — the city that was supposed to be inviolable under YHWH's protection (Ps 46:5) is violated along with its inhabitants.</p>",
    "12": "<p><strong>sarim beyadam nitlu pene zekenim lo nehddaru</strong>: 'Princes have been hanged by their hands; no honor is shown to the faces of elders.' <em>Sarim</em> (princes, officials) hung by their hands likely describes public execution by impalement or exposure — a form of humiliation reserved for enemies and criminals, not nobility. The public disgrace of leadership is complete: neither the young authorities (<em>sarim</em>) nor the old (<em>zekenim</em>, elders) retain their dignity. In the ancient honor-shame culture, showing honor to the <em>penim</em> (face) of elders was a fundamental social obligation (Lev 19:32: 'honor the face of an old man'). The suspension of this basic norm signals the dissolution of all social order — the community has no functional authority structure left.</p>",
    "13": "<p><strong>bachurim tachon nasa'u une'arim baeitz kashalu</strong>: 'Young men are set to work at the grinding stone; boys stagger under loads of wood.' The <em>tachon</em> (grinding stone) was women's and slaves' work in ancient Israel — forcing young men (<em>bachurim</em>, the prime of manhood, those eligible for military service) to grind grain is both economic exploitation and gender-role humiliation. <em>Ne'arim</em> (boys, young men) carrying heavy wood burdens describes forced labor in Babylonian imperial projects. The inversion is complete: those who should be bearing weapons bear millstones and wood loads. The systematic degradation of each social class and age group (elders at v12, young men and boys at v13) constitutes the picture of total social disintegration.</p>",
    "14": "<p><strong>zekenim mishsha'ar shavatu bachurim minneginatam</strong>: 'The elders have left the city gate; the young men have abandoned their music.' The <em>sha'ar</em> (city gate) was the center of civic life — the place where legal cases were heard (Ruth 4:1-11; Deut 21:19), commerce conducted, and elders governed. Its abandonment by the <em>zekenim</em> (elders) signals the end of ordered community life. Music — the <em>neginah</em> (string music, song) of young men — was associated with celebration, worship, and communal joy (cf. Ps 33:2-3; Amos 5:23). The double silence — legal authority gone, cultural expression gone — describes a community in which both civic order and cultural life have ceased entirely. The gate-as-place-of-judgment will be restored in the new Jerusalem (Rev 21:25: its gates will never be shut).</p>",
    "15": "<p><strong>shavat masos libbenu nehpakh le'evel mecholenu</strong>: 'The joy of our hearts has ended; our dancing has turned into mourning.' <em>Masos</em> (joy, exuberant delight) is the term Jeremiah used when announcing the curse: YHWH would silence in Judah's cities the voice of mirth and gladness (Jer 7:34; 16:9; 25:10). Lamentations 5:15 is that prophecy's fulfillment: the <em>masos</em> has ceased. <em>Machol</em> (dancing) is elsewhere the instrument of Israel's praise and celebration of YHWH's saving acts (Ps 149:3; 150:4). The inversion — dancing (<em>machol</em>) to mourning (<em>evel</em>) — is the exact reversal of the covenant blessing; Jeremiah 31:13 promises YHWH will 'turn their mourning into joy' and 'their sorrow into gladness' as part of the new covenant restoration.</p>",
    "16": "<p><strong>nafela ateret roshenu oy na lanu ki chatanu</strong>: 'The crown has fallen from our head. Woe to us — we have sinned!' <em>Ateret</em> (crown, wreath) symbolizes honor, dignity, and divine favor throughout the prophets. Its 'falling' (<em>nafal</em>) is the physical enactment of the loss of status; the community has been stripped of every marker of dignity. The critical movement of this verse is the turn to confession: <em>oy na lanu ki chatanu</em> — 'Woe to us, for we have sinned.' This is Lamentations' most direct statement of communal sin and guilt. The book has moved through grief (chs. 1-2), individual lament and hope (ch. 3), divine wrath and community shame (ch. 4), and arrives here at explicit confession. The fallen crown and the word <em>chatanu</em> (we have sinned) are the theological hinge of the closing prayer: the community owns the cause of its condition before petitioning for restoration.</p>",
    "17": "<p><strong>al zeh hayah daveh libbenu al elleh chasheku einenu</strong>: 'Because of this our heart has grown faint; for all these things our eyes have become dim.' The physical symptoms of grief — <em>daveh lev</em> (faint/sick heart) and <em>chashaku einayim</em> (dimmed eyes) — are recognized in the OT as expressions of profound mourning and suffering. <em>Davah</em> (faint, sick) is the same root used in Isa 1:5 of Israel's sick heart and in Lam 1:22 of the individual lamenter's heart. Dimming eyes are associated with grief for the dead (Job 17:7; Ps 6:7) and with age. The verse presents the community as visibly wasting under the weight of accumulated loss — the physical is the register of the spiritual and communal suffering. 'Because of this' and 'for all these things' tie the bodily symptoms to the enumerated losses of vv. 1-16.</p>",
    "18": "<p><strong>al har Tziyon sheshamem shu'alim hilechu vo</strong>: 'On account of Mount Zion, which lies desolate, jackals prowl across it.' <em>Tziyon sheshamem</em>: Zion desolate — the temple mount, YHWH's chosen dwelling place (Ps 132:13-14), now abandoned and inhabited by <em>shu'alim</em> (foxes/jackals). In the ancient world, wild animals colonizing abandoned cities was the ultimate sign of divine judgment and human absence; the prophets use this image explicitly (Isa 34:13-14 of Edom; Isa 13:21-22 of Babylon). The jackals on Zion invert the divine presence: where YHWH once dwelt in the temple, scavenging animals now roam. The verse prepares for the pivot to YHWH's eternal throne at v19 — the contrast is deliberately absolute: Zion completely desolate vs. YHWH's throne completely unaffected.</p>",
    "19": "<p><strong>atah YHWH le'olam teshev kisekha ledor vador</strong>: 'But you, O LORD, reign forever; your throne endures through all generations.' The theological pivot. Against the backdrop of total desolation — Zion in ruins, jackals on the temple mount — the prayer suddenly affirms the one thing that has not changed: YHWH's eternal kingship. <em>Le'olam</em> (forever, for the age) and <em>ledor vador</em> (from generation to generation) are the terms of divine permanence, contrasted with the destruction of everything human and temporal in vv. 1-18. The same formula appears in Ps 102:12 (a psalm which, like Lamentations, moves from Zion's desolation to YHWH's eternal reign and ends with prayer for restoration). The verse functions as the theological anchor: the lament is not addressed to an absence but to a King who remains, however silent. YHWH's throne (<em>kise</em>) endures when David's throne has fallen — pointing to the one whose throne endures by inheriting YHWH's eternal kingship (Luke 1:33).</p>",
    "20": "<p><strong>lama lanetzach tishkacheinu ta'azveinu le'orek yamim</strong>: 'Why have you forgotten us forever? Why have you forsaken us for such a long time?' The 'why' questions of lament (<em>lama</em>) are a standard form in the psalms of complaint (Ps 22:1; 44:23-24; 74:1). Two near-synonyms for divine abandonment are used: <em>tishkacheinu</em> (you forget us) and <em>ta'azveinu</em> (you forsake us). <em>Shakach</em> (to forget) is precisely what the petitioner asked YHWH NOT to do in v1 (<em>zekor</em>, remember) — the prayer is framed by desired memory vs. perceived forgetting. <em>Azav</em> (to forsake, abandon) is used of YHWH's relationship with Israel in Deut 31:6, 8 with the promise that YHWH will <em>never</em> forsake — making its use here as a question about YHWH's actual behavior all the more searching. <em>Le'orek yamim</em>: 'for so long a time' — the duration of exile makes divine forgetfulness seem like something more than temporary absence.</p>",
    "21": "<p><strong>hashivenu YHWH elekha venashuva chadesh yameinu kekedem</strong>: 'Restore us to yourself, O LORD, that we may be restored. Renew our days as in former times.' The famous <em>teshuvah</em> verse of Lamentations. <em>Hashivenu</em> is the Hiphil (causative) of <em>shuv</em> (to return, repent, be restored) — 'cause us to return.' The matching <em>venashuva</em> (and we will return/be restored) completes the covenant dynamic: YHWH must initiate the return because the community cannot accomplish it on their own. Jeremiah uses this formula as part of the new covenant promise (Jer 31:18: 'Restore me, and I will be restored' — the same causative/intransitive pattern). The prayer recognizes that covenant restoration is not human achievement but divine gift: YHWH must first move, then the community can respond. <em>Chadesh yameinu kekedem</em>: 'renew our days as of old' — appealing to the Exodus-era relationship as the model for restoration. Jewish liturgical practice reads this verse a second time after v22, insisting on ending with hope rather than desolation.</p>",
    "22": "<p><strong>ki im maos me'astanu qatzafta aleinu ad me'od</strong>: 'Or have you utterly rejected us? Are you exceedingly angry with us without end?' Lamentations closes on one of the Bible's most agonizing open questions. <em>Ki im</em> can introduce a strong contrary ('unless') or a resigned alternative ('or is it that...'). <em>Maos me'as</em>: the doubling of the verb (infinitive absolute + perfect) is the Hebrew idiom for complete, thoroughgoing action — 'utterly rejected' with no remainder. This is the question the community cannot answer: has YHWH's anger (<em>qetzef</em>, the intense divine wrath) passed its limit? The book ends without resolution — unlike most lament psalms, which move through petition to praise or assurance. The unresolved ending is the book's own theological act: exile is not resolved by literary closure; the community lives in the open question. Theologically, the open question of v22 is answered by the canon: the book is located within a Scripture that will ultimately declare that YHWH's rejection is not total — the resurrection of Christ is the definitive answer to whether divine anger is 'without end.'</p>"
  }
}
