...
DEUT_ORIGINAL = {
  "3": {
    "11": "<p><strong>ki raq-Og melekh-haBashan nish'ar miyeter haRefa'im hineh arso arso-barzel</strong> (<em>kî raq-ʿÔg melek-habbāšān nišʾar miyyeter hārĕpāʾîm hinnēh ʿarśô ʿereś barzel</em>): 'For only Og the king of Bashan was left of the remnant of the Rephaim. Behold, his bed was a bed of iron.' The <em>Rĕpāʾîm</em> are a category of pre-Israelite inhabitants of Canaan associated with unusual size and formidable strength (Gen 14:5; 15:20; Deut 2:10-11, 20-21). Og's iron bed (<em>ʿereś barzel</em>) — nine cubits long (approximately 13.5 feet) and four cubits wide — was displayed at Rabbah of the Ammonites as a trophy confirming the tradition of his extraordinary stature. The defeat of Og, like that of Sihon (ch. 2), demonstrates that YHWH's guarantee of victory over the giant clans was not empty: the most formidable pre-Israelite ruler east of the Jordan was given into Israel's hand.</p>",
    "22": "<p><strong>lo-tira'u otam ki YHWH Eloheichem hu-hanilcham lachem</strong> (<em>lōʾ tîrĕʾû mēhem kî Yhwh ʾĕlōhêkem hû hananicḥlām lākem</em>): 'You shall not fear them, for it is the LORD your God who fights for you.' The divine warrior formula — YHWH himself as Israel's fighter — is the theological summary of Israel's entire military history east of the Jordan. <em>Hu-hanilcham lachem</em> (he is the one who fights for you): the participial form stresses YHWH's ongoing fighting posture, not a one-time act. This formula recurs throughout the conquest narrative (Josh 10:42; 23:3,10) and becomes the basis of Israel's liturgical confidence in YHWH as the warrior who goes before his people (Exod 14:14; Ps 18).</p>",
    "26": "<p><strong>vayit'aber YHWH bi lema'ankhem velo-shama elai vayomer YHWH elai rav-lach al-tosef daber elai od badavar hazeh</strong> (<em>wayyitʿabbēr Yhwh bî lĕmaʿankhem wĕlōʾ šāmaʿ ʾēlay wayyōʾmer Yhwh ʾēlay rab-lāk ʾal-tôsep̄ dabbēr ʾēlay ʿôd baddābār hazzeh</em>): 'But the LORD was angry with me on your account and would not listen to me. And the LORD said to me, 'Enough from you; do not speak to me of this matter again.'' <em>Wayyitʿabbēr YHWH bî</em> — YHWH crossed over into anger against Moses on Israel's account (<em>lĕmaʿankhem</em>). The verb <em>ʿābar</em> in the Hithpael means to become intensely angry. Moses's intercessory prayer for permission to cross the Jordan (vv. 23-25) was denied with finality: <em>rab-lāk</em> (enough for you). Moses is forbidden from the land not because he is unloved (YHWH's tenderness in v. 27 is evident) but because his striking of the rock (Num 20:7-12) had disqualified him and because he bore the consequences of Israel's corporate sin as their representative leader.</p>"
  },
  "4": {
    "2": "<p><strong>lo-tosefu al-hadavar asher anochi metzaveh etchem velo tigre'u mimenu lishmor et-mitzvot YHWH Eloheichem asher anochi metzaveh etchem</strong> (<em>lōʾ tōsipû ʿal-haddābār ʾăšer ʾānōkî mĕṣawweh ʾetkkem wĕlōʾ tigĕrĕʾû mimmennû lišmōr ʾet-miṣwōt Yhwh ʾĕlōhêkem ʾăšer ʾānōkî mĕṣawweh ʾetkkem</em>): 'You shall not add to the word that I command you, nor take from it, that you may keep the commandments of the LORD your God that I command you.' The double prohibition — neither addition (<em>tōsipû</em>) nor subtraction (<em>tigĕrĕʾû</em>) — defines the canonical boundary of Torah. The same formula reappears in Deut 12:32 and in Revelation's closing warning (22:18-19), which applies it to the entirety of Scripture. The principle is that the covenant document is complete and authoritative as given; human modification in either direction distorts the covenant relationship it mediates.</p>",
    "12": "<p><strong>vayedabber YHWH aleichem mitoch ha'esh kol devarim atem shomim utemunah einekhem ro'im zulati kol</strong> (<em>waydabbēr Yhwh ʾălêkem mittôk hāʾēš qôl dĕbārîm ʾattem šōmĕʿîm ûtĕmûnāh ʾênkem rōʾîm zûlātî qôl</em>): 'Then the LORD spoke to you out of the midst of the fire. You heard the sound of words, but saw no form; there was only a voice.' The programmatic invisibility of YHWH at Horeb is Deuteronomy's key theological safeguard against idolatry: Israel heard <em>kol devarim</em> (sound/voice of words) but saw <em>temunah</em> (form, likeness) of none. The noun <em>temunah</em> is the same word Moses uses of himself in Num 12:8 (Moses sees the <em>temunah</em> of YHWH — a special prophetic privilege that proves the rule of hiddenness). The invisibility grounds the second commandment: since YHWH showed no visible form, any representation is a falsification. John 1:18 ('no one has ever seen God') and John 5:37 ('his form you have never seen') stand in direct continuity with this Deuteronomic tradition.</p>",
    "24": "<p><strong>ki YHWH Eloheicha esh okhlah hu El kanna</strong> (<em>kî Yhwh ʾĕlōhêkā ʾēš ʾōklāh hûʾ ʾēl qannāʾ</em>): 'For the LORD your God is a consuming fire, a jealous God.' <em>Esh okhlah</em> (consuming fire) — fire that devours completely, leaving nothing. The image combines theophanic fire (Horeb), divine holiness, and judicial wrath. <em>El qanna</em> — the root <em>qn'</em> (jealousy/zeal) describes YHWH's exclusive claim on Israel's allegiance, corresponding to the marriage metaphor of covenant: YHWH as Israel's husband tolerates no rivals (Exod 20:5; 34:14). Hebrews 12:29 cites this verse directly in its climactic warning: 'for our God is a consuming fire' — the God of the new covenant is no less holy, his covenant-demands no less total, than at Sinai.</p>",
    "35": "<p><strong>Atah hor'eta lada'at ki YHWH hu ha-Elohim ein od milvado</strong> (<em>ʾAttāh horrĕtā lādaʿat kî Yhwh hûʾ hāʾĕlōhîm ʾên ʿôd milvaddô</em>): 'To you it was shown, that you might know that the LORD is God; there is no other besides him.' <em>Ein od milvado</em> — there is nothing else apart from him. This is Deuteronomy's foundational monotheistic formula, repeated in v. 39 and echoed throughout Second Isaiah (Isa 45:5,6,14,18,21,22; 46:9). The Horeb revelation — fire, darkness, cloud, and the voice of words — was given precisely to produce cognitive certainty (<em>lādaʿat</em>, to know) of YHWH's sole deity. The NT applies the same epistemological structure to Christ: the incarnation as the definitive showing (<em>horrĕtā</em>) that enables knowledge of God (John 1:18: the only God who is at the Father's side — he has made him known).</p>"
  },
  "6": {
