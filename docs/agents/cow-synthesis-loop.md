...
source `cow/<book>/<ch>.json` exists. As of 2026-07-19: **587/1,189 done,
frontier = 2 Kings 14** (Genesis→1 Kings and the whole NT are complete;
2 Kings is missing 14, 15, 17–25; Chronicles→Malachi untouched).
