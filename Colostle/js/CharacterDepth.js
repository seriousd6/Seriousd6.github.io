...
let flawBackstory = [
    ...
    `Being subjected to gaslighting and manipulation in a toxic workplace environment.`,
    ...
    `Coping with the emotional fallout of being a victim of cyberbullying or online harassment.`,
    ...
    `Coping with the emotional impact of being a victim of workplace harassment or discrimination.`,
    ...
    `Coping with the emotional impact of being a victim of workplace bullying or harassment.`,
    ...
    `Coping with the emotional impact of being a victim of cyberstalking or online harassment.`,
...
let minorGoals = [
    ...
    `Learn to code or develop computer programming skills.`,
...
let emotionalLandscape =[//give an array of sources of pain for a character
    //sources of joy
        [
            `Finding love and experiencing a deep emotional connection with someone special.`,
            `Achieving a long-term goal or dream they have worked hard for.`,
            `Spending quality time with close friends and creating lasting memories together.`,
            `Exploring new places and experiencing different cultures during their travels.`,
            `Witnessing the beauty of nature, like a breathtaking sunrise or a star-filled night sky.`,
            `Accomplishing something challenging and feeling a sense of pride and accomplishment.`,
            `Receiving recognition and praise for their achievements from others.`,
            `Enjoying their favorite hobbies or activities that bring them pure joy and relaxation.`,
            `Bonding with a pet and experiencing the unconditional love and companionship they offer.`,
            `Creating and sharing art, music, or writing that resonates with others and brings them joy.`,
            `Being with family and experiencing a sense of love, belonging, and support.`,
            `Laughing uncontrollably with friends or loved ones and feeling carefree in that moment.`,
            `Overcoming a fear or personal obstacle and feeling a sense of empowerment.`,
            `Experiencing a deep sense of contentment and happiness in simple moments of life.`,
            `Making someone else smile or helping others in need and feeling a sense of fulfillment.`,
            `Celebrating personal milestones and accomplishments with loved ones.`,
            `Engaging in acts of kindness and witnessing the positive impact they have on others.`,
            `Connecting with a kindred spirit or finding a true friend who understands and accepts them.`,
            `Experiencing a moment of pure serenity and tranquility in a peaceful setting.`,
            `Participating in an event or activity that triggers a strong sense of nostalgia and happiness.`,
            `Reuniting with a long-lost friend or family member and cherishing the time spent together.`,
            `Accomplishing a selfless act of kindness or charity and seeing the positive impact it has on others.`,
            `Finding inner peace and self-acceptance after a period of self-discovery and reflection.`,
            `Learning a new skill or talent and feeling a sense of growth and personal development.`,
            `Escaping into a captivating book or movie that resonates deeply with their emotions.`,
            `Celebrating a special occasion or holiday with loved ones and creating cherished traditions.`,
            `Sharing a moment of laughter and joy with strangers, forging unexpected connections.`,
            `Overcoming a personal challenge or setback and realizing their inner strength and resilience.`,
            `Experiencing the thrill of adventure and exploration in a new and unfamiliar environment.`,
            `Attending a live performance or event that leaves them feeling inspired and uplifted.`,
            `Witnessing an act of kindness or compassion in others, reaffirming their belief in humanity.`,
            `Feeling a sense of accomplishment and fulfillment in giving back to their community.`,
            `Nurturing and seeing the growth of a plant or garden they've cared for with dedication.`,
            `Reveling in the beauty of a piece of art, whether it's a painting, sculpture, or performance.`,
            `Participating in a tradition or ritual that holds deep cultural or personal significance.`,
            `Engaging in a favorite childhood pastime or activity that brings back cherished memories.`,
            `Sharing a deep and meaningful conversation with someone and connecting on a profound level.`,
            `Witnessing a stunning natural phenomenon, such as a rainbow, waterfall, or blooming flowers.`,
            `Discovering a hidden talent or passion that ignites a newfound sense of purpose.`,
            `Embracing the feeling of freedom and liberation during a moment of carefree spontaneity.`,
            `Participating in a creative endeavor, such as painting, writing, or crafting, and feeling a sense of artistic expression.`,
            `Receiving words of encouragement and support from someone they admire, boosting their confidence.`,
            `Experiencing the joy of a pet's companionship and unconditional love.`,
            `Reflecting on a cherished memory from their past that brings a smile to their face.`,
            `Feeling a sense of accomplishment and pride in achieving a long-term goal or dream.`,
            `Taking a moment to appreciate the beauty of nature and finding solace in its tranquility.`,
            `Exploring a new culture or cuisine and delighting in the flavors and customs.`,
            `Attending a celebration or festival that fills them with a sense of joy and unity.`,
            `Witnessing a breathtaking sunrise or sunset that evokes a sense of wonder and awe.`,
            `Finding comfort in a favorite piece of clothing or accessory that holds sentimental value.`,
            `Completing a challenging puzzle or problem-solving task, experiencing the thrill of success.`,
            `Receiving a thoughtful and unexpected gesture of kindness from a stranger or acquaintance.`,
            `Being inspired by a mentor or role model and adopting their positive traits or values.`,
            `Discovering a piece of music or song that resonates deeply with their emotions.`,
            `Engaging in a moment of meditation or mindfulness, finding peace in the present moment.`,
            `Participating in a team sport or group activity, experiencing camaraderie and mutual support.`,
            `Embarking on a road trip or adventure with friends, creating lasting memories together.`,
            `Helping someone in need and feeling the warmth of gratitude in return.`,
            `Sharing a heartwarming moment with a child, embracing their innocence and joyfulness.`,
            `Taking time to relax and unwind in a favorite place or comfortable environment.`,
            `Spending time with loved ones and friends.`,
            `Achieving personal goals and milestones.`,
            `Engaging in favorite hobbies or pastimes.`,
            `Discovering new places and cultures during their journey.`,
            `Making meaningful connections with strangers along the way.`,
            `Finding solace in the beauty of nature and its wonders.`,
            `Experiencing moments of laughter and lightheartedness.`,
            `Enjoying delicious meals and savoring different cuisines.`,
            `Receiving words of encouragement and support from others.`,
            `Finding inner peace and contentment through meditation or reflection.`,
            `Uniting with a long-lost family member or old friend.`,
            `Experiencing the thrill of adventure and exploring the unknown.`,
            `Finding comfort in the company of a loyal companion or pet.`,
            `Expressing their creativity through art, music, or writing.`,
            `Celebrating victories and triumphs, no matter how small.`,
            `Witnessing acts of kindness and compassion from others.`,
            `Feeling a sense of belonging and acceptance within a community.`,
            `Encountering breathtaking landscapes and awe-inspiring sights.`,
            `Immersing themselves in the thrill of a thrilling challenge or competition.`,
            `Finding inspiration and hope through uplifting stories or legends.`,
            `Rediscovering lost memories or reconnecting with their past.`,
            `Experiencing the joy of giving and helping others in need.`,
            `Finding comfort in a warm and cozy home after a long journey.`,
            `Celebrating festivals and special occasions with loved ones.`,
            `Witnessing the beauty of a sunrise or sunset in a serene setting.`,
            `Embracing the feeling of accomplishment after overcoming a significant challenge.`,
            `Feeling the adrenaline rush during moments of daring and bravery.`,
            `Forming deep bonds of friendship and camaraderie with fellow travelers.`,
            `Learning from wise mentors and gaining valuable knowledge.`,
            `Enjoying the simple pleasures of life, like a good book or a quiet moment of reflection.`,
            `Finding closure or resolution in a long-standing conflict or dilemma.`,
            `Reveling in the sensation of freedom and independence during their adventures.`,
            `Experiencing the thrill of a successful heist or daring escapade.`,
            `Basking in the admiration and respect of others for their heroic deeds.`,
            `Witnessing acts of selflessness and compassion in the face of adversity.`,
            `Discovering hidden talents or abilities that were previously unknown.`,
            `Celebrating personal growth and transformation throughout their journey.`,
            `Experiencing the joy of reunification with a long-lost love or family member.`,
            `Finding comfort and support in the wise words of a mentor or elder.`,
            `Savoring the sense of accomplishment after completing a difficult quest or mission.`,
            `Experiencing the thrill of exploration and uncovering ancient mysteries.`,
            `Being recognized and appreciated for their unique talents or contributions.`,
            `Witnessing acts of bravery and heroism from others that inspire them.`,
            `Finding peace and serenity in a tranquil and picturesque setting.`,
            `Gaining a sense of purpose and direction through a newfound calling.`,
            `Embracing moments of laughter and camaraderie with their companions.`,
            `Finding joy in the little things, like a beautiful flower or a starry night sky.`,
            `Experiencing the rush of adrenaline during a daring rescue or escape.`,
            `Receiving tokens of gratitude and appreciation from those they've helped.`,
            `Feeling a sense of fulfillment in knowing they're making a positive impact on the world.`,
            `Discovering their inner strength and resilience during challenging times.`,
            `Relishing the feeling of being fully alive and present in the moment.`,
            `Experiencing the joy of a well-earned rest after a difficult journey.`,
            `Finding solace and comfort in a place that feels like home.`,
            `Feeling a deep connection to their cultural heritage and roots.`,
            `Experiencing the beauty of a starlit night or a picturesque landscape.`,
            `Reveling in the feeling of being part of a close-knit team or group.`,
            `Finding joy in the company of like-minded individuals and kindred spirits.`,
            `Celebrating personal growth and achievements along their path.`,
            `Experiencing the thrill of overcoming their fears and doubts to succeed.`,
            `Reveling in the satisfaction of solving a complex puzzle or mystery.`,
            `Finding joy in acts of selflessness and putting others before themselves.`,
            `Experiencing the wonder and awe of encountering magical or mystical phenomena.`,
            `Feeling a sense of purpose and fulfillment in fulfilling their destiny.`,
            `Finding joy in the pursuit of knowledge and learning new skills.`,
            `Experiencing the joy of freedom and autonomy in their adventures.`,
            `Relishing the taste of victory after a hard-fought battle or challenge.`,
            `Finding joy in connecting with the natural world and its creatures.`,
            `Experiencing the thrill of unexpected encounters and surprising twists in their journey.`,
            `Feeling a sense of pride and accomplishment in achieving personal goals.`,
            `Relishing the feeling of unity and camaraderie during moments of crisis.`,
            `Experiencing the joy of making a difference in the lives of others.`,
            `Finding solace and comfort in a cherished keepsake or memento.`,
            `Feeling a sense of wonder and awe at the beauty of the world around them.`,
            `Experiencing the joy of discovery and unearthing hidden secrets.`,
            `Relishing the feeling of being in harmony with the flow of destiny.`,
            `Finding joy in acts of kindness and helping those in need.`,
            `Feeling a sense of belonging and acceptance among diverse cultures and peoples.`,
            `Experiencing the thrill of adventure and the unknown in uncharted territories.`,
            `Relishing the feeling of growth and evolution as a person throughout their journey.`,
            `Finding joy in creating meaningful connections with others on their path.`,
            `Experiencing the thrill of standing up for what they believe in and defending their values.`,
            `Relishing the feeling of empowerment and agency in their choices and decisions.`,
            `Finding joy in the beauty and intricacy of art, architecture, and craftsmanship.`,
            `Experiencing the joy of unexpected blessings and fortuitous encounters.`,
            `Relishing the feeling of being part of a larger purpose or greater cause.`,
            `Finding joy in the simple pleasures of life, like a warm hearth or a delicious meal.`,
            `Experiencing the thrill of mastering a difficult skill or technique.`,
            `Relishing the feeling of being respected and admired by others.`,
            `Finding joy in the journey itself, regardless of the destination.`,
            `Experiencing the joy of forgiveness and reconciliation with a long-lost friend or family member.`,
            `Relishing the feeling of inner peace and contentment after overcoming inner conflicts or doubts.`,
            `Finding joy in acts of self-care and taking the time to rest and recharge.`,
            `Experiencing the thrill of unlocking hidden potential and discovering new abilities.`,
            `Relishing the feeling of camaraderie and shared purpose during epic battles or quests.`,
            `Finding joy in the bonds forged with companions and allies, becoming a family of their own.`,
            `Experiencing the joy of witnessing others' happiness and success, knowing they played a part in it.`,
            `Relishing the feeling of unity and solidarity during times of adversity and hardship.`,
            `Finding joy in the beauty of diversity and celebrating the uniqueness of each individual they encounter.`,
            `Experiencing the ultimate joy of fulfilling their goal and achieving their deepest desires, making their journey truly worthwhile.`
        ],
    //sources of pain
        [
            `The loss of a loved one, such as a family member, close friend, or romantic partner.`,
            `Facing the end of a significant relationship or going through a painful breakup.`,
            `Coping with the death of a beloved pet, who held a special place in their heart.`,
            `Experiencing a miscarriage or the loss of an unborn child.`,
            `Dealing with the emotional fallout of a traumatic event or accident.`,
            `Having to say goodbye to a cherished home or place due to circumstances beyond their control.`,
            `Witnessing the decline of a parent or loved one due to illness or aging.`,
            `Coping with the loss of a job or career, which represented a significant part of their identity.`,
            `Going through a difficult and drawn-out legal battle or dispute.`,
            `Feeling the pain of unfulfilled dreams and aspirations, leading to a sense of regret.`,
            `Grieving over the shattered hopes and expectations of a long-anticipated event or plan.`,
            `Coping with a severe illness or injury and the toll it takes on their physical and emotional well-being.`,
            `Dealing with the aftermath of a natural disaster that resulted in significant loss and upheaval.`,
            `Experiencing the dissolution of a close-knit friendship or social group.`,
            `Coping with the effects of a life-altering decision that leads to unintended consequences.`,
            `Grieving over the loss of trust in someone they once held dear.`,
            `Facing the consequences of a mistake or failure with severe repercussions.`,
            `Dealing with the void left by estrangement from a family member or loved one.`,
            `Experiencing the loss of a cherished possession or heirloom with sentimental value.`,
            `Coping with the emotional toll of long-term loneliness or social isolation.`,
            `Grappling with the guilt and remorse over past actions that have hurt others or themselves.`,
            `Coping with the grief of not being able to fulfill the expectations of others or live up to their own ideals.`,
            `Experiencing the sorrow of missed opportunities or chances not taken in life.`,
            `Dealing with the emotional aftermath of being betrayed by someone they deeply trusted.`,
            `Grieving the loss of innocence or a sense of security after going through a traumatic event.`,
            `Coping with the pain of being excluded or ostracized by a social group or community.`,
            `Experiencing the emotional toll of caring for a loved one with a debilitating illness or disability.`,
            `Dealing with the grief of losing touch with their cultural or familial roots.`,
            `Coping with the impact of addiction or substance abuse on their own life or a loved one's life.`,
            `Experiencing the heartache of unrequited love or a one-sided romantic relationship.`,
            `Grieving the loss of a cherished dream or life path due to circumstances beyond their control.`,
            `Coping with the emotional scars of past abuse or trauma and the long road to healing.`,
            `Dealing with the sorrow of feeling disconnected or out of place in their own community or society.`,
            `Experiencing the grief of unfulfilled ambitions or goals that have remained elusive.`,
            `Coping with the emotional burden of carrying the weight of their family's expectations or legacy.`,
            `Grieving the loss of a mentor or role model who played a significant role in their life.`,
            `Dealing with the pain of unresolved conflicts or unresolved issues with a loved one who has passed away.`,
            `Experiencing the sorrow of watching loved ones suffer without being able to help or alleviate their pain.`,
            `Coping with the emotional impact of being discriminated against or facing prejudice.`,
            `Dealing with the grief of having to make difficult choices that affect the lives of others.`,
            `Coping with the sorrow of a broken friendship or severed relationship with someone they once held dear.`,
            `Dealing with the grief of witnessing the destruction of a place or community they deeply cared for.`,
            `Experiencing the emotional pain of feeling isolated or disconnected from the world around them.`,
            `Grieving the loss of a beloved pet or companion animal that provided comfort and companionship.`,
            `Coping with the emotional aftermath of being the victim of a crime or violent act.`,
            `Dealing with the sorrow of feeling trapped in a situation or environment they desperately want to escape.`,
            `Experiencing the heartache of unmet expectations or feeling unfulfilled despite external success.`,
            `Coping with the emotional impact of being betrayed by a close friend or confidant.`,
            `Grieving the loss of a significant cultural or religious tradition that once held deep meaning.`,
            `Dealing with the pain of being haunted by past mistakes or decisions they regret.`, 
            `Suffering the loss of a loved one, leaving a deep void in their heart.`,
            `Enduring physical injuries or scars from dangerous encounters and battles.`,
            `Facing the consequences of past mistakes and regrets, haunted by guilt and remorse.`,
            `Experiencing betrayal by a close friend or ally, shattering their trust in others.`,
            `Dealing with the burden of responsibility and the fear of making wrong decisions.`,
            `Enduring emotional turmoil and inner conflicts that test their resolve and sanity.`,
            `Confronting their deepest fears and phobias, forcing them to confront their vulnerabilities.`,
            `Enduring the pain of rejection and unrequited love, feeling unimportant and unwanted.`,
            `Suffering from feelings of inadequacy and constantly comparing themselves to others.`,
            `Experiencing the agony of failure and setbacks, doubting their abilities and purpose.`,
            `Dealing with the burden of leadership and making tough choices that affect others' lives.`,
            `Enduring the pain of loneliness and isolation, feeling disconnected from the world.`,
            `Confronting a past trauma that resurfaces and brings back painful memories.`,
            `Experiencing the loss of their home or sense of belonging, feeling like an outsider.`,
            `Suffering from the effects of a curse or dark magic that plagues them physically or mentally.`,
            `Dealing with the betrayal of a trusted mentor or role model, feeling lost and disillusioned.`,
            `Enduring the torment of an internal struggle between their good and dark nature.`,
            `Confronting their own mortality and the fear of death, especially in life-threatening situations.`,
            `Experiencing the pain of unfulfilled dreams and aspirations, feeling stuck and hopeless.`,
            `Suffering from the weight of unresolved past conflicts and seeking closure.`,
            `Dealing with the consequences of a past decision that inadvertently harmed others.`,
            `Enduring the pain of witnessing the suffering of innocent people during their quest.`,
            `Experiencing the loss of a valuable possession or relic that held sentimental value.`,
            `Suffering from the burden of a prophecy or destiny that they feel they cannot escape.`,
            `Dealing with the betrayal of a former ally who turned to the side of evil.`,
            `Enduring the pain of unrequited love for someone they cannot be with.`,
            `Experiencing the agony of feeling powerless and unable to protect those they care about.`,
            `Suffering from feelings of self-doubt and the belief that they are unworthy of their goal.`,
            `Dealing with the pain of addiction or dependency on a harmful substance or habit.`,
            `Enduring the consequences of a past betrayal or act of betrayal that they committed.`,
            `Experiencing the torment of nightmares and visions that plague their sleep.`,
            `Suffering from the loss of their identity or memories due to a magical or cursed event.`,
            `Dealing with the pain of being manipulated or deceived by a cunning enemy.`,
            `Enduring the guilt of causing harm to others, even if it was unintentional.`,
            `Experiencing the pain of sacrificing their own well-being for the greater good.`,
            `Suffering from the burden of keeping a dark secret that could destroy their reputation.`,
            `Dealing with the pain of being ostracized or misunderstood by society for their actions.`,
            `Enduring the agony of being captured or imprisoned by their enemies.`,
            `Experiencing the pain of losing their abilities or powers due to a curse or magical interference.`,
            `Suffering from the emotional toll of being separated from their loved ones during their quest.`,
            `Dealing with the pain of being haunted by a malevolent spirit or entity.`,
            `Enduring the torment of constant nightmares and visions of a grim future.`,
            `Experiencing the pain of witnessing the destruction of a place they once called home.`,
            `Suffering from the burden of a dark secret that could harm their loved ones if revealed.`,
            `Dealing with the pain of being manipulated and used as a pawn in a larger scheme.`,
            `Enduring the agony of being cursed with immortality, watching loved ones age and pass away.`,
            `Experiencing the pain of losing a close companion or ally during their journey.`,
            `Suffering from the emotional toll of being estranged from their family due to their quest.`,
            `Dealing with the pain of facing a formidable and seemingly unbeatable adversary.`,
            `Enduring the torment of self-doubt and the fear of not being strong enough to succeed.`,
            `Experiencing the pain of being hunted by relentless enemies who want to end their quest.`,
            `Suffering from the burden of a prophecy that foretells their own tragic demise.`,
            `Dealing with the pain of being cursed to experience the emotions and memories of others.`,
            `Enduring the agony of having to make difficult sacrifices for the greater good.`,
            `Experiencing the pain of losing their voice or ability to communicate effectively.`,
            `Suffering from the emotional toll of being betrayed by someone they deeply trusted.`,
            `Dealing with the pain of being torn between loyalty to two conflicting factions.`,
            `Enduring the torment of being haunted by the ghosts of their past mistakes.`,
            `Experiencing the pain of being cursed with bad luck, leading to constant misfortune.`,
            `Suffering from the burden of a relentless pursuit by a vengeful nemesis.`,
            `Dealing with the pain of being torn between duty and personal desires.`,
            `Enduring the agony of being separated from a loved one for an extended period.`,
            `Experiencing the pain of witnessing the suffering of innocent creatures or animals.`,
            `Suffering from the emotional toll of having to make life and death decisions.`,
            `Dealing with the pain of being haunted by past traumas and memories.`,
            `Enduring the torment of being cursed with a physical ailment or disability.`,
            `Experiencing the pain of losing all hope and feeling completely defeated.`,
            `Suffering from the burden of carrying the weight of the world's expectations.`,
            `Dealing with the pain of being rejected or ostracized by their own allies.`,
            `Enduring the agony of being forced to confront their own deepest fears.`,
            `Experiencing the pain of losing their connection to a higher power or deity.`,
            `Suffering from the emotional toll of being manipulated by a charismatic villain.`,
            `Dealing with the pain of feeling disconnected from their own emotions.`,
            `Enduring the torment of feeling responsible for the destruction caused by their quest.`,
            `Experiencing the pain of being haunted by the mistakes of their ancestors.`,
            `Suffering from the burden of an unrelenting sense of guilt or remorse.`,
            `Dealing with the pain of being cursed with visions of a bleak and hopeless future.`,
            `Enduring the agony of having their most cherished beliefs and values challenged.`,
            `Experiencing the pain of feeling abandoned or betrayed by a mentor or role model.`,
            `Suffering from the emotional toll of feeling isolated and alone on their journey.`,
            `Dealing with the pain of being manipulated by a powerful and malevolent force.`,
            `Enduring the torment of being plagued by recurring nightmares of their past.`,
            `Experiencing the pain of feeling powerless and unable to protect those they care about.`,
            `Suffering from the burden of a deep-seated guilt over a past mistake with grave consequences.`,
            `Dealing with the pain of being haunted by the ghosts of fallen enemies or victims.`,
            `Enduring the agony of facing the consequences of their reckless actions.`,
            `Experiencing the pain of losing a cherished possession or artifact of great significance.`,
            `Suffering from the emotional toll of being burdened with the responsibility of saving the world.`,
            `Dealing with the pain of being betrayed by someone they considered a close friend.`,
            `Enduring the torment of being manipulated by their own inner demons and doubts.`,
            `Experiencing the pain of being cursed with the knowledge of a terrible future event.`,
            `Suffering from the burden of a prophecy that paints them as the bringer of destruction.`,
            `Dealing with the pain of feeling disconnected from their own identity and purpose.`,
            `Enduring the agony of being forced to confront the consequences of their past actions.`,
            `Experiencing the pain of losing their memory and struggling to piece together their past.`,
            `Suffering from the emotional toll of witnessing the suffering and despair of others.`,
            `Dealing with the pain of being cursed with the ability to see the impending deaths of loved ones.`,
            `Enduring the torment of being haunted by the restless spirits of those they could not save.`,
            `Experiencing the pain of being manipulated by an alluring and deceptive enemy.`,
            `Suffering from the burden of a deep-rooted fear of failure and letting others down.`,
            `Dealing with the pain of unrequited love and the fear of never finding true companionship.`,
            `Enduring the agony of being burdened with a family legacy that they want to escape.`,
            `Experiencing the pain of feeling overshadowed by a sibling or rival throughout their life.`,
            `Suffering from the emotional toll of feeling responsible for the destruction caused by their own powers.`,
            `Dealing with the pain of being haunted by the memory of a loved one they couldn't save.`,
            `Enduring the torment of feeling trapped in a life that they never wanted or chose.`,
            `Experiencing the pain of being cursed with an uncontrollable rage or violent temper.`,
            `Suffering from the burden of a secret that they fear would shatter their reputation if revealed.`,
            `Dealing with the pain of being torn between their loyalty to their duty and their desire for freedom.`,
            `Enduring the agony of losing their faith in the cause they once passionately believed in.`,
            `Experiencing the pain of being cursed with a physical or mental affliction that worsens over time.`,
            `Suffering from the emotional toll of being haunted by the memory of a fallen comrade.`,
            `Dealing with the pain of being manipulated by a charismatic and persuasive enemy leader.`,
            `Enduring the torment of feeling unworthy of the hero's role they have been thrust into.`,
            `Experiencing the pain of feeling responsible for the downfall of a once-prosperous community.`,
            `Suffering from the burden of a debt or obligation to a powerful and dangerous individual.`,
            `Dealing with the pain of being cursed with a prophetic vision of their own demise.`,
            `Enduring the agony of being burdened with a powerful artifact that they can't control.`,
            `Experiencing the pain of feeling alienated and rejected by their own people or culture.`,
            `Suffering from the emotional toll of witnessing the suffering of innocent bystanders caught in the crossfire of their quest.`
        ],
    //sources of wonder
        [
            `Witnessing a breathtaking natural phenomenon, like the Northern Lights or a meteor shower.`,
            `Exploring an ancient and mysterious underground cavern filled with glowing crystals.`,
            `Encountering a wise and enigmatic mentor who possesses extraordinary knowledge.`,
            `Discovering a hidden library with ancient tomes and forgotten knowledge.`,
            `Witnessing a rare celestial event, like a solar eclipse or a comet passing close to the planet.`,
            `Encountering a majestic and mythical creature believed to be extinct.`,
            `Exploring a hidden realm or dimension filled with fantastical landscapes.`,
            `Witnessing the birth of a rare and magical creature or being.`,
            `Encountering a mystical artifact that grants incredible powers.`,
            `Experiencing the beauty of an enchanted garden filled with exotic and otherworldly plants.`,
            `Witnessing a powerful display of elemental magic or a rare magical phenomenon.`,
            `Encountering a long-lost civilization with advanced technology or magical prowess.`,
            `Discovering an ancient prophecy that foretells their destiny and purpose.`,
            `Witnessing a dazzling and elaborate magical performance or show.`,
            `Encountering a group of skilled practitioners of an ancient and mysterious art or tradition.`,
            `Exploring a hidden city suspended in the treetops or built inside a mountain.`,
            `Witnessing the grandeur of a massive and ancient tree that spans across the landscape.`,
            `Encountering a mysterious and ethereal being that communicates through riddles and symbols.`,
            `Discovering a hidden sanctuary where time seems to stand still.`,
            `Witnessing a phenomenon that defies the laws of physics or the known universe.`,
            `Encountering a legendary and elusive creature rumored to possess great wisdom.`,
            `Witnessing a breathtaking sunrise or sunset from a high vantage point.`,
            `Discovering a magical portal that leads to a distant and enchanting world.`,
            `Encountering a group of talented artists or performers showcasing their extraordinary skills.`,
            `Witnessing a mesmerizing dance of lights in the night sky caused by magical beings.`,
            `Discovering a hidden oasis in a barren desert, teeming with life and magical properties.`,
            `Encountering a celestial event that bestows temporary magical abilities upon those who witness it.`,
            `Witnessing a celestial alignment that occurs only once in a lifetime.`,
            `Discovering an ancient and abandoned temple filled with intricate and mysterious artifacts.`,
            `Encountering a legendary figure or hero from ancient myths and legends.`,
            `Witnessing a magical transformation or metamorphosis of a creature or being.`,
            `Discovering a hidden underwater city with advanced technology and mythical inhabitants.`,
            `Encountering a mesmerizing and intricate display of illusions and magical tricks.`,
            `Witnessing a mesmerizing display of bioluminescent creatures illuminating the dark depths of a forest.`,
            `Discovering a hidden realm of dreams and imagination accessible through meditation.`,
            `Encountering a group of ethereal beings with a deep connection to nature and the elements.`,
            `Witnessing the creation of a new celestial body in the night sky.`,
            `Discovering a sentient and talking ancient artifact that imparts ancient knowledge.`,
            `Encountering a captivating and magical performance by a skilled storyteller or bard.`,
            `Witnessing a magical rainstorm that showers the land with healing properties and rejuvenation.`,
            `Discovering a hidden garden filled with rare and wondrous creatures and plants.`,
            `Encountering a legendary and benevolent spirit that grants wishes to those it deems worthy.`,
            `Witnessing a mesmerizing display of elemental spirits dancing in harmony with nature.`,
            `Discovering a hidden library filled with books that reveal the secrets of the universe.`,
            `Encountering a mysterious door that leads to different realms with unique wonders.`,
            `Witnessing a celestial event that bestows temporary magical abilities upon those who witness it.`,
            `Discovering a realm where time flows differently, allowing for glimpses of the past and future.`,
            `Encountering a majestic and ancient dragon that imparts wisdom and guidance.`,
            `Witnessing a breathtaking display of natural phenomena, like a waterfall or bioluminescent sea.`,
            `Discovering a hidden garden filled with enchanted flowers that bloom only once a century.`,
            `Encountering a group of travelers from distant lands, each with unique and fascinating stories.`,
            `Witnessing a rare and magical event that unites people of different cultures and backgrounds.`,
            `Discovering a hidden village protected by ancient guardians and powerful enchantments.`,
            `Encountering a mesmerizing performance by a group of talented aerial artists or acrobats.`,
            `Witnessing a natural occurrence, like a double rainbow or a rare alignment of planets.`,
            `Discovering a hidden cave filled with luminescent crystals that emit a soothing glow.`,
            `Encountering a celestial being that offers guidance and support in times of need.`,
            `Witnessing a breathtaking display of fireflies dancing in sync with a mystical melody.`,
            `Discovering a hidden sanctuary where mythical creatures and humans coexist peacefully.`,
            `Encountering a group of skilled artisans creating intricate and magical crafts.`,
            `Witnessing a mesmerizing display of light and shadow created by powerful illusions.`,
            `Discovering a hidden shrine where people come to make wishes and offer prayers.`,
            `Encountering a legendary and elusive creature that bestows blessings upon those it deems worthy.`,
            `Witnessing a magical procession of mythical beings and creatures celebrating an ancient tradition.`,
            `Discovering a hidden realm accessible only through a magical portal in a secluded forest.`,
            `Encountering a group of wise and mystical sages who possess ancient knowledge and wisdom.`,
            `Witnessing a mesmerizing display of water and light in a hidden underground cave.`,
            `Discovering a hidden waterfall that is said to have healing properties for those who bathe in it.`,
            `Encountering a celestial event that brings together people from all walks of life in celebration.`,
            `Witnessing a magical convergence of elements that creates a breathtaking natural spectacle.`,
            `Discovering a hidden realm of dreams and imagination accessible through meditation.`,
            `Encountering a group of ethereal beings with a deep connection to nature and the elements.`,
            `Witnessing the creation of a new celestial body in the night sky.`,
            `Discovering a sentient and talking ancient artifact that imparts ancient knowledge.`,
    ...
    //sources of hope
        [
            `Finding a long-lost family member or friend who brings hope for the future.`,
            `Discovering a prophecy or ancient text that foretells a positive outcome for their quest.`,
            `Encountering a wise mentor who instills hope and provides guidance.`,
            `Witnessing acts of bravery and selflessness in others, inspiring hope for a better world.`,
            `Receiving a mysterious gift or artifact that holds the promise of great power and hope.`,
            `Forming a strong and supportive bond with a group of like-minded individuals on their journey.`,
            `Overcoming a seemingly insurmountable obstacle, proving that hope can conquer despair.`,
            `Discovering a hidden sanctuary or safe haven where hope is kept alive.`,
            `Witnessing the kindness and compassion of strangers, restoring faith in humanity.`,
            `Receiving messages or signs from a higher power that encourage and uplift their spirits.`,
            `Encountering a legendary figure or hero whose story inspires hope and courage.`,
            `Finding a journal or diary left behind by someone who faced similar challenges and overcame them.`,
            `Witnessing the beauty and wonder of nature, reminding them of the resilience of life.`,
            `Receiving words of encouragement and support from a wise elder or spiritual leader.`,
            `Learning about a mythical artifact or legendary item that is said to bring hope to its possessor.`,
            `Witnessing the power of forgiveness and redemption, providing hope for personal growth.`,
            `Discovering a hidden message or clue that leads them closer to achieving their goal.`,
            `Encountering a mystical creature or guardian that offers hope and protection.`,
            `Forming an unbreakable bond with a loyal companion or animal, bringing hope in companionship.`,
            `Realizing that their actions and choices have the potential to make a positive impact on the world.`,
            `Witnessing acts of bravery and resilience in those who have faced adversity, giving them hope that they can overcome their own challenges.`,
            `Encountering a group of rebels or freedom fighters who inspire hope for a better, more just society.`,
            `Discovering a hidden library or repository of knowledge that holds ancient wisdom and hope for the future.`,
            `Receiving a heartfelt letter or message from someone they care about, providing hope and encouragement.`,
            `Witnessing the power of unity and cooperation among different factions, fostering hope for peace and harmony.`,
            `Encountering a group of survivors who have overcome great hardships, reminding them that hope can thrive even in the darkest of times.`,
            `Finding a piece of art, music, or literature that resonates deeply with them and rekindles hope in their heart.`,
            `Witnessing the beauty and magic of a sunrise or sunset, symbolizing new beginnings and hope for a brighter tomorrow.`,
            `Receiving a vision or dream that fills them with hope and a sense of purpose.`,
            `Encountering a wise hermit or seer who imparts ancient prophecies that instill hope for a destined path.`,
            `Discovering a hidden oasis or healing spring that brings hope for physical or emotional renewal.`,
            `Witnessing acts of altruism and self-sacrifice, restoring hope in the goodness of humanity.`,
            `Receiving unexpected help or support from a stranger, renewing their belief in the interconnectedness of all beings.`,
            `Encountering a benevolent spirit or guardian angel who offers guidance and protection, filling them with hope.`,
            `Discovering a long-forgotten tradition or ritual that promises hope and divine favor.`,
            `Witnessing the growth and renewal of nature after a devastating event, reminding them of the resilience of life.`,
            `Receiving a token of luck or charm from a trusted friend or ally, bringing hope for favorable outcomes.`,
            `Encountering a group of resistance fighters or rebels who are dedicated to bringing hope and justice to the oppressed.`,
            `Discovering a hidden community of kind-hearted and optimistic individuals who embrace hope as their way of life.`,
            `Witnessing the power of compassion and empathy in healing emotional wounds, fostering hope for inner peace.`,
            `Receiving a heartfelt message of hope and encouragement from someone they once helped, reminding them of their impact on others.`,
            `Encountering a legendary figure or hero from their culture whose legacy continues to inspire hope in future generations.`,
            `Discovering a lost relic or artifact that carries the essence of hope from a bygone era.`,
            `Witnessing a stunning display of natural phenomena, such as the Northern Lights, filling them with wonder and hope for the mysteries of the universe.`,
            `Receiving guidance from an ancient prophecy or sacred text that foretells a hopeful future.`,
            `Encountering a group of refugees or survivors who have found strength and resilience in each other, inspiring hope for new beginnings.`,
            `Discovering a hidden sanctuary where people from all walks of life come together in unity and hope.`,
            `Witnessing a miraculous event or phenomenon that defies explanation, filling them with hope in the miraculous possibilities of life.`,
            `Receiving a symbol of hope, such as a special amulet or talisman, from a spiritual leader or guardian figure.`,
            `Encountering a wise elder or mentor who imparts their life wisdom and brings hope for a meaningful journey.`,
            `Witnessing the power of forgiveness and reconciliation, renewing hope for healing and second chances.`,
            `Receiving a message from a loved one who has passed away, bringing hope for the continuity of love and connection beyond death.`,
            `Encountering a group of skilled artisans or craftsmen who create beautiful works of art, inspiring hope in the transformative power of creativity.`,
            `Discovering a hidden garden or sanctuary filled with rare and exotic plants, filling them with hope for the diversity and beauty of the natural world.`,
            `Witnessing the birth of new life, whether it's a baby animal or a blooming flower, symbolizing hope for beginnings and growth.`,
            `Receiving a symbol of hope, such as a phoenix rising from ashes or a rainbow after a storm, reminding them of the power of resilience.`,
            `Encountering a group of scholars or intellectuals who dedicate their lives to seeking knowledge, inspiring hope for progress and understanding.`,
            `Discovering a long-lost family heirloom or artifact, bringing hope for a reconnection with their roots and heritage.`,
            `Witnessing an act of kindness or charity that restores their faith in humanity and ignites hope for a compassionate world.`,
            `Receiving guidance from a wise and ancient spirit or deity, instilling hope in the presence of higher powers.`,
            `Encountering a group of rebels or revolutionaries who fight for a just cause, filling them with hope for a better future.`,
            `Discovering a secret society or organization that works behind the scenes to bring hope and change to the world.`,
            `Witnessing the power of unity and cooperation among different species or races, inspiring hope for harmony and coexistence.`,
            `Receiving a mysterious prophecy or vision that holds the promise of hope and transformation.`,
            `Encountering a group of adventurers or explorers who seek to uncover hidden wonders, inspiring hope for the unknown and undiscovered.`,
            `Discovering a hidden realm or dimension of magic and wonder, filling them with hope for the existence of extraordinary possibilities.`,
            `Witnessing the impact of small acts of kindness and generosity that ripple through a community, bringing hope for collective change.`,
            `Receiving guidance from a wise mentor or teacher who imparts valuable life lessons, instilling hope for personal growth and enlightenment.`,
            `Encountering a group of healers or shamans who possess the ability to bring physical or emotional healing, inspiring hope for restoration.`,
            `Discovering a lost civilization or ancient ruins that hold clues to a forgotten history, sparking hope for unlocking ancient wisdom.`,
            `Witnessing the transformation of someone who has overcome their own flaws and weaknesses, filling them with hope for personal growth.`,
            `Receiving support and encouragement from a community or group that shares their values and beliefs, bringing hope for a sense of belonging.`,
            `Encountering a group of skilled warriors or defenders who protect the innocent, inspiring hope for safety and justice.`,
            `Discovering a hidden portal or gateway to other realms or dimensions, igniting hope for the existence of a vast and interconnected universe.`,
            `Witnessing the power of faith and belief in overcoming challenges and adversity, inspiring hope for the strength of the human spirit.`,
            `Receiving a message or sign from a divine entity or spiritual guide, filling them with hope for divine guidance and protection.`,
            `Encountering a group of nomads or travelers who embrace a life of adventure and exploration, inspiring hope for a life of freedom and discovery.`,
            `Discovering a hidden treasure or artifact that holds great significance or power, sparking hope for fulfilling their destiny.`,
            `Witnessing the beauty and harmony of nature in its purest form, bringing hope for a world of balance and serenity.`,
            `Receiving unexpected help or support from a stranger or unlikely ally, inspiring hope for the interconnectedness of all beings.`,
            `Encountering a group of peaceful protestors or activists who stand up for their beliefs, filling them with hope for positive change through non-violence.`,
            `Discovering a forgotten piece of ancient wisdom or philosophy that holds the key to inner peace and enlightenment, inspiring hope for inner transformation.`,
            `Witnessing the power of love and sacrifice, bringing hope for the capacity of love to overcome even the darkest of times.`,
            `Receiving a vision or dream that reveals a path of hope and purpose for their life's journey.`,
            `Encountering a group of musicians or artists who use their talents to inspire and uplift others, inspiring hope through the power of creativity.`,
            `Discovering a hidden sanctuary or refuge where those in need can find solace and protection, filling them with hope for a safe haven.`,
            `Witnessing acts of courage and bravery in the face of danger, inspiring hope for the strength of the human spirit to overcome fear.`,
            `Receiving a message from a long-lost friend or companion, igniting hope for the possibility of reunion and rekindled bonds.`,
            `Encountering a group of wise elders or sages who share their wisdom and insights, instilling hope for the guidance of experience.`,
            `Discovering a lost piece of their identity or heritage, bringing hope for a deeper understanding of their true self.`,
            `Witnessing the power of forgiveness and redemption, inspiring hope for the possibility of healing past wounds.`,
            `Receiving a token of luck or fortune, filling them with hope for favorable outcomes in their endeavors.`,
            `Encountering a group of dreamers or visionaries who see beyond the mundane, inspiring hope for the realization of bold aspirations.`,
            `Discovering a hidden library or repository of knowledge, sparking hope for the pursuit of truth and understanding.`,
            `Witnessing the beauty of a celestial event, such as a meteor shower or an aurora, bringing hope for the wonder and mystery of the universe.`,
            `Receiving a sign or omen that confirms they are on the right path, instilling hope for a sense of divine guidance.`,
            `Encountering a group of skilled artisans or craftsmen who create works of art that evoke strong emotions, inspiring hope for the power of creativity to evoke change.`,
            `Discovering a hidden power or ability within themselves, filling them with hope for the potential to overcome challenges.`,
            `Witnessing acts of selflessness and altruism, bringing hope for the capacity of humanity to care for one another.`,
            `Receiving a message from a departed loved one, inspiring hope for the continuation of their legacy and love beyond the physical realm.`
        ],
    //sources of interest
        [
            `Unexplored lands and uncharted territories, sparking curiosity and wonder about what lies beyond.`,
            `Ancient ruins and artifacts, igniting a desire to uncover the mysteries of the past.`,
            `Mysterious creatures or mythical beings, captivating their imagination and sense of wonder.`,
            `Enigmatic symbols or cryptic writings, intriguing them with the potential for hidden knowledge.`,
            `Unexplained phenomena or supernatural occurrences, fueling their fascination with the unknown.`,
            `Celestial events like eclipses or comet sightings, inspiring awe and fascination with the cosmos.`,
            `Intricate and elaborate architecture, evoking wonder about the skill and creativity of its builders.`,
            `Unique and exotic cultures, piquing their interest in understanding different ways of life.`,
            `Extraordinary talents or abilities displayed by others, inspiring admiration and fascination.`,
            `Unusual natural landscapes, such as bioluminescent forests or glowing caves, leaving them in awe.`,
            `Legendary tales and epic adventures, captivating their imagination and sense of possibility.`,
            `Advanced technology or futuristic innovations, sparking curiosity about the possibilities of the future.`,
            `Unconventional art forms or avant-garde expressions, intriguing them with new perspectives.`,
            `An enigmatic mentor or guide, leaving them fascinated by their wisdom and mysterious past.`,
            `Unusual weather phenomena, such as auroras or mirages, filling them with fascination and wonder.`,
            `Lost or forgotten languages, stirring a desire to decipher and understand their meaning.`,
            `The beauty and complexity of the natural world, inspiring a deep sense of fascination and respect.`,
            `Extraordinary talents or skills displayed by others, sparking a fascination with mastery and expertise.`,
            `Rare and elusive creatures, captivating their curiosity and desire to learn more about them.`,
            `The intricacies of time and its impact on history, stirring a fascination with the flow of time and its significance.`,
            `A legendary and mythical lost city or civilization, capturing their imagination and fueling their quest to find it.`,
            `Unexplained phenomena in nature, such as magnetic anomalies or gravity-defying landscapes, intriguing their scientific curiosity.`,
            `Ancient prophecies or cryptic visions, driving them to unravel their meanings and potential implications.`,
            `Artifacts with mystical powers or supernatural properties, sparking fascination with their origin and capabilities.`,
            `A secret society or organization with hidden knowledge, drawing them into a web of intrigue and fascination.`,
            `The study of magic or arcane arts, fueling a fascination with the unseen forces that shape the world.`,
            `The mysteries of the human mind and consciousness, inspiring a quest for self-discovery and enlightenment.`,
            `A unique and rare musical instrument or art form, evoking fascination with its beauty and cultural significance.`,
            `The exploration of parallel dimensions or alternate realities, igniting a sense of wonder about the possibilities of existence.`,
            `Legends of ancient heroes and mythical quests, inspiring a desire to follow in their footsteps and achieve greatness.`,
            `The history and traditions of a long-lost civilization, driving them to uncover the truth about their ancestors.`,
            `The study of alchemy or potion-making, captivating their interest in transforming the world around them.`,
            `A mysterious and charismatic figure, captivating their attention and leading them on an unexpected journey.`,
            `The art of storytelling and the power of myths, inspiring a fascination with the impact of narratives on culture and belief.`,
            `The wonders of the deep sea or unexplored underwater worlds, beckoning them to dive into the unknown.`,
            `The intricacies of a complex puzzle or riddle, sparking fascination with the challenge of solving it.`,
            `The pursuit of knowledge and wisdom, driving them to seek out ancient libraries and wise sages.`,
            `The enigmatic behavior of a reclusive and secretive character, leaving them intrigued and drawn to unravel their secrets.`,
            `The allure of the stars and celestial bodies, inspiring them to explore the cosmos and seek answers among the galaxies.`,
            `The exploration of a vast and mysterious forest, enticing them to venture deeper into its heart.`,
            `The study of ancient languages or lost scripts, leading them to decipher cryptic texts and uncover forgotten knowledge.`,
            `The quest for immortality or eternal life, fueling their fascination with the mysteries of mortality and the afterlife.`,
            `The search for rare and magical creatures, inspiring a sense of wonder about the diversity of life in the world.`,
            `The exploration of uncharted territories, driving them to venture into the unknown and chart new territories.`,
            `The art of illusion and sleight of hand, captivating their interest in the secrets of magicians and tricksters.`,
            `The pursuit of justice and truth, motivating them to uncover hidden truths and expose corruption.`,
            `The beauty of celestial events, such as meteor showers or solar eclipses, evoking a sense of awe and wonder.`,
            `The study of ancient astronomy and astrology, fascinating them with the connections between celestial bodies and human destinies.`,
            `The mysteries of time travel and temporal manipulation, sparking a fascination with the possibility of altering history.`,
            `The art of dream interpretation and divination, drawing them into the world of subconscious symbols and prophecies.`,
            `The exploration of hidden and forgotten ruins, fueling their fascination with the relics of lost civilizations.`,
            `The allure of powerful relics or artifacts, driving them to seek out objects with legendary abilities.`,
            `The study of ancient myths and folklore, inspiring a fascination with the stories and beliefs of past cultures.`,
            `The pursuit of spiritual enlightenment or inner peace, leading them on a journey of self-discovery and meditation.`,
            `The wonders of advanced technology or futuristic inventions, captivating their interest in the possibilities of the future.`,
            `The art of diplomacy and negotiation, inspiring them to seek peaceful resolutions to conflicts.`,
            `The mysteries of the natural world, sparking a fascination with the cycles of life and the interconnectedness of all living things.`,
            `The exploration of lost civilizations beneath the sea, igniting a curiosity about submerged wonders.`,
            `The pursuit of fame and recognition, driving them to achieve greatness and leave a lasting legacy.`,
            `The beauty of rare and exotic landscapes, inspiring them to explore the far reaches of the world.`,
            `The art of alchemy and potion-making, sparking their curiosity about the transmutation of materials and magical elixirs.`,
            `The study of ancient prophecies and visions, driving them to seek out the hidden meanings and potential future events.`,
            `The wonders of underwater ecosystems and marine life, captivating their interest in the depths of the ocean.`,
            `The pursuit of artistic expression, inspiring them to create beautiful works of art and share their vision with the world.`,
            `The mysteries of ancient civilizations and lost cities, fueling their desire to uncover forgotten histories and secrets.`,
            `The exploration of hidden passageways and secret tunnels, igniting a fascination with hidden spaces and concealed treasures.`,
            `The allure of forbidden magic or forbidden knowledge, drawing them into the world of taboo and secrecy.`,
            `The wonders of the natural world, inspiring a deep appreciation for the beauty and intricacies of flora and fauna.`,
            `The study of ancient battle tactics and warfare, sparking a fascination with the strategies of legendary warriors.`,
            `The pursuit of freedom and liberation, driving them to fight against oppression and tyranny.`,
            `The mysteries of the human mind and consciousness, captivating their interest in psychology and mental phenomena.`,
            `The art of storytelling and bardic traditions, inspiring them to share tales and songs with others.`,
            `The wonders of the cosmos and space exploration, fueling their curiosity about distant planets and celestial bodies.`,
            `The exploration of hidden magical realms or dimensions, drawing them into a world of parallel realities.`,
            `The pursuit of balance and harmony in nature, driving them to protect and preserve the environment.`,
            `The allure of powerful relics or artifacts, inspiring them to become collectors of ancient treasures.`,
            `The mysteries of enchanted forests and magical glades, sparking a fascination with the hidden enchantments of nature.`,
            `The study of ancient architecture and engineering, captivating their interest in the construction of grand structures.`,
            `The wonders of flight and aerial exploration, igniting a fascination with winged creatures and flying machines.`,
            `The pursuit of knowledge and wisdom, driving them to seek out ancient libraries and wise mentors.`,
            `The study of magical creatures and their unique abilities, igniting a fascination with the diversity of life forms.`,
            `The allure of time travel or temporal anomalies, drawing them into the complexities of temporal mechanics.`,
            `The pursuit of mastering a rare and powerful form of magic, driving them to seek out ancient spellcasters.`,
            `The mysteries of ancient rituals and ceremonies, sparking a fascination with ancient traditions and customs.`,
            `The wonders of advanced technology and inventions, captivating their interest in futuristic advancements.`,
            `The exploration of haunted locations and paranormal phenomena, fueling their curiosity about the supernatural.`,
            `The art of dance and performance, inspiring them to express themselves through movement and expression.`,
            `The allure of distant lands and uncharted territories, drawing them into the thrill of exploration.`,
            `The pursuit of justice and righteousness, driving them to champion the oppressed and downtrodden.`,
            `The mysteries of lost languages and deciphering ancient scripts, sparking a fascination with linguistics.`,
            `The wonders of celestial events like eclipses and meteor showers, captivating their interest in astronomical occurrences.`,
            `The exploration of mystical ley lines and energy currents, fueling their curiosity about the Earth's hidden energies.`,
            `The art of diplomacy and negotiation, inspiring them to find peaceful resolutions to conflicts.`,
            `The allure of the unknown and unexplained, drawing them into the world of unsolved mysteries.`,
            `The pursuit of ancient relics and artifacts for their historical significance, driving them to be an archeological enthusiast.`,
            `The mysteries of dream interpretation and the subconscious mind, sparking a fascination with the realm of dreams.`,
            `The wonders of advanced healing and medical practices, captivating their interest in the medical arts.`,
            `The exploration of ancient ruins and forgotten civilizations, fueling their curiosity about past cultures.`,
            `The art of disguise and espionage, inspiring them to become skilled in the arts of stealth and subterfuge.`,
            `The allure of legendary heroes and mythical figures, drawing them into the world of epic tales and heroism.`
        ],
    //sources of fear
        [
            `The fear of losing loved ones, driving them to protect and shelter those they care about.`,
            `The fear of failure and disappointment, pushing them to strive for success and perfection.`,
            `The fear of the unknown and uncharted territories, making them hesitant to venture into new realms.`,
            `The fear of betrayal and deceit, making them wary of trusting others fully.`,
            `The fear of losing control and being powerless, leading them to seek strength and authority.`,
            `The fear of darkness and the supernatural, causing them to be cautious in eerie situations.`,
            `The fear of heights or falling, making them hesitant to climb high places or venture onto precarious ledges.`,
            `The fear of confined spaces or claustrophobia, causing them discomfort in tight or enclosed areas.`,
            `The fear of fire or burns, making them cautious around open flames and heated objects.`,
            `The fear of water or drowning, leading them to avoid swimming or deep bodies of water.`,
            `The fear of insects or arachnids, causing them to be uneasy in the presence of creepy crawlies.`,
            `The fear of public speaking or stage fright, making them nervous in front of large audiences.`,
            `The fear of being judged or ridiculed, leading them to be self-conscious about their actions and appearance.`,
            `The fear of loss of freedom or confinement, making them resistant to captivity or imprisonment.`,
            `The fear of ghosts or supernatural entities, causing them to be wary of haunted locations.`,
            `The fear of illness or contamination, making them anxious about germs and hygiene.`,
            `The fear of the dark or night, leading them to seek light and company during the nighttime.`,
            `The fear of heights or acrophobia, causing them unease in high places or tall buildings.`,
            `The fear of thunderstorms or astraphobia, making them fearful during storms with thunder and lightning.`,
            `The fear of being alone or isolophobia, leading them to seek companionship and avoid solitude.`,
            `The fear of failure and disappointing others, driving them to be overly cautious and hesitant.`,
            `The fear of heights or vertigo, causing them to experience dizziness and discomfort at high elevations.`,
            `The fear of supernatural curses or hexes, making them superstitious and wary of dark magic.`,
            `The fear of being rejected or abandoned, leading them to be hesitant in forming close relationships.`,
            `The fear of the dark or nyctophobia, causing them to feel anxious and unsafe in the absence of light.`,
            `The fear of losing their identity or memory, making them terrified of amnesia or mind-altering situations.`,
            `The fear of being trapped or confined, leading them to avoid tight spaces or situations of restraint.`,
            `The fear of sharp objects or injury, causing them to be cautious around knives, swords, or other weapons.`,
            `The fear of failure and letting down themselves, making them strive for self-improvement and success.`,
            `The fear of the undead or zombies, causing them to be frightened in graveyards or haunted locations.`,
            `The fear of wild animals or beasts, making them nervous in forests or untamed wilderness.`,
            `The fear of darkness or the absence of light, leading them to seek illumination and avoid dark places.`,
            `The fear of supernatural beings or demons, making them wary of occult practices and rituals.`,
            `The fear of change or new experiences, causing them to be resistant to stepping out of their comfort zone.`,
            `The fear of the unknown or unexplored, making them hesitant to venture into unfamiliar territories.`,
            `The fear of being judged or criticized, leading them to be overly self-conscious and guarded.`,
            `The fear of losing their loved ones, driving them to be overly protective and possessive.`,
            `The fear of heights or flying, making them uncomfortable with aerial transportation.`,
            `The fear of deep water or thalassophobia, causing them anxiety near large bodies of water.`,
            `The fear of supernatural possession or mind control, making them wary of mind-altering substances or spells.`,
            `The fear of fire or pyrophobia, causing them to be cautious around flames and incendiary devices.`,
            `The fear of failure and disappointing their family or mentors, driving them to strive for perfection.`,
            `The fear of being betrayed or deceived, making them wary of trusting others too easily.`,
            `The fear of supernatural curses or hexes, causing them to be apprehensive about occult artifacts.`,
            `The fear of illness or germs, leading them to be overly cautious about cleanliness and hygiene.`,
            `The fear of losing control or going insane, making them struggle with anxiety and self-doubt.`,
            `The fear of supernatural apparitions or ghosts, causing them to be nervous in haunted locations.`,
            `The fear of tight spaces or claustrophobia, making them uncomfortable in confined areas.`,
            `The fear of supernatural forces or gods, leading them to be cautious of divine intervention.`,
            `The fear of betrayal or backstabbing, making them hesitant to form close alliances.`,
            `The fear of being helpless or defenseless, driving them to train and prepare for any danger.`,
            `The fear of natural disasters, causing them to be anxious during storms or earthquakes.`,
            `The fear of failure and being unable to fulfill their destiny, leading them to doubt their abilities.`,
            `The fear of darkness or night terrors, making them dread the onset of nighttime.`,
            `The fear of supernatural curses or hexes, leading them to avoid cursed objects and locations.`,
            `The fear of being abandoned or left alone, causing them to cling to companions.`,
            `The fear of public speaking or stage fright, making them anxious in front of crowds.`,
            `The fear of supernatural beings or monsters, causing them to be fearful of dark creatures.`,
            `The fear of technological advances or sciophobia, making them wary of advanced machinery.`,
            `The fear of being controlled or manipulated, leading them to be cautious of mind-altering substances.`,
            `The fear of heights or acrophobia, making them uneasy when confronted with tall structures or cliffs.`,
            `The fear of water or aquaphobia, causing them to avoid deep bodies of water and swimming.`,
            `The fear of supernatural possessions, making them cautious around cursed or haunted objects.`,
            `The fear of wild animals or bestiophobia, causing them to be wary of encountering dangerous creatures.`,
            `The fear of losing loved ones or thanatophobia, leading them to be overprotective of those close to them.`,
            `The fear of the unknown or xenophobia, making them hesitant to trust strangers or foreign cultures.`,
            `The fear of supernatural rituals or occult practices, causing them to avoid involvement in dark ceremonies.`,
            `The fear of aging or gerascophobia, making them anxious about the passage of time and mortality.`,
            `The fear of confrontation or pugnophobia, causing them to avoid conflict and seek peaceful resolutions.`,
            `The fear of supernatural dimensions or interdimensional travel, making them cautious of portals and gateways.`,
            `The fear of loud noises or phonophobia, causing them to startle easily at sudden sounds.`,
            `The fear of the dark or nyctophobia, making them uncomfortable in poorly lit or dark environments.`,
            `The fear of failure and disappointing themselves, leading them to be self-critical and perfectionistic.`,
            `The fear of supernatural visions or premonitions, causing them to be anxious about the future.`,
            `The fear of being trapped or enclosed spaces, making them avoid small rooms or cramped areas.`,
            `The fear of supernatural curses or hexes, leading them to seek protection from magical threats.`,
            `The fear of being controlled or manipulated, causing them to be cautious of mind-controlling abilities.`,
            `The fear of the undead or necrophobia, making them uneasy around corpses and graveyards.`,
            `The fear of supernatural phenomena or anomalies, causing them to be cautious of strange occurrences.`,
            `The fear of natural disasters or cataclysms, making them anxious about impending doom.`,
            `The fear of being abandoned or forsaken, leading them to have difficulty forming deep connections with others.`,
            `The fear of supernatural curses or hexes, making them constantly worry about being cursed.`,
            `The fear of dark magic or necromancy, causing them to be cautious around practitioners of such arts.`,
            `The fear of supernatural revelations, making them anxious about uncovering hidden truths.`,
            `The fear of losing control or becoming possessed, leading them to avoid risky situations.`,
            `The fear of supernatural artifacts, making them hesitant to use or possess powerful magical objects.`,
            `The fear of supernatural beings in disguise, causing them to be suspicious of everyone they meet.`,
            `The fear of supernatural illnesses or curses, making them overly cautious about their health.`,
            `The fear of supernatural abilities, causing them to feel overwhelmed and vulnerable.`,
            `The fear of supernatural mind manipulation, making them doubt their own thoughts and decisions.`,
            `The fear of supernatural time manipulation, causing them to be anxious about the future and past.`,
            `The fear of supernatural weather phenomena, making them wary of storms and natural disasters.`,
            `The fear of being forgotten or erased from history, leading them to seek recognition and fame.`,
            `The fear of supernatural revenge or retribution, making them feel guilty and anxious about their actions.`,
            `The fear of supernatural teleportation, causing them to be apprehensive about sudden displacements.`,
            `The fear of supernatural curses affecting their loved ones, leading them to isolate themselves.`,
            `The fear of supernatural soul extraction or possession, making them anxious about their essence being taken.`,
            `The fear of supernatural time loops or repeating events, causing them to be cautious about making choices.`,
            `The fear of supernatural body transformations, making them wary of shape-shifting creatures.`,
            `The fear of supernatural memories or visions, causing them to be haunted by past events.`
        ]
]
...
var littleDetails = [
    //likes
    [
        `Collecting small trinkets or souvenirs from each new place they visit.`,
        `Enjoying the simple pleasure of a warm cup of tea or coffee in the morning.`,
        `Finding joy in the sound of rain falling on a rooftop.`,
        `Delighting in the aroma of freshly baked bread or pastries.`,
        `Taking pleasure in reading books or scrolls about history and myths.`,
        `Appreciating the beauty of a starry night sky.`,
        `Relishing the taste of their favorite dessert.`,
        `Finding comfort in spending time with animals, such as pets or friendly creatures they encounter.`,
        `Enjoying the thrill of solving puzzles or riddles.`,
        `Taking pleasure in the feeling of the soft grass under their feet during a walk in nature.`,
        `Finding joy in creating or crafting something with their hands.`,
        `Appreciating the vibrant colors of a beautiful sunset or sunrise.`,
        `Enjoying the taste of exotic and unique cuisines from different cultures.`,
        `Taking pleasure in stargazing and identifying constellations.`,
        `Finding joy in music, whether listening to it or playing an instrument.`,
        `Appreciating the quiet moments of solitude and introspection.`,
        `Taking pleasure in the feeling of cool breeze on a warm day.`,
        `Finding joy in storytelling and sharing tales with others.`,
        `Delighting in exploring old and mysterious places.`,
        `Enjoying the taste of freshly picked fruits and vegetables.`,
        `Taking pleasure in observing the intricate details of artwork and craftsmanship.`,
        `Enjoying the feeling of accomplishment after completing a challenging task.`,
        `Finding joy in learning new languages or dialects.`,
        `Appreciating the peacefulness of meditation or mindfulness practices.`,
        `Taking pleasure in the excitement of a thrilling adventure or daring escapade.`,
        `Enjoying the taste of freshly brewed herbal teas or unique potions.`,
        `Finding joy in helping others and making a positive impact on their lives.`,
        `Relishing the feeling of sand between their toes when walking on a beach.`,
        `Taking pleasure in the tranquility of spending time near a flowing river or serene lake.`,
        `Appreciating the sound of laughter and camaraderie among friends and companions.`,
        `Finding joy in the challenge of honing their skills and improving their abilities.`,
        `Enjoying the taste of exotic fruits or delicacies from faraway lands.`,
        `Taking pleasure in the smell of old books or ancient artifacts.`,
        `Finding joy in celebrating festivals and holidays with the locals in different regions.`,
        `Appreciating the beauty of art and architecture from various cultures.`,
        `Taking pleasure in the feeling of soft grass or sand beneath a blanket during a picnic.`,
        `Enjoying the taste of spicy or savory dishes that awaken their senses.`,
        `Finding joy in learning about the history and traditions of different societies.`,
        `Relishing the sound of a crackling fireplace on a cold evening.`,
        `Taking pleasure in the sight of vibrant and colorful gardens or landscapes.`,
        `Finding pleasure in the challenge of solving puzzles or riddles.`,
        `Enjoying the feeling of freedom and exhilaration while riding a fast mount or vehicle.`,
        `Taking pleasure in the beauty of a starry night sky and celestial phenomena.`,
        `Finding joy in discovering hidden or forgotten places off the beaten path.`,
        `Appreciating the taste of freshly baked bread or pastries from local bakeries.`,
        `Taking pleasure in the thrill of a well-executed prank or playful mischief.`,
        `Finding joy in the soothing sound of rain falling on the roof or leaves.`,
        `Enjoying the feeling of accomplishment when successfully negotiating a tricky deal or agreement.`,
        `Taking pleasure in the challenge of mastering different forms of combat and self-defense.`,
        `Finding joy in the company of animals, forming a deep connection with them.`,
        `Relishing the taste of rare and exquisite wines or spirits.`,
        `Taking pleasure in the excitement of attending grand events and social gatherings.`,
        `Enjoying the feeling of excitement and anticipation before embarking on a new adventure.`,
        `Finding joy in the rhythm and melody of music from diverse cultures and genres.`,
        `Appreciating the taste of diverse cuisines from around the world.`,
        `Taking pleasure in the tranquility of a quiet and isolated forest or wilderness.`,
        `Finding joy in the company of close friends and companions during downtime.`,
        `Enjoying the feeling of mastering a new skill or craft after dedicated practice.`,
        `Taking pleasure in the simple act of stargazing or cloud-watching on a clear day.`,
        `Finding joy in the sense of accomplishment when successfully helping others in need.`,
        `Taking pleasure in the scent of fresh flowers or aromatic herbs.`,
        `Finding joy in the challenge of deciphering ancient scripts or languages.`,
        `Enjoying the feeling of serenity and mindfulness during meditation or reflection.`,
        `Appreciating the taste of exotic fruits or delicacies from distant lands.`,
        `Taking pleasure in the warmth and comfort of a crackling fireplace on a cold day.`,
        `Finding joy in the thrill of exploring ancient ruins and uncovering hidden treasures.`,
        `Enjoying the feeling of accomplishment after successfully completing a difficult quest.`,
        `Taking pleasure in the sound of laughter and cheerful banter among friends.`,
        `Finding joy in the excitement of receiving unexpected gifts or surprises.`,
        `Appreciating the taste of a well-prepared and hearty home-cooked meal.`,
        `Taking pleasure in the sensation of a cool breeze on a hot day.`,
        `Finding joy in the art of storytelling and captivating an audience with tales of adventure.`,
        `Enjoying the feeling of contentment and relaxation while strolling through nature.`,
        `Taking pleasure in the satisfaction of outsmarting opponents in games of strategy.`,
        `Finding joy in the beauty of intricate and well-crafted works of art and craftsmanship.`,
        `Appreciating the taste of a perfectly brewed cup of tea or coffee.`,
        `Taking pleasure in the thrill of a daring escape or evasion from danger.`,
        `Finding joy in the challenge of solving complex mathematical or logical problems.`,
        `Enjoying the feeling of connection and understanding when bonding with new acquaintances.`,
        `Taking pleasure in the sense of achievement after accomplishing a personal goal.`,
        `Finding joy in the soothing melodies of music, whether it be from an instrument or the natural sounds of nature.`,
        `Taking pleasure in the feeling of camaraderie and loyalty among their companions in times of need.`,
        `Enjoying the thrill of riding fast and free on a trusted steed or mount.`,
        `Finding joy in the beauty of a breathtaking sunrise or sunset.`,
        `Taking pleasure in the comfort and companionship of a loyal animal companion or pet.`,
        `Appreciating the taste of a refreshing and cold drink on a hot summer's day.`,
        `Finding joy in the challenge of mastering a new skill or technique.`,
        `Enjoying the feeling of accomplishment when creating something with their own hands.`,
        `Taking pleasure in the excitement of attending a lively and festive celebration or festival.`,
        `Finding joy in the sense of wonder and curiosity when encountering new cultures and traditions.`,
        `Appreciating the taste of a perfectly ripe and juicy fruit.`,
        `Taking pleasure in the thrill of engaging in friendly competitions and games.`,
        `Enjoying the feeling of tranquility and peace in a secluded and serene natural spot.`,
        `Finding joy in the satisfaction of helping others and making a positive impact in their lives.`,
        `Taking pleasure in the rush of adrenaline during thrilling and daring adventures.`,
        `Enjoying the beauty and serenity of gazing at the stars on a clear night.`,
        `Finding joy in the feeling of freedom and independence when exploring the world alone.`,
        `Taking pleasure in the sense of nostalgia and comfort from familiar scents and memories.`,
        `Enjoying the excitement of discovering rare and valuable artifacts or knowledge.`,
        `Finding joy in the simple pleasures of life, like a warm hug, a good book, or a moment of laughter.`
    ],
    //dislikes
    [
        `Disliking the taste or texture of certain foods, like spicy dishes or overly sweet desserts.`,
        `Feeling uncomfortable around large crowds or crowded spaces.`,
        `Disliking the feeling of being rushed or pressured to make quick decisions.`,
        `Having a distaste for loud and sudden noises that startle them easily.`,
        `Feeling annoyed by overly talkative or boastful individuals.`,
        `Disliking being underestimated or not taken seriously by others.`,
        `Feeling uncomfortable in confined or enclosed spaces.`,
        `Having a dislike for arrogant or condescending behavior in others.`,
        `Feeling irritated by being interrupted or talked over during conversations.`,
        `Disliking the feeling of being cold and preferring warm and cozy environments.`,
        `Disliking the feeling of being hot and preferring cooler environments.`,
        `Feeling annoyed by disorganization or chaos in their surroundings.`,
        `Having a distaste for excessive rules and restrictions that limit their freedom.`,
        `Disliking the taste of certain beverages, like bitter coffee or overly sweet drinks.`,
        `Feeling uncomfortable around spiders or other creepy crawlies.`,
        `Having a dislike for excessive attention or being in the spotlight.`,
        `Disliking the feeling of being dirty or sweaty after physical activities.`,
        `Feeling irritated by people who are always late or unreliable.`,
        `Having a distaste for excessive formality or rigid social norms.`,
        `Disliking the feeling of being underestimated or not given credit for their achievements.`,
        `Feeling annoyed by individuals who are constantly complaining or pessimistic.`,
        `Disliking the taste of certain alcoholic beverages or the effects of alcohol.`,
        `Feeling uncomfortable around heights or having a fear of falling.`,
        `Having a distaste for excessive noise or chaotic environments.`,
        `Disliking being asked personal or intrusive questions by strangers.`,
        `Feeling irritated by people who are constantly interrupting or talking over others.`,
        `Having a dislike for long, tedious meetings or events.`,
        `Disliking the feeling of being rushed or pressured to make decisions.`,
        `Feeling uncomfortable with physical contact from unfamiliar individuals.`,
        `Having a distaste for gossip or engaging in idle chatter.`,
        `Disliking the feeling of being trapped or confined in small spaces.`,
        `Feeling annoyed by people who are always seeking attention or validation.`,
        `Having a dislike for excessive displays of wealth or materialism.`,
        `Disliking the taste or smell of certain strong or pungent foods.`,
        `Feeling uncomfortable in unfamiliar or unfamiliar social situations.`,
        `Having a distaste for excessive flattery or insincerity in others.`,
        `Disliking the feeling of being ignored or overlooked by others.`,
        `Feeling irritated by people who are always seeking sympathy or pity.`,
        `Having a dislike for excessive noise or loud music.`,
        `Disliking the feeling of being rushed or hurried in their daily tasks.`,
        `Feeling annoyed by individuals who are overly competitive or boastful about their achievements.`,
        `Disliking the taste of certain fruits, vegetables, or specific foods.`,
        `Feeling uncomfortable in crowded or crowded places.`,
        `Having a distaste for people who are constantly seeking validation on social media.`,
        `Disliking the feeling of being unprepared or caught off guard in a situation.`,
        `Feeling irritated by people who are always talking about themselves and not showing interest in others.`,
        `Having a dislike for excessive use of distractions in social settings.`,
        `Disliking the feeling of being controlled or manipulated by others.`,
        `Feeling annoyed by people who are always late or unreliable.`,
        `Having a distaste for being in the spotlight or receiving public attention.`,
        `Disliking the taste of certain types of coffee or tea.`,
        `Feeling uncomfortable with public speaking or being the center of attention.`,
        `Having a dislike for people who are overly boastful or arrogant.`,
        `Disliking the feeling of being underestimated or undervalued by others.`,
        `Feeling irritated by people who are constantly complaining or being negative.`,
        `Having a distaste for certain types of music or genres.`,
        `Disliking the feeling of being forced to conform to societal norms or expectations.`,
        `Feeling annoyed by people who are always seeking sympathy or pity.`,
        `Having a dislike for excessive clutter or disorganization.`,
        `Disliking the taste or texture of certain types of food.`,
        `Having a distaste for people who are overly competitive and always seeking to win at any cost.`,
        `Disliking the feeling of being rushed or pressured to make quick decisions.`,
        `Feeling irritated by people who constantly interrupt or talk over others.`,
        `Having a dislike for certain types of insects or animals.`,
        `Disliking the taste of certain alcoholic beverages or strong flavors.`,
        `Feeling uncomfortable in large social gatherings or parties.`,
        `Having a distaste for people who are overly clingy or dependent on others.`,
        `Disliking the feeling of being in tight or enclosed spaces.`,
        `Feeling annoyed by people who are always gossiping or spreading rumors.`,
        `Having a dislike for excessive noise or loud environments.`,
        `Disliking the taste of certain types of candy or sweets.`,
        `Feeling uncomfortable with public displays of affection.`,
        `Having a distaste for people who are constantly seeking attention or validation from others.`,
        `Disliking the feeling of being judged or criticized by others.`,
        `Feeling irritated by people who are constantly talking and never listening.`,
        `Having a dislike for certain types of art or artistic styles.`,
        `Disliking the taste of certain types of cuisine or foreign dishes.`,
        `Feeling uncomfortable with heights or being on tall structures.`,
        `Having a distaste for people who are overly pessimistic or negative.`,
        `Disliking the feeling of being in situations with unpredictable outcomes.`,   
        `Feeling annoyed by people who are always late or unreliable.`,
        `Having a distaste for overly spicy or hot foods.`,
        `Disliking the taste of certain types of fruits or vegetables.`,
        `Feeling uncomfortable in crowded or congested areas.`,
        `Having a dislike for people who are constantly seeking sympathy or pity.`,
        `Disliking the feeling of being in situations with strict rules or regulations.`,
        `Feeling irritated by people who are overly competitive and always trying to one-up others.`,
        `Having a distaste for certain types of music or genres.`,
        `Disliking the taste of certain types of coffee or tea.`,
        `Feeling uncomfortable with physical contact from strangers.`,
        `Having a dislike for people who are always seeking approval or validation from others.`,
        `Disliking the feeling of being in situations with large amounts of responsibility.`,
        `Feeling annoyed by people who are always talking about themselves and their achievements.`,
        `Having a distaste for certain types of weather, such as extreme heat or cold.`,
        `Disliking the taste of certain types of alcoholic beverages or mixed drinks.`,
        `Feeling uncomfortable with public speaking or performing in front of others.`,
        `Having a dislike for people who are constantly seeking sympathy or attention.`,
        `Disliking the feeling of being in situations with too much chaos or disorder.`,
        `Feeling irritated by people who are always seeking to be the center of attention.`,
        `Having a distaste for certain types of sports or physical activities.`
    ],
    //favorites options
    [
        `Favorite color(s)`,
        ...
        `Favorite scent or fragrance`,
        `Favorite type of music or genre`,
        `Favorite season`,
        `Favorite holiday or celebration`,
        `Favorite childhood memory`,
        `Favorite piece of clothing or accessory`,
        `Favorite type of art or artistic style`,
        `Favorite fictional character or superhero`,
        `Favorite historical figure or icon`,
        `Favorite type of sport or physical activity`,
        `Favorite type of movie or TV genre`,
        `Favorite type of cuisine or dish from a specific culture`,
        `Favorite quote or saying`,
        `Favorite type of plant or flower`,
        `Favorite type of vehicle or mode of transportation`,
        `Favorite childhood toy or game`,
        `Favorite subject or topic to learn about`,
        `Favorite type of dessert or sweet treat`,
        `Favorite type of drink or beverage`,
        `Favorite type of weather`,
        `Favorite type of landscape or natural setting (e.g., mountains, ocean, forest)`,
        `Favorite type of architecture or building style`,
        `Favorite type of fantasy creature (e.g., dragons, unicorns)`,
        `Favorite type of technology or gadget`,
        `Favorite type of historical era or time period`,
        `Favorite type of outdoor activity (e.g., hiking, camping)`,
        `Favorite type of mythical or legendary story`,
        `Favorite type of comedy or humor style`,
        `Favorite type of social activity or event (e.g., parties, gatherings)`,
        `Favorite type of puzzle or brain teaser`,
        `Favorite type of leisure activity (e.g., reading, painting)`,
        `Favorite type of video game or gaming genre`,
        `Favorite type of fictional world or universe`,
        `Favorite type of transportation for traveling (e.g., train, boat)`,
        `Favorite type of dance or dance style`,
        `Favorite type of art medium (e.g., painting, sculpture)`,
        `Favorite type of clothing fabric or texture`,
        `Favorite type of exercise or fitness routine`,
        `Favorite type of musical instrument`,
        `Favorite type of home decor or interior design style`,
        `Favorite type of character in a story (e.g., hero, villain)`,
        `Favorite type of supernatural or paranormal phenomenon`,
        `Favorite type of magical power or ability`,
        `Favorite type of language or writing system`,
        `Favorite type of historical event or period`,
        `Favorite type of job or career`,
        `Favorite type of technology or gadget`,
        `Favorite type of historical figure or icon`,
        `Favorite type of fictional world or universe`,
        `Favorite type of sport or physical activity`,
        `Favorite type of art or artistic style`,
        `Favorite type of plant or flower`,
        ...
        `Favorite type of historical event or period`,
        `Favorite type of job or career`,
        `Favorite type of music or musical genre`,
        `Favorite type of adventure or quest`,
        `Favorite type of weather condition`,
        `Favorite type of cuisine or cooking style`,
        `Favorite type of social activity or event`,
        `Favorite type of myth or legend`,
        `Favorite type of emotion or feeling`,
        `Favorite type of hidden or unknown knowledge`
    ],
    //what makes them tick
    [
        `Ambition to achieve a specific goal or dream.`,
        `Desire for revenge or justice.`,
        `Need for recognition or validation.`,
        `Fear of failure or rejection.`,
        `Love for a person, place, or cause.`,
        `Loyalty to family or friends.`,
        `Hunger for power or control.`,
        `Search for truth or knowledge.`,
        `Longing for adventure and excitement.`,
        `Commitment to a higher purpose or belief system.`,
        `Yearning for freedom or independence.`,
        `Thirst for exploration and discovery.`,
        `Strive for perfection or excellence.`,
        `Need for approval or acceptance.`,
        `Sense of duty or responsibility.`,
        `Desire for peace and tranquility.`,
        `Hunger for material wealth and possessions.`,
        `Passion for art, creativity, or expression.`,
        `Drive to protect and care for others.`,
        `Curiosity and fascination with the unknown.`,
        `Need for order and structure.`,
        `Hunger for competition and success.`,
        `Passion for helping others or making a difference.`,
        `Longing for a sense of belonging and community.`,
        `Strive for self-improvement and growth.`,
        `Desire for inner peace and enlightenment.`,
        `Thirst for adrenaline and risk-taking.`,
        `Hunger for justice and fairness.`,
        `Passion for exploration and travel.`,
        `Drive to conquer challenges and obstacles.`,
        `Desire for companionship and love.`,
        `Yearning for a sense of purpose and meaning.`,
        `Strive for acceptance and understanding.`,
        `Need for emotional connection and intimacy.`,
        `Passion for a specific hobby or interest.`,
        `Drive to overcome past traumas or hardships.`,
        `Hunger for recognition and fame.`,
        `Desire for control and influence over others.`,
        `Thirst for new experiences and sensations.`,
        `Hunger for revenge or vengeance.`,
        `Drive to protect and defend loved ones.`,
        `Desire for spiritual enlightenment and connection.`,
        `Thirst for knowledge and wisdom.`,
        `Hunger for success and achievements.`,
        `Desire for order and stability.`,
        `Drive to explore and learn about the world.`,
        `Passion for adventure and discovery.`,
        `Yearning for acceptance and belonging.`,
        `Thirst for excitement and thrill-seeking.`,
        `Need for validation and approval from others.`,
        `Passion for fighting for a cause or belief.`,
        `Hunger for recognition and praise.`,
        `Drive to prove oneself and overcome challenges.`,
        `Desire for a sense of purpose and direction.`,
        `Need for companionship and friendship.`,
        `Hunger for revenge and retribution.`,
        `Passion for helping and caring for others.`,
        `Desire for a sense of belonging and community.`,
        `Drive to protect and defend the innocent.`,
        `Need for control and power over others.`,
        `Passion for art and creativity.`,
        `Desire for knowledge and understanding.`,
        `Drive to seek justice and right wrongs.`,
        `Hunger for spiritual fulfillment and enlightenment.`,
        `Passion for adventure and exploration.`,
        `Desire for inner peace and tranquility.`,
        `Drive to achieve greatness and be remembered.`,
        `Need for recognition and validation from authority figures.`,
        `Thirst for revenge and retribution.`,
        `Hunger for power and control over others.`,
        `Desire for acceptance and belonging.`,
        `Drive to protect and defend loved ones.`,
        `Passion for seeking and uncovering hidden truths.`,
        `Desire for material wealth and luxury.`,
        `Hunger for recognition and fame.`,
        `Thirst for adventure and excitement.`,
        `Drive to overcome past traumas and find healing.`,
        `Passion for making a positive impact on the world.`,
        `Desire for freedom and independence.`,
        `Need for approval and admiration from others.`,
        `Hunger for success and achievement.`,
        `Drive to seek out new experiences and challenges.`,
        `Passion for helping and supporting others.`,
        `Desire for a sense of purpose and direction in life.`,
        `Thirst for knowledge and understanding of the world.`,
        `Hunger for acceptance and love from others.`,
        `Drive to protect and defend the weak and vulnerable.`,
        `Passion for creativity and self-expression.`,
        `Desire for inner peace and harmony.`,
        `Need for recognition and praise from peers.`,
        `Hunger for justice and fairness in the world.`,
        `Drive to explore and discover new places.`,
        `Passion for learning and personal growth.`,
        `Desire for emotional connection and intimacy with others.`,
        `Thirst for excitement and adventure.`,
        `Hunger for revenge and retribution against enemies.`,
        `Drive to achieve personal goals and ambitions.`,
        `Passion for making a difference and helping others.`,
        `Desire for a sense of belonging and community.`,
        `Hunger for success and recognition in their chosen field.`,
        `Desire for redemption and atonement for past mistakes.`,
        `Hunger for revenge against a specific individual or group.`,
        `Drive to protect and preserve the environment and nature.`,
        `Passion for exploring the mysteries of the universe and beyond.`,
        `Need for approval and validation from a parental figure.`,
        `Thirst for uncovering family secrets and hidden lineage.`,
        `Hunger for revenge against a corrupt or oppressive system.`,
        `Drive to seek out and protect ancient artifacts or knowledge.`,
        `Desire for fame and recognition as a legendary hero or adventurer.`,
        `Passion for studying and mastering a particular art or craft.`,
        `Need for solitude and the desire to be alone with one's thoughts.`,
        `Thirst for revenge against a former friend or ally who betrayed them.`,
        `Hunger for uncovering the truth behind a long-standing conspiracy.`,
        `Drive to seek justice for a loved one who was wronged or harmed.`,
        `Desire for immortality or eternal life through mystical means.`,
        `Passion for living a life of luxury and indulgence.`,
        `Need for validation and acceptance from a romantic partner.`,
        `Thirst for exploring the depths of the human psyche and emotions.`,
        `Hunger for power and control over a specific region or territory.`,
        `Drive to discover and understand the meaning of life and existence.`,
        `Desire for vengeance against a powerful and oppressive ruler.`,
        `Passion for collecting rare and valuable artifacts or treasures.`,
        `Need for recognition and praise from a mentor or role model.`,
        `Thirst for uncovering the truth behind a family curse or legend.`,
        `Hunger for seeking out and facing their greatest fears.`,
        `Drive to find a cure for a deadly and mysterious illness.`,
        `Desire for revenge against a rival or competitor.`,
        `Passion for uncovering the secrets of an ancient civilization.`,
        `Need for validation and acceptance from a close friend or ally.`,
        `Thirst for exploring the wonders of the natural world.`,
        `Hunger for revenge against a powerful and influential enemy.`,
        `Drive to protect and defend a specific community or group of people.`,
        `Desire for freedom from a life of oppression or servitude.`,
        `Passion for mastering and controlling powerful magical abilities.`,
        `Need for validation and approval from a respected authority figure.`,
        `Thirst for uncovering the truth behind a tragic family history.`,
        `Hunger for revenge against a former love interest or partner.`,
        `Drive to seek out and confront a legendary and elusive creature.`,
        `Desire for recognition and fame as a skilled warrior or fighter.`,
        `Passion for exploring the possibilities of alternate dimensions and realities.`,
        `Need for validation and acceptance from a mentor or elder.`,
        `Thirst for uncovering the secrets of a long-lost civilization.`,
        `Hunger for revenge against a former ally or companion who betrayed them.`,
        `Drive to protect and defend a sacred or magical artifact.`,
        `Desire for revenge against a rival who has consistently bested them.`,
        `Passion for uncovering the mysteries of a powerful ancient prophecy.`,
        `Need for validation and approval from a deity or divine being.`,
        `Thirst for exploring the vastness of outer space and distant planets.`,
        `Hunger for revenge against a powerful and malevolent supernatural entity.`,
        `Drive to seek out and confront the person responsible for a great injustice.`,
        `Desire for knowledge and understanding of the universe's deepest mysteries.`,
        `Passion for protecting and caring for endangered or mythical creatures.`,
        `Need for validation and acceptance from a long-lost family member.`,
        `Thirst for revenge against a rival who stole credit for their achievements.`,
        `Hunger for uncovering the truth about their own forgotten past.`,
        `Drive to protect and defend a sacred, hidden realm from outsiders.`,
        `Desire for redemption and forgiveness for past sins or transgressions.`,
        `Passion for challenging and outsmarting powerful adversaries.`,
        `Need for recognition and respect from a legendary hero or mentor.`,
        `Thirst for uncovering the origin and purpose of a powerful artifact.`,
        `Hunger for revenge against a secret society that wronged them.`,
        `Drive to protect and preserve ancient cultural traditions and knowledge.`,
        `Desire for freedom from a life of servitude or captivity.`,
        `Passion for creating and inventing revolutionary technologies or magic.`,
        `Need for validation and acceptance from a wise and ancient sage.`,
        `Thirst for uncovering the hidden history of a lost civilization.`,
        `Hunger for revenge against a corrupt and oppressive government.`,
        `Drive to protect and defend innocent and vulnerable beings.`,
        `Desire for recognition and fame as a legendary explorer or adventurer.`,
        `Passion for mastering and controlling the elemental forces of nature.`,
        `Need for validation and approval from a renowned warrior or knight.`,
        `Thirst for uncovering the truth behind a legendary prophecy.`,
        `Hunger for revenge against a deceptive and manipulative foe.`,
        `Drive to protect and preserve a sacred natural landmark or resource.`,
        `Desire for redemption and atonement for causing harm to others.`,
        `Passion for uncovering the lost teachings of a forgotten mystical order.`,
        `Need for validation and acceptance from a beloved and deceased family member.`,
        `Thirst for uncovering the truth about a long-standing family feud.`,
        `Hunger for revenge against a powerful sorcerer or dark magician.`,
        `Drive to protect and defend a realm or world from imminent destruction.`,
        `Desire for recognition and praise as a skilled strategist and tactician.`,
        `Passion for uncovering the hidden secrets of a long-abandoned castle.`,
        `Need for validation and approval from a wise and venerable elder.`,
        `Thirst for uncovering the truth about a vanished ancient civilization.`,
        `Hunger for revenge against an organization that caused personal tragedy.`,
        `Drive to protect and preserve ancient prophecies from falling into the wrong hands.`,
        `Desire for redemption and forgiveness from those they once betrayed.`,
        `Passion for mastering and controlling dark and forbidden magic.`,
        `Need for validation and acceptance from a reclusive and wise hermit.`,
        `Thirst for uncovering the truth about a legendary, lost treasure.`,
        `Hunger for revenge against a powerful and enigmatic immortal.`,
        `Drive to protect and defend a utopian society from external threats.`,
        `Desire for recognition and fame as a master of disguise and espionage.`,
        `Passion for uncovering the hidden meaning behind ancient symbols and writings.`,
        `Need for validation and approval from a legendary and mythical creature.`,
        `Thirst for uncovering the truth about a long-lost sibling or twin.`,
        `Hunger for revenge against a supernatural entity that cursed them.`,
        `Drive to protect and preserve ancient magical rituals and traditions.`,
        `Desire for redemption and atonement for past failures and mistakes.`,
        `Passion for uncovering the lost arts of a nearly extinct civilization.`
    ]
]
...
let subjectiveStuggles = [
    `Battling with self-doubt and feeling like an imposter in their achievements.`,
    `Dealing with intense anxiety and constant worry, making it hard to focus on tasks.`,
    `Struggling with perfectionism and feeling like nothing is ever good enough.`,
    `Wrestling with unresolved guilt or regret from past actions or decisions.`,
    `Facing inner conflict between duty and personal desires, torn between two paths.`,
    `Overcoming a deep-seated fear or phobia that limits their actions and choices.`,
    `Trying to control their anger and impulsivity, fearing they might hurt others.`,
    `Dealing with feelings of inadequacy and comparing themselves to others.`,
    `Coping with the loss of hope and struggling to find meaning in life.`,
    `Struggling with body image issues and low self-esteem.`,
    `Battling with addiction and the constant urge to give in to destructive habits.`,
    `Dealing with unresolved trauma from their past, causing emotional distress.`,
    `Wrestling with feelings of jealousy and insecurity in their relationships.`,
    `Trying to break free from a toxic relationship, even though they still love the person.`,
    `Overcoming a negative mindset and pessimism, trying to see the positive side of things.`,
    `Facing a crisis of faith and questioning their beliefs or spirituality.`,
    `Dealing with feelings of betrayal and the difficulty of trusting others again.`,
    `Struggling with social anxiety and the fear of judgment from others.`,
    `Wrestling with a sense of loneliness and feeling disconnected from others.`,
    `Trying to forgive themselves for past mistakes and move forward.`,
    `Overcoming a deep-seated sense of unworthiness and feeling unlovable.`,
    `Dealing with a sense of emptiness and lack of purpose in life.`,
    `Struggling with obsessive thoughts and compulsive behaviors.`,
    `Wrestling with feelings of resentment and bitterness towards others.`,
    `Trying to let go of a grudge and find forgiveness in their heart.`,
    `Dealing with unresolved grief and difficulty accepting the loss of a loved one.`,
    `Struggling with feelings of hopelessness and questioning their own worth.`,
    `Battling with self-sabotaging behaviors that hinder their progress.`,
    `Wrestling with the fear of abandonment and being left alone.`,
    `Trying to find their identity and establish a sense of self.`,
    `Dealing with unresolved childhood trauma and its impact on their adulthood.`,
    `Struggling with decision-making and fearing they'll make the wrong choices.`,
    `Wrestling with feelings of inadequacy and constantly seeking validation from others.`,
    `Trying to overcome a victim mentality and take control of their life.`,
    `Dealing with a sense of powerlessness and feeling trapped in their circumstances.`,
    `Struggling with codependency and relying too heavily on others for validation.`,
    `Wrestling with feelings of worthlessness and believing they don't deserve happiness.`,
    `Trying to overcome a fear of intimacy and letting others get close to them.`,
    `Dealing with recurring nightmares and the fear of sleep.`,
    `Struggling with a sense of disconnection from reality and questioning their sanity.`,
    `Wrestling with feelings of envy and resentment towards those who seem to have it all.`,
    `Trying to break free from a toxic cycle of self-destructive behaviors and relationships.`,
    `Dealing with the fear of failure and the pressure to live up to others' expectations.`,
    `Struggling with a sense of identity crisis and not knowing who they truly are.`,
    `Wrestling with feelings of unworthiness and feeling like they don't deserve happiness.`,
    `Trying to find their voice and speak up for themselves, despite fear of rejection.`,
    `Dealing with a deep sense of loneliness and isolation, even in a crowd.`,
    `Struggling with the weight of responsibility and feeling overwhelmed by it all.`,
    `Wrestling with feelings of resentment towards authority figures or parents.`,
    `Trying to overcome a negative self-image and cultivate self-compassion.`,
    `Dealing with unresolved trauma from a toxic past relationship.`,
    `Struggling with feelings of inferiority and constantly comparing themselves to others.`,
    `Wrestling with a fear of intimacy and avoiding vulnerability in relationships.`,
    `Trying to break free from the constraints of societal norms and expectations.`,
    `Dealing with internalized shame and feelings of being "not good enough."`,
    `Struggling with a lack of direction and feeling lost in life.`,
    `Wrestling with the fear of rejection and avoiding social interactions.`,
    `Trying to overcome a tendency to sabotage their own success due to fear of change.`,
    `Dealing with unresolved conflicts from their past that continue to haunt them.`,
    `Struggling with a fear of commitment and avoiding long-term relationships.`,
    `Wrestling with feelings of resentment towards a friend or loved one's success.`,
    `Trying to break free from the clutches of a controlling or abusive relationship.`,
    `Dealing with the fear of vulnerability and keeping others at arm's length.`,
    `Struggling with a deep-seated need for validation and seeking approval from others.`,
    `Wrestling with feelings of jealousy and insecurity in their romantic relationship.`,
    `Trying to overcome a fear of public speaking and expressing themselves openly.`,
    `Dealing with unresolved issues with their parents or family members.`,
    `Struggling with the fear of abandonment and clinging to toxic relationships.`,
    `Wrestling with feelings of guilt and regret over past mistakes.`,
    `Trying to break free from a cycle of self-destructive habits and behaviors.`,
    `Dealing with unresolved feelings for someone from their past.`,
    `Struggling with a fear of confrontation and avoiding difficult conversations.`,
    `Wrestling with feelings of inadequacy in their professional life.`,
    `Trying to overcome a fear of intimacy and emotional connection with others.`,
    `Dealing with unresolved grief and finding closure after a significant loss.`,
    `Struggling with feelings of powerlessness in the face of adversity.`,
    `Wrestling with a fear of change and holding onto the familiar, even if harmful.`,
    `Trying to break free from the grip of an addiction that controls their life.`,
    `Dealing with the fear of rejection and avoiding new friendships or relationships.`,
    `Struggling with feelings of self-hatred and shame over past actions.`,
    `Wrestling with the fear of commitment and avoiding long-term plans.`,
    `Trying to overcome a tendency to self-sacrifice and neglect their own needs.`,
    `Dealing with unresolved issues with a former friend or betrayed trust.`,
    `Struggling with feelings of inadequacy and never feeling "good enough."`,
    `Wrestling with a fear of failure and holding back from taking risks.`,
    `Trying to break free from a harmful pattern of self-isolation and loneliness.`,
    `Dealing with the fear of vulnerability and avoiding emotional intimacy.`,
    `Struggling with feelings of resentment towards a family member or authority figure.`,
    `Wrestling with the fear of being judged or ridiculed by others.`,
    `Trying to overcome a fear of change and embracing new opportunities.`,
    `Dealing with unresolved feelings of guilt or regret from a past relationship.`,
    `Struggling with feelings of envy and jealousy towards others' success.`,
    `Wrestling with the fear of abandonment and avoiding close relationships.`,
    `Trying to break free from a cycle of negative self-talk and self-doubt.`,
    `Dealing with the fear of confronting their own mortality and existential questions.`,
    `Struggling with feelings of loneliness and a lack of meaningful connections.`,
    `Wrestling with the fear of disappointing others and seeking constant approval.`,
    `Trying to overcome a fear of confrontation and assert their boundaries.`,
    `Dealing with unresolved feelings towards a former friend or loved one.`,
    `Struggling with a fear of the unknown and uncertainty about the future.`,
    `Wrestling with imposter syndrome and feeling like they don't belong or deserve their success.`,
    `Trying to break free from the hold of perfectionism and the fear of making mistakes.`,
    `Dealing with the fear of rejection and being hesitant to open up to new friendships.`,
    `Struggling with feelings of unworthiness and not feeling deserving of love or happiness.`,
    `Wrestling with the fear of abandonment and avoiding close relationships to protect themselves.`,
    `Trying to overcome a fear of authority and standing up for themselves in challenging situations.`,
    `Dealing with unresolved anger and finding healthy ways to express and manage it.`,
    `Struggling with the fear of being vulnerable and trusting others with their emotions.`,
    `Wrestling with feelings of guilt and responsibility for a past failure or tragedy.`,
    `Trying to break free from a toxic friendship or relationship that drains their energy.`,
    `Dealing with the fear of failure and holding back from pursuing their dreams.`,
    `Struggling with feelings of inadequacy and comparing themselves to others.`,
    `Wrestling with the fear of intimacy and avoiding emotional closeness in relationships.`,
    `Trying to overcome a fear of commitment and making long-term plans for the future.`,
    `Dealing with unresolved trauma and finding healing and closure from past events.`,
    `Struggling with feelings of shame and self-blame for past mistakes.`,
    `Wrestling with the fear of confrontation and avoiding difficult conversations.`,
    `Trying to break free from a pattern of self-sabotage and negative self-talk.`,
    `Dealing with the fear of being vulnerable and showing their true emotions to others.`,
    `Struggling with feelings of loneliness and the need for external validation.`,
    `Wrestling with the fear of abandonment and being overly clingy in relationships.`,
    `Trying to overcome a fear of change and stepping out of their comfort zone.`,
    `Dealing with unresolved issues with a family member and the need for forgiveness.`,
    `Struggling with feelings of jealousy and insecurity in their personal relationships.`,
    `Wrestling with the fear of rejection and hesitating to pursue new opportunities.`,
    `Trying to break free from a toxic work environment that negatively impacts their well-being.`,
    `Dealing with the fear of being judged by others and seeking validation from external sources.`,
    `Struggling with feelings of hopelessness and a lack of direction in life.`,
    `Wrestling with the fear of intimacy and avoiding emotional connections with others.`,
    `Trying to overcome a fear of failure and taking risks to achieve their goals.`,
    `Dealing with unresolved grief and finding closure after a significant loss.`,
    `Struggling with feelings of powerlessness and a lack of control over their life.`,
    `Wrestling with the fear of commitment and avoiding serious relationships.`,
    `Trying to break free from a harmful addiction that is taking a toll on their health and well-being.`,
    `Dealing with the fear of rejection and avoiding social situations as a result.`,
    `Struggling with feelings of self-doubt and a lack of confidence in their abilities.`,
    `Wrestling with the fear of abandonment and being overly dependent on others for validation.`,
    `Trying to overcome a fear of change and embracing new opportunities for growth.`,
    `Dealing with unresolved feelings of guilt and regret from a past mistake.`,
    `Struggling with feelings of envy and jealousy towards others' achievements.`,
    `Wrestling with the fear of confrontation and avoiding difficult conversations with loved ones.`,
    `Trying to break free from a negative mindset and cultivate a more positive outlook on life.`,
    `Dealing with the fear of vulnerability and not allowing others to see their true emotions.`,
    `Struggling with feelings of resentment towards someone who has wronged them in the past.`,
    `Wrestling with the fear of being judged or ridiculed by others for their choices.`,
    `Trying to overcome a fear of failure and taking the first steps towards their dreams.`,
    `Dealing with unresolved conflicts and strained relationships with family members.`,
    `Struggling with feelings of inadequacy and a constant need to prove themselves.`,
    `Wrestling with the fear of commitment and avoiding long-term commitments.`,
    `Trying to break free from a toxic friendship that is emotionally draining and one-sided.`,
    `Dealing with the fear of abandonment and feeling anxious about being left alone.`,
    `Struggling with feelings of worthlessness and questioning their value in the world.`,
    `Wrestling with the fear of betrayal and being hesitant to trust others fully.`,
    `Trying to break free from a cycle of self-sacrifice and putting others' needs before their own.`,
    `Dealing with the fear of change and clinging to the familiar even when it's detrimental.`,
    `Struggling with feelings of inadequacy in their career and feeling like an imposter at work.`,
    `Wrestling with the fear of rejection and avoiding romantic relationships altogether.`,
    `Trying to overcome a fear of intimacy and letting someone get close to their heart.`,
    `Dealing with unresolved anger towards a loved one and struggling to forgive.`,
    `Struggling with feelings of being misunderstood and isolated from others.`,
    `Wrestling with the fear of loss and becoming overly attached to people or possessions.`,
    `Trying to break free from a past betrayal that has left them emotionally scarred.`,
    `Dealing with the fear of the unknown and being hesitant to take risks.`,
    `Struggling with feelings of insecurity about their appearance or physical abilities.`,
    `Wrestling with the fear of failure and feeling paralyzed by the possibility of making mistakes.`,
    `Trying to overcome a fear of authority and standing up for their beliefs.`,
    `Dealing with unresolved guilt and regret over a decision that had negative consequences.`,
    `Struggling with feelings of jealousy and comparing themselves to others incessantly.`,
    `Wrestling with the fear of abandonment and becoming overly clingy in relationships.`,
    `Trying to break free from a pattern of self-doubt and negative self-talk.`,
    `Dealing with the fear of confrontation and avoiding conflicts at all costs.`,
    `Struggling with feelings of unworthiness and feeling undeserving of love and happiness.`,
    `Wrestling with the fear of judgment from others and being overly self-conscious.`,
    `Trying to overcome a fear of commitment and being hesitant to make long-term plans.`,
    `Dealing with unresolved trauma and emotional wounds from their past.`,
    `Struggling with feelings of shame and guilt about something they did long ago.`,
    `Wrestling with the fear of vulnerability and not wanting to appear weak in front of others.`,
    `Trying to break free from a toxic relationship that drains their emotional energy.`,
    `Dealing with the fear of rejection and being hesitant to express their true feelings.`,
    `Struggling with feelings of isolation and loneliness, even in a crowd of people.`,
    `Wrestling with the fear of failure and avoiding new challenges as a result.`,
    `Trying to overcome a fear of change and the uncertainty that comes with it.`,
    `Dealing with unresolved issues with a friend and trying to mend the broken bond.`,
    `Struggling with feelings of envy and resentment towards someone close to them.`,
    `Wrestling with the fear of commitment and avoiding getting too close to others.`,
    `Trying to break free from a negative self-image and embracing self-acceptance.`,
    `Dealing with the fear of rejection and being hesitant to ask for help or support.`,
    `Struggling with feelings of guilt and responsibility for something that wasn't their fault.`,
    `Wrestling with the fear of the future and feeling anxious about what lies ahead.`,
    `Trying to overcome a fear of confrontation and learning to assert themselves confidently.`,
    `Dealing with unresolved grief and finding closure after a significant loss.`,
    `Struggling with feelings of powerlessness and the need to regain control over their life.`,
    `Wrestling with the fear of intimacy and avoiding emotional connections with others.`,
    `Trying to break free from a harmful addiction that has taken a toll on their well-being.`,
    `Dealing with the fear of rejection and not feeling good enough for others.`,
    `Struggling with feelings of self-doubt and constantly seeking validation from others.`,
    `Wrestling with the fear of abandonment and being overly cautious in forming attachments.`,
    `Trying to overcome a fear of change and embracing new opportunities for growth.`,
    `Dealing with unresolved feelings of guilt and regret from past mistakes.`,
    `Struggling with feelings of bitterness and resentment towards someone who hurt them.`,
    `Dealing with a sense of unfulfillment and the constant need to seek meaning in their life.`,
    `Struggling with feelings of insecurity about their talents and doubting their abilities.`,
    `Wrestling with the fear of success and the pressure that comes with achieving their goals.`,
    `Trying to break free from a negative mindset and cultivating a more positive outlook on life.`,
    `Dealing with the fear of vulnerability and the reluctance to open up emotionally to others.`,
    `Struggling with feelings of inadequacy in their relationships and feeling undeserving of love.`,
    `Wrestling with the fear of being judged for their past mistakes and feeling ashamed of their history.`,
    `Trying to overcome a fear of authority and standing up for what they believe is right.`,
    `Dealing with unresolved trauma from their childhood and its impact on their current relationships.`,
    `Struggling with feelings of unworthiness and the belief that they don't deserve happiness.`,
    `Wrestling with the fear of being alone and seeking validation from others to feel valued.`,
    `Trying to break free from a toxic friendship that drains their energy and self-esteem.`,
    `Dealing with the fear of rejection and not allowing themselves to be vulnerable in love.`,
    `Struggling with feelings of jealousy and comparing themselves to others in various aspects of life.`,
    `Wrestling with the fear of failure and the pressure to live up to others' expectations.`,
    `Trying to overcome a fear of change and embracing new experiences outside their comfort zone.`,
    `Dealing with unresolved guilt over a decision that caused harm to someone else.`,
    `Struggling with feelings of resentment towards a family member for past grievances.`,
    `Wrestling with the fear of abandonment and being overly dependent on others for emotional support.`,
    `Trying to break free from a pattern of self-sabotage and self-destructive behavior.`,
    `Dealing with the fear of rejection and the reluctance to express their true feelings to a friend.`,
    `Struggling with feelings of isolation and alienation from those around them.`,
    `Wrestling with the fear of commitment and avoiding long-term relationships.`,
    `Trying to overcome a fear of intimacy and learning to trust others with their emotions.`,
    `Dealing with unresolved regrets and the longing to make amends with someone from their past.`,
    `Struggling with feelings of envy and comparing their achievements to others.`,
    `Wrestling with the fear of judgment from others and being overly self-critical.`,
    `Trying to break free from a manipulative relationship that has undermined their self-worth.`,
    `Dealing with the fear of rejection and hesitating to share their creative work with others.`,
    `Struggling with feelings of loneliness and seeking a sense of belonging in their life.`,
    `Wrestling with the fear of inadequacy and constantly feeling like they fall short.`,
    `Trying to overcome a fear of public speaking and finding their voice in front of others.`,
    `Dealing with unresolved issues with a mentor or role model and seeking closure.`,
    `Struggling with feelings of guilt over past mistakes and the desire to make things right.`,
    `Wrestling with the fear of vulnerability and keeping their emotions guarded from others.`,
    `Trying to break free from a negative body image and learning to love themselves as they are.`,
    `Dealing with the fear of rejection and hesitating to share their creative work with others.`,
    `Struggling with feelings of insecurity in their abilities and doubting their potential for success.`,
    `Wrestling with the fear of failure and the pressure to live up to others' expectations.`,
    `Trying to overcome a fear of confrontation and learning to assert themselves confidently.`
]

let personalExperiences = [
    //frustration
    [
        `Struggling to achieve a long-held dream or goal despite facing numerous setbacks and obstacles.`,
        `Dealing with the frustration of being misunderstood or not being able to effectively communicate their thoughts and feelings.`,
        `Experiencing the annoyance of constantly being underestimated or overlooked by others.`,
        `Coping with the frustration of feeling stuck in a repetitive or monotonous routine with little opportunity for change.`,
        `Dealing with the exasperation of being held back or limited by their own self-doubt or fear of failure.`,
        `Experiencing the irritation of having their ideas or opinions dismissed or ignored by those in positions of power.`,
        `Coping with the frustration of being in a toxic or unhealthy relationship that they feel unable to escape from.`,
        `Dealing with the annoyance of constantly facing criticism or judgment from others.`,
        `Experiencing the frustration of feeling unappreciated or undervalued for their efforts and contributions.`,
        `Coping with the irritation of being in a situation where they have little control over their own destiny or fate.`,
        `Dealing with the frustration of repeatedly making the same mistakes or falling into old patterns of behavior.`,
        `Experiencing the annoyance of feeling trapped or confined by societal norms and expectations.`,
        `Coping with the frustration of not being able to help or save someone they deeply care about.`,
        `Dealing with the exasperation of being forced to work with someone they strongly dislike or have conflicts with.`,
        `Experiencing the irritation of being underestimated or belittled because of their age, gender, or background.`,
        `Coping with the frustration of feeling like they don't belong or fit in with their peers or community.`,
        `Dealing with the annoyance of having their plans or goals derailed by unforeseen circumstances or external forces.`,
        `Experiencing the frustration of feeling like they are constantly putting others' needs before their own.`,
        `Coping with the irritation of being unable to confront or stand up to someone who has wronged them.`,
        `Dealing with the exasperation of feeling like they are running out of time to achieve their dreams or ambitions.`,
        `Experiencing the frustration of facing a moral dilemma where there is no clear right or wrong choice.`,
        `Dealing with the annoyance of being constantly misunderstood or misinterpreted by others.`,
        `Coping with the frustration of trying to break free from a toxic relationship or friendship.`,
        `Experiencing the exasperation of facing repeated setbacks or failures in their pursuits.`,
        `Dealing with the irritation of having their privacy invaded or personal boundaries crossed.`,
        `Coping with the frustration of being held back by their own self-doubt and lack of confidence.`,
        `Experiencing the annoyance of feeling overwhelmed by responsibilities and expectations placed upon them.`,
        `Dealing with the frustration of feeling stuck in a monotonous routine or unfulfilling job.`,
        `Coping with the exasperation of dealing with bureaucracy or red tape that hinders their progress.`,
        `Experiencing the irritation of being judged or criticized for their choices and actions by others.`,
        `Dealing with the frustration of having unrequited feelings for someone they care deeply about.`,
        `Experiencing the annoyance of constantly comparing themselves to others and feeling inadequate.`,
        `Coping with the frustration of being trapped in a cycle of bad habits or self-destructive behavior.`,
        `Dealing with the irritation of facing constant criticism or disapproval from a parent or authority figure.`,
        `Experiencing the exasperation of trying to communicate with someone who refuses to listen or understand.`,
        `Coping with the frustration of feeling trapped in a stagnant or unfulfilling relationship.`,
        `Dealing with the annoyance of being underestimated or not taken seriously by others.`,
        `Experiencing the frustration of feeling powerless in the face of injustice or inequality.`,
        `Coping with the exasperation of dealing with a chronic illness or physical limitation.`,
        `Dealing with the irritation of constantly facing microaggressions or subtle forms of discrimination.`,
        `Experiencing the frustration of being misunderstood or misjudged by others, leading to a sense of isolation.`,
        `Dealing with the annoyance of facing setbacks or obstacles in their personal or professional goals.`,
        `Coping with the frustration of being stuck in a routine or mundane life, longing for something more exciting or fulfilling.`,
        `Experiencing the exasperation of dealing with a toxic or manipulative person in their life.`,
        `Dealing with the irritation of feeling like they are constantly being taken advantage of or taken for granted.`,
        `Coping with the frustration of feeling unappreciated or undervalued for their efforts and contributions.`,
        `Experiencing the annoyance of having their boundaries violated or not being able to assert themselves effectively.`,
        `Dealing with the frustration of feeling like they are constantly running out of time or struggling to meet expectations.`,
        `Coping with the exasperation of being torn between conflicting responsibilities or obligations.`,
        `Experiencing the irritation of feeling envious or resentful of others' successes or happiness.`,
        `Dealing with the frustration of feeling like they are constantly compared to others, leading to self-doubt and insecurity.`,
        `Experiencing the irritation of facing prejudice or discrimination based on their identity or background.`,
        `Coping with the frustration of trying to please everyone and feeling overwhelmed by the pressure to be perfect.`,
        `Dealing with the annoyance of experiencing a creative or emotional block, hindering their ability to express themselves.`,
        `Experiencing the exasperation of being stuck in a difficult or unhealthy relationship, unsure of how to break free.`,
        `Coping with the frustration of feeling stuck in the past and unable to move forward from a painful event or trauma.`,
        `Dealing with the irritation of being in a dead-end job or career, yearning for more fulfillment and purpose.`,
        `Experiencing the frustration of trying to change a negative behavior or habit but facing setbacks along the way.`,
        `Coping with the annoyance of feeling invisible or overlooked by others, longing to be seen and heard.`,
        `Dealing with the exasperation of struggling with a chronic illness or physical limitation, impacting their daily life.`,
        `Dealing with the frustration of facing constant setbacks and failures in their pursuit of a lifelong dream or goal.`,
        `Experiencing the annoyance of feeling misunderstood or misjudged by others, leading to a sense of isolation.`,
        `Coping with the frustration of feeling trapped in a toxic or dysfunctional family dynamic, yearning for a sense of belonging.`,
        `Dealing with the exasperation of being in a never-ending cycle of procrastination, hindering their personal growth.`,
        `Experiencing the irritation of having their boundaries constantly crossed by others, leading to a loss of trust.`,
        `Coping with the frustration of feeling disconnected from their cultural or ancestral roots, seeking a sense of identity.`,
        `Dealing with the annoyance of constantly comparing themselves to others on social media, leading to feelings of inadequacy.`,
        `Experiencing the exasperation of being in a job that goes against their values, causing a moral dilemma.`,
        `Coping with the frustration of feeling overwhelmed by their responsibilities, leading to burnout and fatigue.`,
        `Dealing with the irritation of being in a long-distance relationship, struggling with the challenges of distance and longing.`
    ],
    //fury
    [
        `Experiencing fury when witnessing injustice or cruelty towards the innocent, igniting a deep desire for justice and retribution.`,
        `Feeling furious after being betrayed by someone they trusted wholeheartedly, struggling to rebuild broken trust.`,
        `Dealing with uncontrollable fury when facing constant criticism or ridicule, fueling a burning determination to prove others wrong.`,
        `Experiencing a furious outburst when confronted with a painful past memory, struggling to come to terms with past trauma.`,
        `Feeling furious when their principles and beliefs are challenged or mocked, sparking a fierce defense of their values.`,
        `Dealing with a seething fury when facing repeated failures or setbacks, leading to a relentless pursuit of success.`,
        `Experiencing overwhelming fury when someone they love is harmed or threatened, triggering a protective instinct.`,
        `Feeling furious after witnessing a close friend being treated unfairly, prompting them to stand up for their friend's rights.`,
        `Dealing with intense fury when facing discrimination or prejudice, propelling them to advocate for equality and inclusivity.`,
        `Experiencing furious resentment towards a rival or enemy, leading to a heated and bitter rivalry.`,
        `Feeling furious when encountering a situation that goes against their sense of fairness and justice, causing them to speak out against the wrongdoings.`,
        `Experiencing a fiery rage when witnessing acts of cruelty towards animals, motivating them to become advocates for animal rights.`,
        `Dealing with intense fury when facing incompetence or dishonesty in positions of authority, leading them to challenge the system.`,
        `Feeling furious when their ideas or contributions are dismissed or stolen by others, driving them to prove their worth and uniqueness.`,
        `Experiencing a blazing fury when dealing with manipulative or deceitful individuals, prompting them to expose the truth.`,
        `Feeling furious when confronted with their own weaknesses or failures, inspiring them to embark on a journey of self-improvement.`,
        `Dealing with a seething anger when they witness the destruction of natural environments, fueling their passion for environmental conservation.`,
        `Experiencing intense fury when their loved ones are harmed or threatened, resulting in a protective and fiercely loyal nature.`,
        `Feeling furious when they witness oppression or exploitation, becoming champions for the oppressed and marginalized.`,
        `Dealing with a burning rage when facing systemic issues and corruption, leading them to become agents of change and reform.`,
        `Experiencing a furious outburst when their boundaries are crossed or disrespected, asserting themselves with forceful determination.`,
        `Feeling furious when they encounter individuals who exploit others for personal gain, driving them to expose and confront the perpetrators.`,
        `Dealing with a fiery anger when they witness injustice towards a group they deeply identify with, fueling their advocacy for equality.`,
        `Experiencing overwhelming fury when faced with betrayal from someone they considered a close friend, challenging their ability to trust.`,
        `Feeling furious when they witness cruelty or abuse towards children, motivating them to become advocates for child protection.`,
        `Dealing with intense fury when they are blamed for something they did not do, sparking a quest to clear their name and seek justice.`,
        `Experiencing a blazing anger when they see people exploiting religion for personal gain or power, leading them to question beliefs and seek spirituality on their terms.`,
        `Feeling furious when they face discrimination based on their gender, race, or identity, driving them to stand up against bigotry.`,
        `Dealing with a seething fury when faced with bureaucracy and red tape, pushing them to fight for streamlined systems and better processes.`,
        `Experiencing intense fury when they encounter individuals who manipulate or take advantage of vulnerable populations, prompting them to become advocates for social justice.`,
        `Feeling furious when they witness the destruction of cultural heritage and historical landmarks, inspiring them to become advocates for preservation and conservation.`,
        `Dealing with a burning rage when they see individuals taking advantage of the less fortunate, driving them to support and uplift those in need.`,
        `Experiencing a furious outburst when they encounter individuals who spread hate and discrimination, motivating them to promote love and understanding.`,
        `Feeling furious when faced with corrupt political leaders, prompting them to engage in activism and work towards political reform.`,
        `Dealing with a fiery anger when they witness animal cruelty in industries like factory farming, motivating them to promote ethical treatment of animals.`,
        `Experiencing overwhelming fury when they witness systemic racism and oppression, pushing them to fight for racial equality and justice.`,
        `Feeling furious when they see the exploitation of workers and unfair labor practices, leading them to advocate for workers' rights.`,
        `Dealing with intense fury when they encounter individuals who manipulate or deceive to gain power, inspiring them to resist authoritarianism.`,
        `Experiencing a blazing anger when they witness environmental pollution and destruction, driving them to become environmental activists.`,
        `Feeling furious when they face discrimination and prejudice based on their sexual orientation, inspiring them to become LGBTQ+ advocates.`,
        `Dealing with a seething anger when they witness cyberbullying and online harassment, prompting them to promote a kinder and safer internet.`,
        `Experiencing intense fury when they encounter individuals who exploit the vulnerable for financial gain, inspiring them to expose and combat scams.`,
        `Feeling furious when faced with unfair trade practices and exploitation of developing countries, motivating them to support fair trade initiatives.`,
        `Dealing with a fiery anger when they witness animal testing for cosmetics and other products, leading them to support cruelty-free alternatives.`,
        `Experiencing a furious outburst when they see individuals disregarding COVID-19 safety measures, driving them to raise awareness and promote responsible behavior.`,
        `Feeling furious when they witness body-shaming and unrealistic beauty standards in the media, inspiring them to promote body positivity and self-acceptance.`,
        `Dealing with intense fury when they encounter individuals who abuse their power and authority, prompting them to advocate for accountability.`,
        `Experiencing a blazing rage when faced with human trafficking and modern-day slavery, motivating them to fight against this injustice.`,
        `Feeling furious when they see individuals engaging in cultural appropriation, driving them to promote cultural respect and appreciation.`,
        `Dealing with a seething anger when they witness bullying and harassment, inspiring them to support anti-bullying initiatives and provide a safe space for victims.`,
        `Experiencing intense fury when they encounter individuals who exploit natural disasters for personal gain, prompting them to support disaster relief efforts.`,
        `Feeling furious when faced with misleading and false information being spread, motivating them to promote media literacy and critical thinking.`,
        `Dealing with a fiery anger when they witness animal abandonment and neglect, leading them to support animal rescue and adoption initiatives.`,
        `Experiencing overwhelming fury when they see individuals engaging in corruption and bribery, driving them to support transparency and accountability measures.`,
        `Feeling furious when they encounter individuals who downplay or deny climate change, inspiring them to advocate for climate action and sustainability.`,
        `Dealing with a burning rage when they witness cultural erasure and attempts to suppress minority voices, motivating them to promote cultural diversity and inclusivity.`,
        `Experiencing a furious outburst when they face censorship and restrictions on freedom of speech, driving them to support freedom of expression.`,
        `Feeling furious when they see individuals profiting from the suffering of others, prompting them to support charitable causes and social justice initiatives.`,
        `Dealing with intense fury when they encounter individuals who perpetrate hate crimes and violence, inspiring them to promote peace and understanding.`,
        `Experiencing a blazing anger when they witness individuals exploiting loopholes in tax systems, leading them to support tax reform and equitable taxation.`,
    ]
]
