...
function spellFetch() {
    let x = searchArray(spellData)
    let output = `(${x.level}) ${x.name}`

    document.getElementById("Spell").innerHTML = output
}

function classFetch(type) {
    let spells = []
    spellData.forEach(element => {
        x = charClass
        if (typeof(x) === array) {
            for (i = 0; i < x.length; i++) {
                console.log(x[i]);
                if (x[i] === charClass) {
                    spells.push(element.name)
                }
            }
        } else {
            if (charClass === x) {
    ...
    printFrom(spells, spells.length, "Class")
}
...
var spellData = [{
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Abjuration',
        charClass: 'Ranger, Ritual Caster, Wizard'
    },
    {
        name: 'Alter Self',
        desc: 'You assume a different form. When you cast the spell, choose one of the following options, the effects of which last for the duration of the spell. While the spell lasts, you can end one option as an action to gain the benefits of a different one.<b>Aquatic Adaptation.</b> You adapt your body to an aquatic environment, sprouting gills and growing webbing between your fingers. You can breathe underwater and gain a swimming speed equal to your walking speed.<b>Change Appearance.</b> You transform your appearance. You decide what you look like, including your height, weight, facial features, sound of your voice, hair length, coloration, and distinguishing characteristics, if any. You can make yourself appear as a member of another race, though none of your statistics change. You also can’t appear as a creature of a different size than you, and your basic shape stays the same; if you\'re bipedal, you can’t use this spell to become quadrupedal, for instance. At any time for the duration of the spell, you can use your action to change your appearance in this way again.<b>Natural Weapons.</b> You grow claws, fangs, spines, horns, or a different natural weapon of your choice. Your unarmed strikes deal 1d6 bludgeoning, piercing, or slashing damage, as appropriate to the natural weapon you chose, and you are proficient with your unarmed strikes. Finally, the natural weapon is magic and you have a +1 bonus to the attack and damage rolls you make using it.',
        page: 'phb 211',
        range: 'Self',
        components: 'V, S',
        ritual: 'no',
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Enchantment',
        charClass: 'Bard, Cleric, Druid, Ranger',
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Enchantment',
        charClass: ['Bard', 'Druid', 'Ranger', 'Ritual Caster'],
    },
    {
        name: 'Animal Shapes',
    ...
    },
    {
        ...
        level: '5th-level',
        school: 'Transmutation',
        charClass: ['Bard', 'Sorcerer', 'Wizard'],
    },
    {
        name: 'Antilife Shell',
    ...
    },
    {
        ...
        level: '6th-level',
        school: 'Conjuration',
        charClass: ['Sorcerer', 'Warlock', 'Wizard'],
    },
    {
        name: 'Arcane Lock',
    ...
    },
    {
        ...
        level: '9th-level',
        school: 'Necromancy',
        charClass: ['Cleric', 'Warlock', 'Wizard'],
    },
    {
        name: 'Augury',
        ...
        level: '2nd-level',
        school: 'Divination',
        charClass: ['Cleric', 'Ritual Caster'],
        domains: 'Knowledge'
    },
    {
        name: 'Aura of Life',
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Abjuration',
        charClass: ['Cleric', 'Paladin', 'Sorcerer', 'Warlock', 'Wizard'],
        oaths: 'Vengeance'
    },
    {
        name: 'Barkskin',
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Divination',
        charClass: ['Druid', 'Ranger', 'Ritual Caster'],
    },
    {
        name: 'Bestow Curse',
        ...
        level: '3rd-level',
        school: 'Necromancy',
        charClass: ['Bard', 'Cleric', 'Wizard'],
    },
    {
        name: 'Bigby\'s Hand',
        desc: 'You create a Large hand of shimmering, translucent force in an unoccupied space that you can see within range. The hand lasts for the spell’s duration, and it moves at your command, mimicking the movements of your own hand.The hand is an object that has AC 20 and hit points equal to your hit point maximum. If it drops to 0 hit points, the spell ends. It has a Strength of 26 (+8) and a Dexterity of 10 (+0). The hand doesn’t fill its space.When you cast the spell and as a bonus action on your subsequent turns, you can move the hand up to 60 feet and then cause one of the following effects with it.<b>Clenched Fist.</b> The hand strikes one creature or object within 5 feet of it. Make a melee spell attack for the hand using your game statistics. On a hit, the target takes 4d8 force damage.<b>Forceful Hand.</b> The hand attempts to push a creature within 5 feet of it in a direction you choose. Make a check with the hand’s Strength contested by the Strength (Athletics) check of the target. If the target is Medium or smaller, you have advantage on the check. If you succeed, the hand pushes the target up to 5 feet plus a number of feet equal to five times your spellcasting ability modifier. The hand moves with the target to remain within 5 feet of it.<b>Grasping Hand.</b> The hand attempts to grapple a Huge or smaller creature within 5 feet of it. You use the hand’s Strength score to resolve the grapple. If the target is Medium or smaller, you have advantage on the check. While the hand is grappling the target, you can use a bonus action to have the hand crush it. When you do so, the target takes bludgeoning damage equal to 2d6 + your spellcasting ability modifier.<b>Interposing Hand.</b> The hand interposes itself between you and a creature you choose until you give the hand a different command. The hand moves to stay between you and the target, providing you with half cover against the target. The target can\'t move through the hand’s space if its Strength score is less than or equal to the hand’s Strength score. If its Strength score is higher than the hand’s Strength score, the target can move toward you through the hand’s space, but that space is difficult terrain for the target.',
    ...
    },
    {
        ...
        level: 'Cantrip',
        school: 'Abjuration',
        charClass: ['Bard', 'Sorcerer', 'Warlock', 'Wizard'],
    },
    {
        name: 'Bless',
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Necromancy',
        charClass: ['Druid', 'Sorcerer', 'Warlock', 'Wizard'],
        circles: 'Desert'
    },
    {
        name: 'Blinding Smite',
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Necromancy',
        charClass: ['Bard', 'Cleric', 'Sorcerer', 'Warlock', 'Wizard'],
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Transmutation',
        charClass: ['Cleric', 'Sorcerer', 'Warlock', 'Wizard'],
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Illusion',
        charClass: ['Druid', 'Sorcerer', 'Wizard'],
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Enchantment',
        charClass: ['Bard', 'Cleric', 'Druid', 'Sorcerer', 'Warlock', 'Wizard'],
    ...
    {
        name: 'Command',
        desc: 'You speak a one-word command to a creature you can see within range. The target must succeed on a wisdom saving throw or follow the command on its next turn. The spell has no effect if the target is undead, if it doesn’t understand your language, or if your command is directly harmful to it.Some typical commands and their effects follow. You might issue a command other than one described here. If you do so, the DM determines how the target behaves. If the target can’t follow your command, the spell ends.<b>Approach.</b> The target moves toward you by the shortest and most direct route, ending its turn if it moves within 5 feet of you.<b>Drop</b> The target drops whatever it is holding and then ends its turn.<b>Flee.</b> The target spends its turn moving away from you by the fastest available means.<b>Grovel.</b> The target falls prone and then ends its turn.<b>Halt.</b> The target doesn’t move and takes no actions. A flying creature stays aloft, provided that it is able to do so. If it must move to stay aloft, it flies the minimum distance needed to remain in the air.',
        ...
        level: '1st-level',
        school: 'Enchantment',
        charClass: ['Cleric', 'Paladin', 'Warlock'],
        archetype: 'Warlock: Fiend',
        domains: 'Knowledge',
        patrons: 'Fiend'
    },
    {
        ...
        level: '5th-level',
        school: 'Divination',
        charClass: ['Cleric', 'Paladin', 'Ritual Caster'],
        archetype: 'Paladin: Devotion',
        oaths: 'Devotion'
    },
    {
        ...
        level: '5th-level',
        school: 'Divination',
        charClass: ['Druid', 'Paladin', 'Ranger', 'Ritual Caster'],
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Divination',
        charClass: ['Bard', 'Ritual Caster', 'Sorcerer', 'Warlock', 'Wizard'],
    },
    {
        name: 'Compulsion',
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Enchantment',
        charClass: ['Bard', 'Cleric', 'Druid', 'Sorcerer'],
        archetype: 'Cleric: Knowledge',
        domains: 'Knowledge'
    },
    {
    ...
    },
    {
        ...
        level: '5th-level',
        school: 'Divination',
        charClass: ['Ritual Caster', 'Warlock', 'Wizard'],
    },
    {
        name: 'Contagion',
        desc: 'Your touch inflicts disease. Make a melee spell attack against a creature within your reach. On a hit, you afflict the creature with a disease of your choice from any of the ones described below.At the end of each of the target’s turns, it must make a constitution saving throw. After failing three of these saving throws, the disease’s effects last for the duration, and the creature stops making these saves. After succeeding on three of these saving throws, the creature recovers from the disease, and the spell ends.Since this spell induces a natural disease in its target, any effect that removes a disease or otherwise ameliorates a disease’s effects apply to it.<b>Blinding Sickness.</b> Pain grips the creature’s mind, and its eyes turn milky white. The creature has disadvantage on wisdom checks and wisdom saving throws and is blinded.<b>Filth Fever.</b> A raging fever sweeps through the creature’s body. The creature has disadvantage on strength checks, strength saving throws, and attack rolls that use Strength.<b>Flesh Rot.</b> The creature’s flesh decays. The creature has disadvantage on Charisma checks and vulnerability to all damage.<b>Mindfire.</b> The creature’s mind becomes feverish. The creature has disadvantage on intelligence checks and intelligence saving throws, and the creature behaves as if under the effects of the confusion spell during combat.<b>Seizure.</b> The creature is overcome with shaking. The creature has disadvantage on dexterity checks, dexterity saving throws, and attack rolls that use Dexterity.<b>Slimy Doom.</b> The creature begins to bleed uncontrollably. The creature has disadvantage on constitution checks and constitution saving throws. In addition, whenever the creature takes damage, it is stunned until the end of its next turn.',
        page: 'phb 227',
        range: 'Touch',
        components: 'V, S',
        ritual: 'no',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Conjuration',
        charClass: ['Cleric', 'Druid', 'Paladin'],
        archetype: 'Druid: Desert',
        circles: 'Desert'
    },
    {
        name: 'Create or Destroy Water',
        desc: 'You either create or destroy water.<b>Create Water.</b> You create up to 10 gallons of clean water within range in an open container. Alternatively, the water falls as rain in a 30-foot cube within range.<b>Destroy Water.</b> You destroy up to 10 gallons of water in an open container within range. Alternatively, you destroy fog in a 30-foot cube within range.',
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Evocation',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger'],
        domains: 'Life'
    },
    {
        name: 'Dancing Lights',
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Transmutation',
        charClass: ['Druid', 'Ranger', 'Sorcerer', 'Wizard'],
    },
    {
        name: 'Daylight',
        ...
        level: '3rd-level',
        school: 'Evocation',
        charClass: ['Cleric', 'Druid', 'Paladin', 'Ranger', 'Sorcerer'],
        domains: 'Light',
        circles: 'Grassland'
    },
    {
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Divination',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Ritual Caster', 'Sorcerer', 'Wizard'],
    },
    {
        ...
        level: '1st-level',
        school: 'Divination',
        charClass: 'Cleric, Druid, Paladin, Ranger, Ritual Caster'
    },
    {
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Conjuration',
        charClass: ['Bard', 'Cleric', 'Paladin', 'Sorcerer', 'Warlock', 'Wizard'],
        archetype: 'Cleric: TrickeryPaladin: Vengeance',
        domains: 'Trickery',
        oaths: 'Vengeance'
    },
    {
        ...
        level: '1st-level',
        school: 'Illusion',
        charClass: ['Bard', 'Cleric', 'Sorcerer', 'Wizard'],
        archetype: 'Cleric: Trickery',
        domains: 'Trickery'
    },
    {
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Abjuration',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Sorcerer', 'Warlock', 'Wizard'],
        archetype: 'Cleric: Trickery',
        domains: 'Trickery',
        oaths: 'Devotion'
    },
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Divination',
        charClass: ['Cleric', 'Druid', 'Ritual Caster'],
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Enchantment',
        charClass: ['Cleric', 'Druid', 'Sorcerer', 'Warlock'],
    ...
    },
    {
        ...
        level: '6th-level',
        school: 'Conjuration',
        charClass: ['Ritual Caster', 'Wizard'],
    },
    {
    ...
    },
    {
        ...
        level: '5th-level',
        school: 'Illusion',
        charClass: ['Bard', 'Druid', 'Warlock', 'Wizard'],
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Evocation',
        charClass: ['Bard', 'Druid', 'Sorcerer', 'Wizard'],
    },
    {
        name: 'Earthbind',
    ...
    },
    {
        ...
        level: '8th-level',
        school: 'Evocation',
        charClass: ['Cleric', 'Druid', 'Sorcerer'],
    },
    {
        name: 'Eldritch Blast',
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Transmutation',
        charClass: ['Druid', 'Warlock', 'Wizard'],
    },
    {
    ...
    },
    {
        ...
        desc: 'You touch a creature and bestow upon it a magical enhancement. Choose one of the following effects; the target gains that effect until the spell ends.<b>Bear’s Endurance.</b> The target has advantage on constitution checks. It also gains 2d6 temporary hit points, which are lost when the spell ends. <b>Bull’s Strength.</b> The target has advantage on strength checks, and his or her carrying capacity doubles.<b>Cat’s Grace.</b> The target has advantage on dexterity checks. It also doesn’t take damage from falling 20 feet or less if it isn’t incapacitated.<b>Eagle’s Splendor.</b> The target has advantage on Charisma checks.<b>Fox’s Cunning.</b> The target has advantage on intelligence checks.<b>Owl’s Wisdom.</b> The target has advantage on wisdom checks.',
        higher_level: 'When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.',
        page: 'phb 237',
        range: 'Touch',
        components: 'V, S, M',
    ...
    {
        name: 'Eyebite',
        desc: 'For the spell’s duration, your eyes become an inky void imbued with dread power. One creature of your choice within 60 feet of you that you can see must succeed on a wisdom saving throw or be affected by one of the following effects of your choice for the duration. On each of your turns until the spell ends, you can use your action to target another creature but can’t target a creature again if it has succeeded on a saving throw against this casting of eyebite.<b>Asleep.</b> The target falls unconscious. It wakes up if it takes any damage or if another creature uses its action to shake the sleeper awake.<b>Panicked.</b> The target is frightened of you. On each of its turns, the frightened creature must take the Dash action and move away from you by the safest and shortest available route, unless there is nowhere to move. If the target moves to a place at least 60 feet away from you where it can no longer see you, this effect ends.<b>Sickened.</b> The target has disadvantage on attack rolls and ability checks. At the end of each of its turns, it can make another wisdom saving throw. If it succeeds, the effect ends.',
        page: 'phb 238',
        range: 'Self',
        components: 'V, S',
        ritual: 'no',
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Evocation',
        charClass: ['Bard', 'Cleric', 'Druid', 'Warlock'],
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Necromancy',
        charClass: ['Bard', 'Cleric', 'Druid', 'Ritual Caster', 'Wizard'],
    },
    {
        name: 'Find Familiar',
        ...
        range: '10 feet',
        components: 'V, S, M',
        material: '10gp worth of charcoal, incense, and herbs that must be consumed by fire in a brass brazier.You gain the service of a familiar, a spirit that takes an animal form you choose: bat, cat, crab, frog (toad), hawk, lizard, octopus, owl, poisonous snake, fish (quipper), rat, raven, sea horse, spider, or weasel. Appearing in an unoccupied space within range, the familiar has the statistics of the chosen form, though it is a celestial, fey, or fiend (your choice) instead of a beast.',
        ritual: 'yes',
        duration: 'Instantaneous',
        concentration: 'no',
        casting_time: '1 hour',
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Conjuration',
        charClass: ['Cleric', 'Druid', 'Ranger', 'Sorcerer', 'Wizard'],
        archetype: 'Cleric: Tempest',
        domains: 'Tempest'
    },
    {
    ...
    },
    {
        ...
        level: '9th-level',
        school: 'Conjuration',
        charClass: ['Cleric', 'Sorcerer', 'Wizard'],
    },
    {
        name: 'Geas',
        ...
        level: '5th-level',
        school: 'Enchantment',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Wizard']
    },
    {
        name: 'Gentle Repose',
        ...
        level: '2nd-level',
        school: 'Necromancy',
        charClass: ['Cleric', 'Ritual Caster', 'Wizard'],
    },
    {
        name: 'Giant Insect',
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Illusion',
        charClass: ['Bard', 'Druid', 'Sorcerer', 'Warlock', 'Wizard'],
        archetype: 'Druid: UnderdarkWarlock: Archfey',
        circles: 'Underdark',
        patrons: 'Archfey'
    },
    {
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Evocation',
        charClass: ['Cleric', 'Druid', 'Sorcerer', 'Wizard'],
        archetype: 'Cleric: Tempest',
        domains: 'Tempest'
    },
    {
    ...
    {
        name: 'Hallow',
        desc: 'You touch a point and infuse an area around it with holy (or unholy) power. The area can have a radius up to 60 feet, and the spell fails if the radius includes an area already under the effect a hallow spell. The affected area is subject to the following effects.First, celestials, elementals, fey, fiends, and undead can’t enter the area, nor can such creatures charm, frighten, or possess creatures within it. Any creature charmed, frightened, or possessed by such a creature is no longer charmed, frightened, or possessed upon entering the area. You can exclude one or more of those types of creatures from this effect.Second, you can bind an extra effect to the area. Choose the effect from the following list, or choose an effect offered by the DM. Some of these effects apply to creatures in the area; you can designate whether the effect applies to all creatures, creatures that follow a specific deity or leader, or creatures of a specific sort, such as ores or trolls. When a creature that would be affected enters the spell’s area for the first time on a turn or starts its turn there, it can make a charisma saving throw. On a success, the creature ignores the extra effect until it leaves the area.<b>Courage.</b> Affected creatures can’t be frightened while in the area.<b>Darkness.</b> Darkness fills the area. Normal light, as well as magical light created by spells of a lower level than the slot you used to cast this spell, can’t illuminate the area.<b>Daylight.</b> Bright light fills the area. Magical darkness created by spells of a lower level than the slot you used to cast this spell can’t extinguish the light.<b>Energy Protection.</b> Affected creatures in the area have resistance to one damage type of your choice, except for bludgeoning, piercing, or slashing.<b>Energy Vulnerability.</b> Affected creatures in the area have vulnerability to one damage type of your choice, except for bludgeoning, piercing, or slashing.<b>Everlasting Rest.</b> Dead bodies interred in the area can’t be turned into undead.<b>Extradimensional Interference.</b> Affected creatures can’t move or travel using teleportation or by extradimensional or interplanar means.<b>Fear.</b> Affected creatures are frightened while in the area.<b>Silence.</b> No sound can emanate from within the area, and no sound can reach into it.<b>Tongues.</b> Affected creatures can communicate with any other creature in the area, even if they don’t share a common language.',
        page: 'phb 249',
        range: 'Touch',
        components: 'V, S, M',
    ...
    },
    {
        ...
        range: '300 feet',
        components: 'V, S, M',
        material: 'A stone, a twig, and a bit of green plant.You make natural terrain in a 150-foot cube in range look, sound, and smell like some other sort of natural terrain. Thus, open fields or a road can be made to resemble a swamp, hill, crevasse, or some other difficult or impassable terrain. A pond can be made to seem like a grassy meadow, a precipice like a gentle slope, or a rock-strewn gully like a wide and smooth road. Manufactured structures, equipment, and creatures within the area aren’t changed in appearance.',
        ritual: 'no',
        duration: '24 hours',
        concentration: 'no',
        casting_time: '10 minutes',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Transmutation',
        charClass: ['Druid', 'Paladin', 'Sorcerer', 'Wizard'],
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Evocation',
        charClass: ['Cleric', 'Druid', 'Paladin', 'Sorcerer', 'Wizard'],
        archetype: 'Cleric: TempestPaladin: Ancients',
        domains: 'Tempest',
        circles: 'Arctic',
        oaths: 'Ancients'
    },
    {
        ...
        level: '1st-level',
        school: 'Divination',
        charClass: ['Bard', 'Cleric', 'Ritual Caster', 'Wizard'],
        archetype: 'Cleric: Knowledge',
        domains: 'Knowledge'
    },
    {
        ...
        level: '1st-level',
        school: 'Illusion',
        charClass: ['Bard', 'Ritual Caster', 'Warlock', 'Wizard'],
    },
    {
        name: 'Immolation',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Evocation',
        charClass: ['Bard', 'Ritual Caster', 'Wizard'],
    },
    {
    ...
    },
    {
        ...
        level: '4th-level',
        school: 'Divination',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Wizard'],
        circles: 'Swamp'
    },
    {
        name: 'Locate Object',
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Transmutation',
        charClass: ['Bard', 'Druid', 'Ranger', 'Wizard'],
    },
    {
        name: 'Maelstrom',
        desc: 'A mass of 5-foot-deep water appears and swirls in a 30-foot radius centered on a point you can see within range. The point must be on ground or in a body of water. Until the spell ends, that area is difficult terrain, and any creature that starts its turn there must succeed on a Strength saving throw or take 6d6 bludgeoning damage and be pulled 10 feet toward the center.',
        page: 'ee charClass 20',
        range: '120 feet',
        components: 'V, S, M',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Abjuration',
        charClass: ['Cleric', 'Paladin', 'Warlock', 'Wizard'],
    },
    {
        name: 'Magic Jar',
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Transmutation',
        charClass: ['Cleric', 'Paladin', 'Wizard'],
        archetype: 'Cleric: War',
        domains: 'War'
    },
    {
    ...
    },
    {
        ...
        level: 'Cantrip',
        school: 'Transmutation',
        charClass: ['Cleric', 'Bard', 'Druid', 'Sorcerer', 'Wizard'],
    },
    {
        name: 'Message',
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Illusion',
        charClass: ['Cleric', 'Druid', 'Sorcerer', 'Warlock', 'Wizard'],
        archetype: 'Cleric: TrickeryDruid: Coast',
        domains: 'Trickery',
        circles: 'Coast'
    },
    {
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Conjuration',
        charClass: ['Druid', 'Paladin', 'Sorcerer', 'Warlock', 'Wizard'],
        archetype: 'Druid: CoastPaladin: Ancients, Vengeance',
        circles: 'Coast',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Abjuration',
        charClass: 'Bard, Cleric, Ranger, Wizard',
        archetype: 'Cleric: Knowledge',
        domains: 'Knowledge'
    },
    {
        name: 'Nystul\'s Magic Aura',
        desc: 'You place an illusion on a creature or an object you touch so that divination spells reveal false information about it. The target can be a willing creature or an object that isn’t being carried or worn by another creature.When you cast the spell, choose one or both of the following effects. The effect lasts for the duration. If you cast this spell on the same creature or object every day for 30 days, placing the same effect on it each time, the illusion lasts until it is dispelled.<b>False Aura.</b> You change the way the target appears to spells and magical effects, such as detect magic, that detect magical auras. You can make a nonmagical object appear magical, a magical object appear nonmagical, or change the object’s magical aura so that it appears to belong to a specific school of magic that you choose. When you use this effect on an object, you can make the false magic apparent to any creature that handles the item.<b>Mask.</b> You change the way the target appears to spells and magical effects that detect creature types, such as a paladin’s Divine Sense or the trigger of a symbol spell. You choose a creature type and other spells and magical effects treat the target as if it were a creature of that type or of that alignment.',
        page: 'phb 263',
        range: 'Touch',
        components: 'V, S, M',
    ...
    },
    {
        ...
        level: '5th-level',
        school: 'Abjuration',
        charClass: ['Bard', 'Cleric', 'Druid', 'Wizard'],
    },
    {
        name: 'Plane Shift',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Transmutation',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Warlock'],
        archetype: 'Cleric: NaturePaladin: AncientsWarlock: Archfey',
        domains: 'Nature',
        circles: 'Forest',
        oaths: 'Ancients',
        patrons: 'Archfey'
    ...
    },
    {
        ...
        desc: 'Eight multicolored rays of light flash from your hand. Each ray is a different color and has a different power and purpose. Each creature in a 60-foot cone must make a dexterity saving throw. For each target, roll a d8 to determine which color ray affects it.<b>1. Red.</b> The target takes 10d6 fire damage on a failed save, or half as much damage on a successful one.<b>2. Orange.</b> The target takes 10d6 acid damage on a failed save, or half as much damage on a successful one.<b>3. Yellow.</b> The target takes 10d6 lightning damage on a failed save, or half as much damage on a successful one.<b>4. Green.</b> The target takes 10d6 poison damage on a failed save, or half as much damage on a successful one.<b>5. Blue.</b> The target takes 10d6 cold damage on a failed save, or half as much damage on a successful one.<b>6. Indigo.</b> On a failed save, the target is restrained. It must then make a constitution saving throw at the end of each of its turns. If it successfully saves three times, the spell ends. If it fails its save three times, it permanently turns to stone and is subjected to the petrified condition. The successes and failures don’t need to be consecutive; keep track of both until the target collects three of a kind.<b>7. Violet.</b> On a failed save, the target is blinded. It must then make a wisdom saving throw at the start of your next turn. A successful save ends the blindness. If it fails that save, the creature is transported to another plane of existence of the DM’s choosing and is no longer blinded. (Typically, a creature that is on a plane that isn’t its home plane is banished home, while other creatures are usually cast into the Astral or Ethereal planes.)<b>8. Special.</b> The target is struck by two rays. Roll twice more, rerolling any 8.',
        page: 'phb 267',
        range: 'Self',
        components: 'V, S',
        ritual: 'no',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Abjuration',
        charClass: ['Cleric', 'Druid', 'Paladin', 'Ranger', 'Sorcerer', 'Wizard'],
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Abjuration',
        charClass: ['Cleric', 'Druid', 'Paladin', 'Ranger'],
    },
    {
        ...
        level: '1st-level',
        school: 'Transmutation',
        charClass: ['Cleric', 'Druid', 'Paladin', 'Ritual Caster'],
    },
    {
        name: 'Pyrotechnics',
    ...
    {
        name: 'Reincarnate',
        desc: 'You touch a dead humanoid or a piece of a dead humanoid. Provided that the creature has been dead no longer than 10 days, the spell forms a new adult body for it and then calls the soul to enter that body. If the target’s soul isn’t free or willing to do so, the spell fails.The magic fashions a new body for the creature to inhabit, which likely causes the creature’s race to change. The DM rolls a d 100 and consults the following table to determine what form the creature takes when restored to life, or the DM chooses a form.<b>01-04</b> Dragonborn<b>05-13</b> Dwarf, hill<b>14-21</b> Dwarf, mountain<b>22-25</b> Elf, dark<b>26-34</b> Elf, high<b>35-42</b> Elf, wood<b>43-46</b> Gnome, forest<b>47-52</b> Gnome, rock<b>53-56</b> Half-elf<b>57-60</b> Half-orc<b>61-68</b> Halfling, lightfoot<b>69-76</b> Halfling, stout<b>77-96</b> Human<b>97-00</b> TieflingThe reincarnated creature recalls its former life and experiences. It retains the capabilities it had in its original form, except it exchanges its original race for the new one and changes its racial traits accordingly.',
        page: 'phb 271',
        range: 'Touch',
        components: 'V, S, M',
    ...
    {
        name: 'Scorching Ray',
        desc: 'You generate three rays of fire and will throw to targets in the range of the spell. You can project them on one or more targets.Perform a remote attack spell for each department. If it hits, the target takes 2d6 fire damage.',
    ...
    },
    {
        ...
        level: '5th-level',
        school: 'Divination',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Warlock', 'Wizard'],
        archetype: 'Paladin: Vengeance',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Evocation',
        charClass: ['Bard', 'Cleric', 'Warlock', 'Wizard'],
        archetype: 'Warlock: Great Old One',
        patrons: 'Great Old One'
    },
    {
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Illusion',
        charClass: ['Bard', 'Cleric', 'Druid', 'Ranger', 'Ritual Caster'],
        archetype: 'Druid: Desert',
        circles: 'Desert'
    },
    {
    ...
    },
    {
        ...
        level: '2nd-level',
        school: 'Transmutation',
        charClass: ['Bard', 'Druid', 'Ritual Caster', 'Wizard'],
    },
    {
        name: 'Sleep',
    ...
    },
    {
        ...
        level: '1st-level',
        school: 'Divination',
        charClass: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Ritual Caster'],
        archetype: 'Cleric: NaturePaladin: Ancients',
        domains: 'Nature',
        oaths: 'Ancients'
    },
    {
    ...
    },
    {
        ...
        desc: 'A churning storm cloud forms, centered on a point you can see and spreading to a radius of 360 feet. Lightning flashes in the area, thunder booms, and strong winds roar. Each creature under the cloud (no more than 5,000 feet beneath the cloud) when it appears must make a constitution saving throw. On a failed save, a creature takes 2d6 thunder damage and becomes deafened for 5 minutes.Each round you maintain concentration on this spell, the storm produces additional effects on your turn. <b>Round 2.</b> Acidic rain falls from the cloud. Each creature and object under the cloud takes 1d6 acid damage.<b>Round 3.</b> You call six bolts of lightning from the cloud to strike six creatures or objects of your choice beneath the cloud. A given creature or object can’t be struck by more than one bolt. A struck creature must make a dexterity saving throw. The creature takes 10d6 lightning damage on a failed save, or half as much damage on a successful one.<b>Round 4.</b> Hailstones rain down from the cloud. Each creature under the cloud takes 2d6 bludgeoning damage.<b>Round 5-10.</b> Gusts and freezing rain assail the area under the cloud. The area becomes difficult terrain and is heavily obscured. Each creature there takes 1d6 cold damage. Ranged weapon attacks in the area are impossible. The wind and rain count as a severe distraction for the purposes of maintaining concentration on spells. Finally, gusts of strong wind (ranging from 20 to 50 miles per hour) automatically disperse fog, mists, and similar phenomena in the area, whether mundane or magical.',
        page: 'phb 279',
        range: 'Sight',
        components: 'V, S',
        ritual: 'no',
    ...
    {
        name: 'Sword Burst',
        desc: 'You create a momentary circle of spectral blades that sweep around you. Each creature within range, other than you, must succeed on a Dexterity saving throw or take 1d6 force damage.This spell\'s damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).',
        page: 'scag 143',
        range: '5 feet',
        components: 'V',
        ritual: 'no',
    ...
    {
        name: 'Symbol',
        desc: 'When you cast this spell, you inscribe a harmful glyph either on a surface (such as a section of floor, a wall, or a table) or within an object that can be closed to conceal the glyph (such as a book, a scroll, or a treasure chest). If you choose a surface, the glyph can cover an area of the surface no larger than 10 feet in diameter. If you choose an object, that object must remain in its place; if the object is moved more than 10 feet from where you cast this spell, the glyph is broken, and the spell ends without being triggered.The glyph is nearly invisible, requiring an Intelligence (Investigation) check against your spell save DC to find it.You decide what triggers the glyph when you cast the spell. For glyphs inscribed on a surface, the most typical triggers include touching or stepping on the glyph, removing another object covering it, approaching within a certain distance of it, or manipulating the object that holds it. For glyphs inscribed within an object, the most common triggers are opening the object, approaching within a certain distance of it, or seeing or reading the glyph.You can further refine the trigger so the spell is activated only under certain circumstances or according to a creature’s physical characteristics (such as height or weight), or physical kind (for example, the ward could be set to affect hags or shapechangers). You can also specify creatures that don’t trigger the glyph, such as those who say a certain password.When you inscribe the glyph, choose one of the options below for its effect. Once triggered, the glyph glows, filling a 60-foot-radius sphere with dim light for 10 minutes, after which time the spell ends. Each creature in the sphere when the glyph activates is targeted by its effect, as is a creature that enters the sphere for the first time on a turn or ends its turn there. <b>Death.</b> Each target must make a constitution saving throw, taking 10d 10 necrotic damage on a failed save, or half as much damage on a successful save.<b>Discord.</b> Each target must make a constitution saving throw. On a failed save, a target bickers and argues with other creatures for 1 minute. During this time, it is incapable of meaningful communication and has disadvantage on attack rolls and ability checks.<b>Fear.</b> Each target must make a wisdom saving throw and becomes frightened for 1 minute on a failed save. While frightened, the target drops whatever it is holding and must move at least 30 feet away from the glyph on each of its turns, if able.<b>Hopelessness.</b> Each target must make a charisma saving throw. On a failed save, the target is overwhelmed with despair for 1 minute. During this time, it can’t attack or target any creature with harmful abilities, spells, or other magical effects.<b>Insanity.</b> Each target must make an intelligence saving throw. On a failed save, the target is driven insane for 1 minute. An insane creature can’t take actions, can\'t understand what other creatures say, can’t read, and speaks only in gibberish. The DM controls its movement, which is erratic.<b>Pain.</b> Each target must make a constitution saving throw and becomes incapacitated with excruciating pain for 1 minute on a failed save.<b>Sleep.</b> Each target must make a wisdom saving throw and falls unconscious for 10 minutes on a failed save. A creature awakens if it takes damage or if someone uses an action to shake or slap it awake.<b>Stunning.</b> Each target must make a wisdom saving throw and becomes stunned for 1 minute on a failed save.',
        page: 'phb 280',
        range: 'Touch',
        components: 'V, S, M',
    ...
    {
        name: 'Trap the Soul',
        desc: 'This spell name was added as an error and does not exist. Refer to the spell named "imprisonment" for information on what this spell was intended to be.',
        page: 'phb Error',
        range: '30 feet',
        components: 'V, S, M',
        ritual: 'no',
    ...
    {
        name: 'True Polymorph',
        desc: 'Choose one creature or nonmagical object that you can see within range. You transform the creature into a different creature, the creature into an object, or the object into a creature (the object must be neither worn nor carried by another creature). The transformation lasts for the duration, or until the target drops to 0 hit points or dies. If you concentrate on this spell for the full duration, the transformation becomes permanent.Shapechangers aren’t affected by this spell. An unwilling creature can make a wisdom saving throw, and if it succeeds, it isn’t affected by this spell.<b>Creature into Creature.</b> If you turn a creature into another kind of creature, the new form can be any kind you choose whose challenge rating is equal to or less than the target’s (or its level, if the target doesn’t have a challenge rating). The target’s game statistics, including mental ability scores, are replaced by the statistics of the new form. It retains its alignment and personality.The target assumes the hit points of its new form, and when it reverts to its normal form, the creature returns to the number of hit points it had before it transformed. If it reverts as a result of dropping to 0 hit points, any excess damage carries over to its normal form. As long as the excess damage doesn’t reduce the creature’s normal form to 0 hit points, it isn’t knocked unconscious.The creature is limited in the actions it can perform by the nature of its new form, and it can’t speak, cast spells, or take any other action that requires hands or speech unless its new form is capable of such actions.The target’s gear melds into the new form. The creature can’t activate, use, wield, or otherwise benefit from any of its equipment.<b>Object into Creature.</b> You can turn an object into any kind of creature, as long as the creature’s size is no larger than the object’s size and the creature’s challenge rating is 9 or lower. The creature is friendly to you and your companions. It acts on each of your turns. You decide what action it takes and how it moves. The DM has the creature’s statistics and resolves all of its actions and movement.If the spell becomes permanent, you no longer control the creature. It might remain friendly to you, depending on how you have treated it.<b>Creature into Object.</b> If you turn a creature into an object, it transforms along with whatever it is wearing and carrying into that form. The creature’s statistics become those of the object, and the creature has no memory of time spent in this form, after the spell ends and it returns to its normal form.',
        page: 'phb 283',
        range: '30 feet',
        components: 'V, S, M',
    ...
    },
    {
        ...
        level: '3rd-level',
        school: 'Transmutation',
        charClass: ['Druid', 'Ranger', 'Ritual Caster', 'Sorcerer', 'Wizard'],
        circles: 'Coast'
    },
    {
        name: 'Water Walk',
