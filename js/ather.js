...
function quest() {
    ...
    let tropeArray =['The Chosen One','The Secret Heir','The Evil overlord','The reluctant hero','The lucky Novice','The Mentor','Good Vs. Evil','Magic','People in distress','Ancient stuff','All-powerful artifacts','Taverns','Overqualified party','Dragons','Quest',`${searchArray(['Inheritance', 'Hidden truth'])}`, 'Training Sequences', 'Magic school']
